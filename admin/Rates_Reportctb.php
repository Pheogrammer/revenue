				...
				<thead>
					...
					<tr class="ew-table-header">
						<?php if ($Rates_Report_crosstab->GroupColumnCount > 0) { ?>
							<td class="ew-rpt-col-summary" colspan="<?php echo $Rates_Report_crosstab->GroupColumnCount ?>">
								<div><?php echo $Rates_Report_crosstab->renderSummaryCaptions() ?></div>
							</td>
						<?php } ?>
					...
					<tr class="ew-table-header">
						...
						?>
								<td class="ew-table-header" <?php echo $Rates_Report_crosstab->date->cellAttributes() ?>>
									<div<?php echo $Rates_Report_crosstab->date->viewAttributes() ?>><?php echo $Rates_Report_crosstab->SummaryViewValues[$iy - 1]; ?>
		</div>
		</td>
<?php
							}
...
<!-- Dynamic columns end -->
<td class="ew-table-header" <?php echo $Rates_Report_crosstab->date->cellAttributes() ?>>
	<div<?php echo $Rates_Report_crosstab->date->viewAttributes() ?>><?php echo $Rates_Report_crosstab->renderSummaryCaptions() ?>
	</div>
	</td>
	</tr>
	</thead>
	...
	?>
		<tr<?php echo $Rates_Report_crosstab->rowAttributes(); ?>>
			<?php if ($Rates_Report_crosstab->ChargeGroupName->Visible) { ?>
				<!-- ChargeGroupName -->
				<td data-field="ChargeGroupName" <?php echo $Rates_Report_crosstab->ChargeGroupName->cellAttributes(); ?>>
					<span<?php echo $Rates_Report_crosstab->ChargeGroupName->viewAttributes() ?>><?php echo $Rates_Report_crosstab->ChargeGroupName->GroupViewValue ?></span>
				</td>
			<?php } ?>
			<!-- Dynamic columns begin -->
			<?php
