			...
			<tr id="r_ClientId">
				...
				<td data-name="ClientId" <?php echo $client_query_view->ClientId->cellAttributes() ?>>
					<span id="el_client_query_ClientId">
						<span<?php echo $client_query_view->ClientId->viewAttributes() ?>><?php echo $client_query_view->ClientId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Query">
				...
				<td data-name="Query" <?php echo $client_query_view->Query->cellAttributes() ?>>
					<span id="el_client_query_Query">
						<span<?php echo $client_query_view->Query->viewAttributes() ?>><?php echo $client_query_view->Query->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Reply">
				...
				<td data-name="Reply" <?php echo $client_query_view->Reply->cellAttributes() ?>>
					<span id="el_client_query_Reply">
						<span<?php echo $client_query_view->Reply->viewAttributes() ?>><?php echo $client_query_view->Reply->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Date">
				...
				<td data-name="Date" <?php echo $client_query_view->Date->cellAttributes() ?>>
					<span id="el_client_query_Date">
						<span<?php echo $client_query_view->Date->viewAttributes() ?>><?php echo $client_query_view->Date->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Status">
				...
				<td data-name="Status" <?php echo $client_query_view->Status->cellAttributes() ?>>
					<span id="el_client_query_Status">
						<span<?php echo $client_query_view->Status->viewAttributes() ?>><?php echo $client_query_view->Status->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
