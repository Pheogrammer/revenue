		...
		<form name="faudittraillist" id="faudittraillist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_audittrail" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($audittrail_list->TotalRecords > 0 || $audittrail_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_audittraillist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->id) == "") { ?>
										<th data-name="id" class="<?php echo $audittrail_list->id->headerCellClass() ?>">
											<div id="elh_audittrail_id" class="audittrail_id">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $audittrail_list->id->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->id) ?>', 1);">
												<div id="elh_audittrail_id" class="audittrail_id">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->datetime) == "") { ?>
										<th data-name="datetime" class="<?php echo $audittrail_list->datetime->headerCellClass() ?>">
											<div id="elh_audittrail_datetime" class="audittrail_datetime">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->datetime->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="datetime" class="<?php echo $audittrail_list->datetime->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->datetime) ?>', 1);">
												<div id="elh_audittrail_datetime" class="audittrail_datetime">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->script) == "") { ?>
										<th data-name="script" class="<?php echo $audittrail_list->script->headerCellClass() ?>">
											<div id="elh_audittrail_script" class="audittrail_script">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->script->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="script" class="<?php echo $audittrail_list->script->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->script) ?>', 1);">
												<div id="elh_audittrail_script" class="audittrail_script">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->user) == "") { ?>
										<th data-name="user" class="<?php echo $audittrail_list->user->headerCellClass() ?>">
											<div id="elh_audittrail_user" class="audittrail_user">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->user->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="user" class="<?php echo $audittrail_list->user->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->user) ?>', 1);">
												<div id="elh_audittrail_user" class="audittrail_user">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->_action) == "") { ?>
										<th data-name="_action" class="<?php echo $audittrail_list->_action->headerCellClass() ?>">
											<div id="elh_audittrail__action" class="audittrail__action">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->_action->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="_action" class="<?php echo $audittrail_list->_action->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->_action) ?>', 1);">
												<div id="elh_audittrail__action" class="audittrail__action">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->_table) == "") { ?>
										<th data-name="_table" class="<?php echo $audittrail_list->_table->headerCellClass() ?>">
											<div id="elh_audittrail__table" class="audittrail__table">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->_table->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="_table" class="<?php echo $audittrail_list->_table->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->_table) ?>', 1);">
												<div id="elh_audittrail__table" class="audittrail__table">
								...
								?>
									<?php if ($audittrail_list->SortUrl($audittrail_list->field) == "") { ?>
										<th data-name="field" class="<?php echo $audittrail_list->field->headerCellClass() ?>">
											<div id="elh_audittrail_field" class="audittrail_field">
												<div class="ew-table-header-caption"><?php echo $audittrail_list->field->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="field" class="<?php echo $audittrail_list->field->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $audittrail_list->SortUrl($audittrail_list->field) ?>', 1);">
												<div id="elh_audittrail_field" class="audittrail_field">
										...
										?>
											<td data-name="id" <?php echo $audittrail_list->id->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail_id">
													<span<?php echo $audittrail_list->id->viewAttributes() ?>><?php echo $audittrail_list->id->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="datetime" <?php echo $audittrail_list->datetime->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail_datetime">
													<span<?php echo $audittrail_list->datetime->viewAttributes() ?>><?php echo $audittrail_list->datetime->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="script" <?php echo $audittrail_list->script->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail_script">
													<span<?php echo $audittrail_list->script->viewAttributes() ?>><?php echo $audittrail_list->script->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="user" <?php echo $audittrail_list->user->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail_user">
													<span<?php echo $audittrail_list->user->viewAttributes() ?>><?php echo $audittrail_list->user->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="_action" <?php echo $audittrail_list->_action->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail__action">
													<span<?php echo $audittrail_list->_action->viewAttributes() ?>><?php echo $audittrail_list->_action->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="_table" <?php echo $audittrail_list->_table->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail__table">
													<span<?php echo $audittrail_list->_table->viewAttributes() ?>><?php echo $audittrail_list->_table->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="field" <?php echo $audittrail_list->field->cellAttributes() ?>>
												<span id="el<?php echo $audittrail_list->RowCount ?>_audittrail_field">
													<span<?php echo $audittrail_list->field->viewAttributes() ?>><?php echo $audittrail_list->field->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
