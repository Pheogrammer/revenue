			...
			<div id="gmp_Report1" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<table class="<?php echo $Report1_summary->ReportTableClass ?>">
						...
						<tr class="ew-table-header">
							<?php if ($Report1_summary->id->Visible) { ?>
								...
								<?php } else { ?>
									<?php if ($Report1_summary->sortUrl($Report1_summary->id) == "") { ?>
										<th data-name="id" class="<?php echo $Report1_summary->id->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="Report1_id">
												<div class="ew-table-header-caption"><?php echo $Report1_summary->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $Report1_summary->id->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->id) ?>', 1);">
												<div class="Report1_id">
							...
							<?php if ($Report1_summary->ClientName->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->ClientName) == "") { ?>
									<th data-name="ClientName" class="<?php echo $Report1_summary->ClientName->headerCellClass() ?>">
										<div class="Report1_ClientName">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->ClientName->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ClientName" class="<?php echo $Report1_summary->ClientName->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->ClientName) ?>', 1);">
											<div class="Report1_ClientName">
							...
							<?php if ($Report1_summary->ClientType->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->ClientType) == "") { ?>
									<th data-name="ClientType" class="<?php echo $Report1_summary->ClientType->headerCellClass() ?>">
										<div class="Report1_ClientType">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->ClientType->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ClientType" class="<?php echo $Report1_summary->ClientType->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->ClientType) ?>', 1);">
											<div class="Report1_ClientType">
							...
							<?php if ($Report1_summary->IdentityType->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->IdentityType) == "") { ?>
									<th data-name="IdentityType" class="<?php echo $Report1_summary->IdentityType->headerCellClass() ?>">
										<div class="Report1_IdentityType">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->IdentityType->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="IdentityType" class="<?php echo $Report1_summary->IdentityType->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->IdentityType) ?>', 1);">
											<div class="Report1_IdentityType">
							...
							<?php if ($Report1_summary->ClientID->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->ClientID) == "") { ?>
									<th data-name="ClientID" class="<?php echo $Report1_summary->ClientID->headerCellClass() ?>">
										<div class="Report1_ClientID">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->ClientID->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ClientID" class="<?php echo $Report1_summary->ClientID->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->ClientID) ?>', 1);">
											<div class="Report1_ClientID">
							...
							<?php if ($Report1_summary->Surname->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->Surname) == "") { ?>
									<th data-name="Surname" class="<?php echo $Report1_summary->Surname->headerCellClass() ?>">
										<div class="Report1_Surname">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->Surname->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Surname" class="<?php echo $Report1_summary->Surname->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->Surname) ?>', 1);">
											<div class="Report1_Surname">
							...
							<?php if ($Report1_summary->FirstName->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->FirstName) == "") { ?>
									<th data-name="FirstName" class="<?php echo $Report1_summary->FirstName->headerCellClass() ?>">
										<div class="Report1_FirstName">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->FirstName->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="FirstName" class="<?php echo $Report1_summary->FirstName->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->FirstName) ?>', 1);">
											<div class="Report1_FirstName">
							...
							<?php if ($Report1_summary->MiddleName->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->MiddleName) == "") { ?>
									<th data-name="MiddleName" class="<?php echo $Report1_summary->MiddleName->headerCellClass() ?>">
										<div class="Report1_MiddleName">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->MiddleName->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="MiddleName" class="<?php echo $Report1_summary->MiddleName->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->MiddleName) ?>', 1);">
											<div class="Report1_MiddleName">
							...
							<?php if ($Report1_summary->Gender->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->Gender) == "") { ?>
									<th data-name="Gender" class="<?php echo $Report1_summary->Gender->headerCellClass() ?>">
										<div class="Report1_Gender">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->Gender->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Gender" class="<?php echo $Report1_summary->Gender->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->Gender) ?>', 1);">
											<div class="Report1_Gender">
							...
							<?php if ($Report1_summary->MaritalStatus->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->MaritalStatus) == "") { ?>
									<th data-name="MaritalStatus" class="<?php echo $Report1_summary->MaritalStatus->headerCellClass() ?>">
										<div class="Report1_MaritalStatus">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->MaritalStatus->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="MaritalStatus" class="<?php echo $Report1_summary->MaritalStatus->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->MaritalStatus) ?>', 1);">
											<div class="Report1_MaritalStatus">
							...
							<?php if ($Report1_summary->DateOfBirth->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->DateOfBirth) == "") { ?>
									<th data-name="DateOfBirth" class="<?php echo $Report1_summary->DateOfBirth->headerCellClass() ?>">
										<div class="Report1_DateOfBirth">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->DateOfBirth->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="DateOfBirth" class="<?php echo $Report1_summary->DateOfBirth->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->DateOfBirth) ?>', 1);">
											<div class="Report1_DateOfBirth">
							...
							<?php if ($Report1_summary->PostalAddress->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->PostalAddress) == "") { ?>
									<th data-name="PostalAddress" class="<?php echo $Report1_summary->PostalAddress->headerCellClass() ?>">
										<div class="Report1_PostalAddress">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->PostalAddress->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="PostalAddress" class="<?php echo $Report1_summary->PostalAddress->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->PostalAddress) ?>', 1);">
											<div class="Report1_PostalAddress">
							...
							<?php if ($Report1_summary->PhysicalAddress->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->PhysicalAddress) == "") { ?>
									<th data-name="PhysicalAddress" class="<?php echo $Report1_summary->PhysicalAddress->headerCellClass() ?>">
										<div class="Report1_PhysicalAddress">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->PhysicalAddress->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="PhysicalAddress" class="<?php echo $Report1_summary->PhysicalAddress->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->PhysicalAddress) ?>', 1);">
											<div class="Report1_PhysicalAddress">
							...
							<?php if ($Report1_summary->TownOrVillage->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->TownOrVillage) == "") { ?>
									<th data-name="TownOrVillage" class="<?php echo $Report1_summary->TownOrVillage->headerCellClass() ?>">
										<div class="Report1_TownOrVillage">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->TownOrVillage->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="TownOrVillage" class="<?php echo $Report1_summary->TownOrVillage->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->TownOrVillage) ?>', 1);">
											<div class="Report1_TownOrVillage">
							...
							<?php if ($Report1_summary->Mobile->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->Mobile) == "") { ?>
									<th data-name="Mobile" class="<?php echo $Report1_summary->Mobile->headerCellClass() ?>">
										<div class="Report1_Mobile">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->Mobile->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Mobile" class="<?php echo $Report1_summary->Mobile->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->Mobile) ?>', 1);">
											<div class="Report1_Mobile">
							...
							<?php if ($Report1_summary->_Email->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->_Email) == "") { ?>
									<th data-name="_Email" class="<?php echo $Report1_summary->_Email->headerCellClass() ?>">
										<div class="Report1__Email">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->_Email->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="_Email" class="<?php echo $Report1_summary->_Email->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->_Email) ?>', 1);">
											<div class="Report1__Email">
							...
							<?php if ($Report1_summary->NextOfKin->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->NextOfKin) == "") { ?>
									<th data-name="NextOfKin" class="<?php echo $Report1_summary->NextOfKin->headerCellClass() ?>">
										<div class="Report1_NextOfKin">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->NextOfKin->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="NextOfKin" class="<?php echo $Report1_summary->NextOfKin->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->NextOfKin) ?>', 1);">
											<div class="Report1_NextOfKin">
							...
							<?php if ($Report1_summary->NextOfKinMobile->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->NextOfKinMobile) == "") { ?>
									<th data-name="NextOfKinMobile" class="<?php echo $Report1_summary->NextOfKinMobile->headerCellClass() ?>">
										<div class="Report1_NextOfKinMobile">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->NextOfKinMobile->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="NextOfKinMobile" class="<?php echo $Report1_summary->NextOfKinMobile->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->NextOfKinMobile) ?>', 1);">
											<div class="Report1_NextOfKinMobile">
							...
							<?php if ($Report1_summary->NextOfKinEmail->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->NextOfKinEmail) == "") { ?>
									<th data-name="NextOfKinEmail" class="<?php echo $Report1_summary->NextOfKinEmail->headerCellClass() ?>">
										<div class="Report1_NextOfKinEmail">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->NextOfKinEmail->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="NextOfKinEmail" class="<?php echo $Report1_summary->NextOfKinEmail->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->NextOfKinEmail) ?>', 1);">
											<div class="Report1_NextOfKinEmail">
							...
							<?php if ($Report1_summary->AdditionalInformation->Visible) { ?>
								<?php if ($Report1_summary->sortUrl($Report1_summary->AdditionalInformation) == "") { ?>
									<th data-name="AdditionalInformation" class="<?php echo $Report1_summary->AdditionalInformation->headerCellClass() ?>">
										<div class="Report1_AdditionalInformation">
											<div class="ew-table-header-caption"><?php echo $Report1_summary->AdditionalInformation->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="AdditionalInformation" class="<?php echo $Report1_summary->AdditionalInformation->headerCellClass() ?>">
										<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $Report1_summary->sortUrl($Report1_summary->AdditionalInformation) ?>', 1);">
											<div class="Report1_AdditionalInformation">
								...
								<?php if ($Report1_summary->id->Visible) { ?>
									...
									<?php } else { ?>
										<td data-field="id" <?php echo $Report1_summary->id->cellAttributes(); ?>>
											<span<?php echo $Report1_summary->id->viewAttributes() ?>><?php echo $Report1_summary->id->GroupViewValue ?></span>
										</td>
									<?php } ?>
								<?php } ?>
								<?php if ($Report1_summary->ClientName->Visible) { ?>
					...
					<tfoot>
						...
						<?php if ($Report1_summary->id->ShowCompactSummaryFooter) { ?>
							<tr<?php echo $Report1_summary->rowAttributes() ?>>
								<td colspan="<?php echo ($Report1_summary->GroupColumnCount + $Report1_summary->DetailColumnCount) ?>"><?php echo $Language->phrase("RptGrandSummary") ?> <span class="ew-summary-count">(<span class="ew-aggregate-caption"><?php echo $Language->phrase("RptCnt") ?></span><?php echo $Language->phrase("AggregateEqual") ?><span class="ew-aggregate-value"><?php echo FormatNumber($Report1_summary->TotalCount, 0); ?></span>)</span></td>
								</tr>
							<?php } else { ?>
								<tr<?php echo $Report1_summary->rowAttributes() ?>>
									<td colspan="<?php echo ($Report1_summary->GroupColumnCount + $Report1_summary->DetailColumnCount) ?>"><?php echo $Language->phrase("RptGrandSummary") ?> <span class="ew-summary-count">(<?php echo FormatNumber($Report1_summary->TotalCount, 0); ?><?php echo $Language->phrase("RptDtlRec") ?>)</span></td>
									</tr>
								<?php } ?>
					</tfoot>
				</table>
