	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_BillingYear" class="form-group row">
				...
				<div class="<?php echo $billing_period_edit->RightColumnClass ?>">
					<div <?php echo $billing_period_edit->BillingYear->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_billing_period_BillingYear">
								<span<?php echo $billing_period_edit->BillingYear->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_edit->BillingYear->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_edit->BillingYear->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_BillingCycle" class="form-group row">
				...
				<div class="<?php echo $billing_period_edit->RightColumnClass ?>">
					<div <?php echo $billing_period_edit->BillingCycle->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_billing_period_BillingCycle">
								<span<?php echo $billing_period_edit->BillingCycle->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_edit->BillingCycle->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_edit->BillingCycle->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_From" class="form-group row">
				...
				<div class="<?php echo $billing_period_edit->RightColumnClass ?>">
					<div <?php echo $billing_period_edit->From->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
								...
								<?php if (!$billing_period_edit->From->ReadOnly && !$billing_period_edit->From->Disabled && !isset($billing_period_edit->From->EditAttrs["readonly"]) && !isset($billing_period_edit->From->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fbilling_periodedit", "datetimepicker"], function() {
											ew.createDateTimePicker("fbilling_periodedit", "x_From", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_billing_period_From">
								<span<?php echo $billing_period_edit->From->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_edit->From->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_edit->From->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_To" class="form-group row">
				...
				<div class="<?php echo $billing_period_edit->RightColumnClass ?>">
					<div <?php echo $billing_period_edit->To->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
							<span id="el_billing_period_To">
								...
								<?php if (!$billing_period_edit->To->ReadOnly && !$billing_period_edit->To->Disabled && !isset($billing_period_edit->To->EditAttrs["readonly"]) && !isset($billing_period_edit->To->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fbilling_periodedit", "datetimepicker"], function() {
											ew.createDateTimePicker("fbilling_periodedit", "x_To", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_billing_period_To">
								<span<?php echo $billing_period_edit->To->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_edit->To->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_edit->To->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Status" class="form-group row">
				...
				<div class="<?php echo $billing_period_edit->RightColumnClass ?>">
					<div <?php echo $billing_period_edit->Status->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_billing_period_Status">
								<span<?php echo $billing_period_edit->Status->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_edit->Status->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_edit->Status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
