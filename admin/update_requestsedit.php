	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->ClientId->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewClientIdentity" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->NewClientIdentity->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->NewClientIdentity->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewClientName" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->NewClientName->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->NewClientName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewAccountType" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->NewAccountType->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->NewAccountType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewMobileNumber" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->NewMobileNumber->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->NewMobileNumber->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewEmail" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->NewEmail->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->NewEmail->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewAdditionalInformation" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->NewAdditionalInformation->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->NewAdditionalInformation->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_date" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->date->cellAttributes() ?>>
							...
							<?php if (!$update_requests_edit->date->ReadOnly && !$update_requests_edit->date->Disabled && !isset($update_requests_edit->date->EditAttrs["readonly"]) && !isset($update_requests_edit->date->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["fupdate_requestsedit", "datetimepicker"], function() {
										ew.createDateTimePicker("fupdate_requestsedit", "x_date", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 7
										});
						...
						<?php echo $update_requests_edit->date->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_status" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->status->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Property" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->Property->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->Property->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyId" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->PropertyId->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->PropertyId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->PropertyUse->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Comment" class="form-group row">
				...
				<div class="<?php echo $update_requests_edit->RightColumnClass ?>">
					<div <?php echo $update_requests_edit->Comment->cellAttributes() ?>>
						...
						<?php echo $update_requests_edit->Comment->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
