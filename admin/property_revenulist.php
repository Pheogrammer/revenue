							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->id) == "") { ?>
										<th data-name="id" class="<?php echo $property_revenu_list->id->headerCellClass() ?>">
											<div id="elh_property_revenu_id" class="property_revenu_id">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $property_revenu_list->id->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->id) ?>', 1);">
												<div id="elh_property_revenu_id" class="property_revenu_id">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->ClientId) == "") { ?>
										<th data-name="ClientId" class="<?php echo $property_revenu_list->ClientId->headerCellClass() ?>">
											<div id="elh_property_revenu_ClientId" class="property_revenu_ClientId">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->ClientId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientId" class="<?php echo $property_revenu_list->ClientId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->ClientId) ?>', 1);">
												<div id="elh_property_revenu_ClientId" class="property_revenu_ClientId">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->ClientProperty) == "") { ?>
										<th data-name="ClientProperty" class="<?php echo $property_revenu_list->ClientProperty->headerCellClass() ?>">
											<div id="elh_property_revenu_ClientProperty" class="property_revenu_ClientProperty">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->ClientProperty->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientProperty" class="<?php echo $property_revenu_list->ClientProperty->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->ClientProperty) ?>', 1);">
												<div id="elh_property_revenu_ClientProperty" class="property_revenu_ClientProperty">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->PropertyId) == "") { ?>
										<th data-name="PropertyId" class="<?php echo $property_revenu_list->PropertyId->headerCellClass() ?>">
											<div id="elh_property_revenu_PropertyId" class="property_revenu_PropertyId">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->PropertyId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyId" class="<?php echo $property_revenu_list->PropertyId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->PropertyId) ?>', 1);">
												<div id="elh_property_revenu_PropertyId" class="property_revenu_PropertyId">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $property_revenu_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_property_revenu_PropertyUse" class="property_revenu_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $property_revenu_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->PropertyUse) ?>', 1);">
												<div id="elh_property_revenu_PropertyUse" class="property_revenu_PropertyUse">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->AmountPaid) == "") { ?>
										<th data-name="AmountPaid" class="<?php echo $property_revenu_list->AmountPaid->headerCellClass() ?>">
											<div id="elh_property_revenu_AmountPaid" class="property_revenu_AmountPaid">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->AmountPaid->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPaid" class="<?php echo $property_revenu_list->AmountPaid->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->AmountPaid) ?>', 1);">
												<div id="elh_property_revenu_AmountPaid" class="property_revenu_AmountPaid">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->Balance) == "") { ?>
										<th data-name="Balance" class="<?php echo $property_revenu_list->Balance->headerCellClass() ?>">
											<div id="elh_property_revenu_Balance" class="property_revenu_Balance">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->Balance->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Balance" class="<?php echo $property_revenu_list->Balance->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->Balance) ?>', 1);">
												<div id="elh_property_revenu_Balance" class="property_revenu_Balance">
								...
								?>
									<?php if ($property_revenu_list->SortUrl($property_revenu_list->date) == "") { ?>
										<th data-name="date" class="<?php echo $property_revenu_list->date->headerCellClass() ?>">
											<div id="elh_property_revenu_date" class="property_revenu_date">
												<div class="ew-table-header-caption"><?php echo $property_revenu_list->date->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="date" class="<?php echo $property_revenu_list->date->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_revenu_list->SortUrl($property_revenu_list->date) ?>', 1);">
												<div id="elh_property_revenu_date" class="property_revenu_date">
										...
										?>
											<td data-name="id" <?php echo $property_revenu_list->id->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_id">
													<span<?php echo $property_revenu_list->id->viewAttributes() ?>><?php echo $property_revenu_list->id->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientId" <?php echo $property_revenu_list->ClientId->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_ClientId">
													<span<?php echo $property_revenu_list->ClientId->viewAttributes() ?>><?php echo $property_revenu_list->ClientId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientProperty" <?php echo $property_revenu_list->ClientProperty->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_ClientProperty">
													<span<?php echo $property_revenu_list->ClientProperty->viewAttributes() ?>><?php echo $property_revenu_list->ClientProperty->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyId" <?php echo $property_revenu_list->PropertyId->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_PropertyId">
													<span<?php echo $property_revenu_list->PropertyId->viewAttributes() ?>><?php echo $property_revenu_list->PropertyId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyUse" <?php echo $property_revenu_list->PropertyUse->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_PropertyUse">
													<span<?php echo $property_revenu_list->PropertyUse->viewAttributes() ?>><?php echo $property_revenu_list->PropertyUse->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPaid" <?php echo $property_revenu_list->AmountPaid->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_AmountPaid">
													<span<?php echo $property_revenu_list->AmountPaid->viewAttributes() ?>><?php echo $property_revenu_list->AmountPaid->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Balance" <?php echo $property_revenu_list->Balance->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_Balance">
													<span<?php echo $property_revenu_list->Balance->viewAttributes() ?>><?php echo $property_revenu_list->Balance->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="date" <?php echo $property_revenu_list->date->cellAttributes() ?>>
												<span id="el<?php echo $property_revenu_list->RowCount ?>_property_revenu_date">
													<span<?php echo $property_revenu_list->date->viewAttributes() ?>><?php echo $property_revenu_list->date->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
