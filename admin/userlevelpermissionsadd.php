	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_userlevelid" class="form-group row">
				...
				<div class="<?php echo $userlevelpermissions_add->RightColumnClass ?>">
					<div <?php echo $userlevelpermissions_add->userlevelid->cellAttributes() ?>>
						<span id="el_userlevelpermissions_userlevelid">
							<input type="text" data-table="userlevelpermissions" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($userlevelpermissions_add->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevelpermissions_add->userlevelid->EditValue ?>" <?php echo $userlevelpermissions_add->userlevelid->editAttributes() ?>>
						</span>
						<?php echo $userlevelpermissions_add->userlevelid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__tablename" class="form-group row">
				...
				<div class="<?php echo $userlevelpermissions_add->RightColumnClass ?>">
					<div <?php echo $userlevelpermissions_add->_tablename->cellAttributes() ?>>
						...
						<?php echo $userlevelpermissions_add->_tablename->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_permission" class="form-group row">
				...
				<div class="<?php echo $userlevelpermissions_add->RightColumnClass ?>">
					<div <?php echo $userlevelpermissions_add->permission->cellAttributes() ?>>
						<span id="el_userlevelpermissions_permission">
							<input type="text" data-table="userlevelpermissions" data-field="x_permission" name="x_permission" id="x_permission" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($userlevelpermissions_add->permission->getPlaceHolder()) ?>" value="<?php echo $userlevelpermissions_add->permission->EditValue ?>" <?php echo $userlevelpermissions_add->permission->editAttributes() ?>>
						</span>
						<?php echo $userlevelpermissions_add->permission->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
