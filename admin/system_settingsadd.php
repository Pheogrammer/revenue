	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_name" class="form-group row">
				...
				<div class="<?php echo $system_settings_add->RightColumnClass ?>">
					<div <?php echo $system_settings_add->name->cellAttributes() ?>>
						...
						<?php echo $system_settings_add->name->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__email" class="form-group row">
				...
				<div class="<?php echo $system_settings_add->RightColumnClass ?>">
					<div <?php echo $system_settings_add->_email->cellAttributes() ?>>
						...
						<?php echo $system_settings_add->_email->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_contact" class="form-group row">
				...
				<div class="<?php echo $system_settings_add->RightColumnClass ?>">
					<div <?php echo $system_settings_add->contact->cellAttributes() ?>>
						...
						<?php echo $system_settings_add->contact->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
