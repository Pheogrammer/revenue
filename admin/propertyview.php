			...
			<tr id="r_id">
				...
				<td data-name="id" <?php echo $property_view->id->cellAttributes() ?>>
					<span id="el_property_id">
						<span<?php echo $property_view->id->viewAttributes() ?>><?php echo $property_view->id->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientId">
				...
				<td data-name="ClientId" <?php echo $property_view->ClientId->cellAttributes() ?>>
					<span id="el_property_ClientId">
						<span<?php echo $property_view->ClientId->viewAttributes() ?>><?php echo $property_view->ClientId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeGroup">
				...
				<td data-name="ChargeGroup" <?php echo $property_view->ChargeGroup->cellAttributes() ?>>
					<span id="el_property_ChargeGroup">
						<span<?php echo $property_view->ChargeGroup->viewAttributes() ?>><?php echo $property_view->ChargeGroup->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeGropuDes">
				...
				<td data-name="ChargeGropuDes" <?php echo $property_view->ChargeGropuDes->cellAttributes() ?>>
					<span id="el_property_ChargeGropuDes">
						<span<?php echo $property_view->ChargeGropuDes->viewAttributes() ?>><?php echo $property_view->ChargeGropuDes->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeableFee">
				...
				<td data-name="ChargeableFee" <?php echo $property_view->ChargeableFee->cellAttributes() ?>>
					<span id="el_property_ChargeableFee">
						<span<?php echo $property_view->ChargeableFee->viewAttributes() ?>><?php echo $property_view->ChargeableFee->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_BalanceBF">
				...
				<td data-name="BalanceBF" <?php echo $property_view->BalanceBF->cellAttributes() ?>>
					<span id="el_property_BalanceBF">
						<span<?php echo $property_view->BalanceBF->viewAttributes() ?>><?php echo $property_view->BalanceBF->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_AmountPayable">
				...
				<td data-name="AmountPayable" <?php echo $property_view->AmountPayable->cellAttributes() ?>>
					<span id="el_property_AmountPayable">
						<span<?php echo $property_view->AmountPayable->viewAttributes() ?>><?php echo $property_view->AmountPayable->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Property">
				...
				<td data-name="Property" <?php echo $property_view->Property->cellAttributes() ?>>
					<span id="el_property_Property">
						<span<?php echo $property_view->Property->viewAttributes() ?>><?php echo $property_view->Property->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyId">
				...
				<td data-name="PropertyId" <?php echo $property_view->PropertyId->cellAttributes() ?>>
					<span id="el_property_PropertyId">
						<span<?php echo $property_view->PropertyId->viewAttributes() ?>><?php echo $property_view->PropertyId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyUse">
				...
				<td data-name="PropertyUse" <?php echo $property_view->PropertyUse->cellAttributes() ?>>
					<span id="el_property_PropertyUse">
						<span<?php echo $property_view->PropertyUse->viewAttributes() ?>><?php echo $property_view->PropertyUse->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Location">
				...
				<td data-name="Location" <?php echo $property_view->Location->cellAttributes() ?>>
					<span id="el_property_Location">
						<span<?php echo $property_view->Location->viewAttributes() ?>><?php echo $property_view->Location->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_AmountPaid">
				...
				<td data-name="AmountPaid" <?php echo $property_view->AmountPaid->cellAttributes() ?>>
					<span id="el_property_AmountPaid">
						<span<?php echo $property_view->AmountPaid->viewAttributes() ?>><?php echo $property_view->AmountPaid->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_CurrentBalance">
				...
				<td data-name="CurrentBalance" <?php echo $property_view->CurrentBalance->cellAttributes() ?>>
					<span id="el_property_CurrentBalance">
						<span<?php echo $property_view->CurrentBalance->viewAttributes() ?>><?php echo $property_view->CurrentBalance->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Description">
				...
				<td data-name="Description" <?php echo $property_view->Description->cellAttributes() ?>>
					<span id="el_property_Description">
						<span<?php echo $property_view->Description->viewAttributes() ?>><?php echo $property_view->Description->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_DataRegistered">
				...
				<td data-name="DataRegistered" <?php echo $property_view->DataRegistered->cellAttributes() ?>>
					<span id="el_property_DataRegistered">
						<span<?php echo $property_view->DataRegistered->viewAttributes() ?>><?php echo $property_view->DataRegistered->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PhysicalAddress">
				...
				<td data-name="PhysicalAddress" <?php echo $property_view->PhysicalAddress->cellAttributes() ?>>
					<span id="el_property_PhysicalAddress">
						<span<?php echo $property_view->PhysicalAddress->viewAttributes() ?>><?php echo $property_view->PhysicalAddress->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Status">
				...
				<td data-name="Status" <?php echo $property_view->Status->cellAttributes() ?>>
					<span id="el_property_Status">
						<span<?php echo $property_view->Status->viewAttributes() ?>><?php echo $property_view->Status->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
