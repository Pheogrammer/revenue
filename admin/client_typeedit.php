	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_ClientType" class="form-group row">
				...
				<div class="<?php echo $client_type_edit->RightColumnClass ?>">
					<div <?php echo $client_type_edit->ClientType->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_client_type_ClientType">
								<span<?php echo $client_type_edit->ClientType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_type_edit->ClientType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_type_edit->ClientType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
