		...
		<form name="fpropertylist" id="fpropertylist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_property" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($property_list->TotalRecords > 0 || $property_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_propertylist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->id) == "") { ?>
										<th data-name="id" class="<?php echo $property_list->id->headerCellClass() ?>">
											<div id="elh_property_id" class="property_id">
												<div class="ew-table-header-caption"><?php echo $property_list->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $property_list->id->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->id) ?>', 1);">
												<div id="elh_property_id" class="property_id">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->ClientId) == "") { ?>
										<th data-name="ClientId" class="<?php echo $property_list->ClientId->headerCellClass() ?>">
											<div id="elh_property_ClientId" class="property_ClientId">
												<div class="ew-table-header-caption"><?php echo $property_list->ClientId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientId" class="<?php echo $property_list->ClientId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->ClientId) ?>', 1);">
												<div id="elh_property_ClientId" class="property_ClientId">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->ChargeGroup) == "") { ?>
										<th data-name="ChargeGroup" class="<?php echo $property_list->ChargeGroup->headerCellClass() ?>">
											<div id="elh_property_ChargeGroup" class="property_ChargeGroup">
												<div class="ew-table-header-caption"><?php echo $property_list->ChargeGroup->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGroup" class="<?php echo $property_list->ChargeGroup->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->ChargeGroup) ?>', 1);">
												<div id="elh_property_ChargeGroup" class="property_ChargeGroup">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->ChargeGropuDes) == "") { ?>
										<th data-name="ChargeGropuDes" class="<?php echo $property_list->ChargeGropuDes->headerCellClass() ?>">
											<div id="elh_property_ChargeGropuDes" class="property_ChargeGropuDes">
												<div class="ew-table-header-caption"><?php echo $property_list->ChargeGropuDes->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGropuDes" class="<?php echo $property_list->ChargeGropuDes->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->ChargeGropuDes) ?>', 1);">
												<div id="elh_property_ChargeGropuDes" class="property_ChargeGropuDes">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->ChargeableFee) == "") { ?>
										<th data-name="ChargeableFee" class="<?php echo $property_list->ChargeableFee->headerCellClass() ?>">
											<div id="elh_property_ChargeableFee" class="property_ChargeableFee">
												<div class="ew-table-header-caption"><?php echo $property_list->ChargeableFee->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeableFee" class="<?php echo $property_list->ChargeableFee->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->ChargeableFee) ?>', 1);">
												<div id="elh_property_ChargeableFee" class="property_ChargeableFee">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->BalanceBF) == "") { ?>
										<th data-name="BalanceBF" class="<?php echo $property_list->BalanceBF->headerCellClass() ?>">
											<div id="elh_property_BalanceBF" class="property_BalanceBF">
												<div class="ew-table-header-caption"><?php echo $property_list->BalanceBF->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="BalanceBF" class="<?php echo $property_list->BalanceBF->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->BalanceBF) ?>', 1);">
												<div id="elh_property_BalanceBF" class="property_BalanceBF">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->AmountPayable) == "") { ?>
										<th data-name="AmountPayable" class="<?php echo $property_list->AmountPayable->headerCellClass() ?>">
											<div id="elh_property_AmountPayable" class="property_AmountPayable">
												<div class="ew-table-header-caption"><?php echo $property_list->AmountPayable->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPayable" class="<?php echo $property_list->AmountPayable->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->AmountPayable) ?>', 1);">
												<div id="elh_property_AmountPayable" class="property_AmountPayable">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->Property) == "") { ?>
										<th data-name="Property" class="<?php echo $property_list->Property->headerCellClass() ?>">
											<div id="elh_property_Property" class="property_Property">
												<div class="ew-table-header-caption"><?php echo $property_list->Property->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Property" class="<?php echo $property_list->Property->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->Property) ?>', 1);">
												<div id="elh_property_Property" class="property_Property">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->PropertyId) == "") { ?>
										<th data-name="PropertyId" class="<?php echo $property_list->PropertyId->headerCellClass() ?>">
											<div id="elh_property_PropertyId" class="property_PropertyId">
												<div class="ew-table-header-caption"><?php echo $property_list->PropertyId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyId" class="<?php echo $property_list->PropertyId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->PropertyId) ?>', 1);">
												<div id="elh_property_PropertyId" class="property_PropertyId">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $property_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_property_PropertyUse" class="property_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $property_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $property_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->PropertyUse) ?>', 1);">
												<div id="elh_property_PropertyUse" class="property_PropertyUse">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->Location) == "") { ?>
										<th data-name="Location" class="<?php echo $property_list->Location->headerCellClass() ?>">
											<div id="elh_property_Location" class="property_Location">
												<div class="ew-table-header-caption"><?php echo $property_list->Location->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Location" class="<?php echo $property_list->Location->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->Location) ?>', 1);">
												<div id="elh_property_Location" class="property_Location">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->AmountPaid) == "") { ?>
										<th data-name="AmountPaid" class="<?php echo $property_list->AmountPaid->headerCellClass() ?>">
											<div id="elh_property_AmountPaid" class="property_AmountPaid">
												<div class="ew-table-header-caption"><?php echo $property_list->AmountPaid->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPaid" class="<?php echo $property_list->AmountPaid->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->AmountPaid) ?>', 1);">
												<div id="elh_property_AmountPaid" class="property_AmountPaid">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->CurrentBalance) == "") { ?>
										<th data-name="CurrentBalance" class="<?php echo $property_list->CurrentBalance->headerCellClass() ?>">
											<div id="elh_property_CurrentBalance" class="property_CurrentBalance">
												<div class="ew-table-header-caption"><?php echo $property_list->CurrentBalance->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="CurrentBalance" class="<?php echo $property_list->CurrentBalance->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->CurrentBalance) ?>', 1);">
												<div id="elh_property_CurrentBalance" class="property_CurrentBalance">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->DataRegistered) == "") { ?>
										<th data-name="DataRegistered" class="<?php echo $property_list->DataRegistered->headerCellClass() ?>">
											<div id="elh_property_DataRegistered" class="property_DataRegistered">
												<div class="ew-table-header-caption"><?php echo $property_list->DataRegistered->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="DataRegistered" class="<?php echo $property_list->DataRegistered->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->DataRegistered) ?>', 1);">
												<div id="elh_property_DataRegistered" class="property_DataRegistered">
								...
								?>
									<?php if ($property_list->SortUrl($property_list->Status) == "") { ?>
										<th data-name="Status" class="<?php echo $property_list->Status->headerCellClass() ?>">
											<div id="elh_property_Status" class="property_Status">
												<div class="ew-table-header-caption"><?php echo $property_list->Status->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Status" class="<?php echo $property_list->Status->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_list->SortUrl($property_list->Status) ?>', 1);">
												<div id="elh_property_Status" class="property_Status">
										...
										?>
											<td data-name="id" <?php echo $property_list->id->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_id">
													<span<?php echo $property_list->id->viewAttributes() ?>><?php echo $property_list->id->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientId" <?php echo $property_list->ClientId->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_ClientId">
													<span<?php echo $property_list->ClientId->viewAttributes() ?>><?php echo $property_list->ClientId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeGroup" <?php echo $property_list->ChargeGroup->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_ChargeGroup">
													<span<?php echo $property_list->ChargeGroup->viewAttributes() ?>><?php echo $property_list->ChargeGroup->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeGropuDes" <?php echo $property_list->ChargeGropuDes->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_ChargeGropuDes">
													<span<?php echo $property_list->ChargeGropuDes->viewAttributes() ?>><?php echo $property_list->ChargeGropuDes->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeableFee" <?php echo $property_list->ChargeableFee->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_ChargeableFee">
													<span<?php echo $property_list->ChargeableFee->viewAttributes() ?>><?php echo $property_list->ChargeableFee->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="BalanceBF" <?php echo $property_list->BalanceBF->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_BalanceBF">
													<span<?php echo $property_list->BalanceBF->viewAttributes() ?>><?php echo $property_list->BalanceBF->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPayable" <?php echo $property_list->AmountPayable->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_AmountPayable">
													<span<?php echo $property_list->AmountPayable->viewAttributes() ?>><?php echo $property_list->AmountPayable->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Property" <?php echo $property_list->Property->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_Property">
													<span<?php echo $property_list->Property->viewAttributes() ?>><?php echo $property_list->Property->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyId" <?php echo $property_list->PropertyId->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_PropertyId">
													<span<?php echo $property_list->PropertyId->viewAttributes() ?>><?php echo $property_list->PropertyId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyUse" <?php echo $property_list->PropertyUse->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_PropertyUse">
													<span<?php echo $property_list->PropertyUse->viewAttributes() ?>><?php echo $property_list->PropertyUse->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Location" <?php echo $property_list->Location->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_Location">
													<span<?php echo $property_list->Location->viewAttributes() ?>><?php echo $property_list->Location->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPaid" <?php echo $property_list->AmountPaid->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_AmountPaid">
													<span<?php echo $property_list->AmountPaid->viewAttributes() ?>><?php echo $property_list->AmountPaid->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="CurrentBalance" <?php echo $property_list->CurrentBalance->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_CurrentBalance">
													<span<?php echo $property_list->CurrentBalance->viewAttributes() ?>><?php echo $property_list->CurrentBalance->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="DataRegistered" <?php echo $property_list->DataRegistered->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_DataRegistered">
													<span<?php echo $property_list->DataRegistered->viewAttributes() ?>><?php echo $property_list->DataRegistered->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Status" <?php echo $property_list->Status->cellAttributes() ?>>
												<span id="el<?php echo $property_list->RowCount ?>_property_Status">
													<span<?php echo $property_list->Status->viewAttributes() ?>><?php echo $property_list->Status->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
