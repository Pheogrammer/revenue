			...
			<tr id="r_id">
				...
				<td data-name="id" <?php echo $client_view->id->cellAttributes() ?>>
					<span id="el_client_id">
						<span<?php echo $client_view->id->viewAttributes() ?>><?php echo $client_view->id->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientName">
				...
				<td data-name="ClientName" <?php echo $client_view->ClientName->cellAttributes() ?>>
					<span id="el_client_ClientName">
						<span<?php echo $client_view->ClientName->viewAttributes() ?>><?php echo $client_view->ClientName->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientType">
				...
				<td data-name="ClientType" <?php echo $client_view->ClientType->cellAttributes() ?>>
					<span id="el_client_ClientType">
						<span<?php echo $client_view->ClientType->viewAttributes() ?>><?php echo $client_view->ClientType->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_IdentityType">
				...
				<td data-name="IdentityType" <?php echo $client_view->IdentityType->cellAttributes() ?>>
					<span id="el_client_IdentityType">
						<span<?php echo $client_view->IdentityType->viewAttributes() ?>><?php echo $client_view->IdentityType->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientID">
				...
				<td data-name="ClientID" <?php echo $client_view->ClientID->cellAttributes() ?>>
					<span id="el_client_ClientID">
						<span<?php echo $client_view->ClientID->viewAttributes() ?>><?php echo $client_view->ClientID->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Surname">
				...
				<td data-name="Surname" <?php echo $client_view->Surname->cellAttributes() ?>>
					<span id="el_client_Surname">
						<span<?php echo $client_view->Surname->viewAttributes() ?>><?php echo $client_view->Surname->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_FirstName">
				...
				<td data-name="FirstName" <?php echo $client_view->FirstName->cellAttributes() ?>>
					<span id="el_client_FirstName">
						<span<?php echo $client_view->FirstName->viewAttributes() ?>><?php echo $client_view->FirstName->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_MiddleName">
				...
				<td data-name="MiddleName" <?php echo $client_view->MiddleName->cellAttributes() ?>>
					<span id="el_client_MiddleName">
						<span<?php echo $client_view->MiddleName->viewAttributes() ?>><?php echo $client_view->MiddleName->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Gender">
				...
				<td data-name="Gender" <?php echo $client_view->Gender->cellAttributes() ?>>
					<span id="el_client_Gender">
						<span<?php echo $client_view->Gender->viewAttributes() ?>><?php echo $client_view->Gender->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_MaritalStatus">
				...
				<td data-name="MaritalStatus" <?php echo $client_view->MaritalStatus->cellAttributes() ?>>
					<span id="el_client_MaritalStatus">
						<span<?php echo $client_view->MaritalStatus->viewAttributes() ?>><?php echo $client_view->MaritalStatus->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_DateOfBirth">
				...
				<td data-name="DateOfBirth" <?php echo $client_view->DateOfBirth->cellAttributes() ?>>
					<span id="el_client_DateOfBirth">
						<span<?php echo $client_view->DateOfBirth->viewAttributes() ?>><?php echo $client_view->DateOfBirth->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PostalAddress">
				...
				<td data-name="PostalAddress" <?php echo $client_view->PostalAddress->cellAttributes() ?>>
					<span id="el_client_PostalAddress">
						<span<?php echo $client_view->PostalAddress->viewAttributes() ?>><?php echo $client_view->PostalAddress->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PhysicalAddress">
				...
				<td data-name="PhysicalAddress" <?php echo $client_view->PhysicalAddress->cellAttributes() ?>>
					<span id="el_client_PhysicalAddress">
						<span<?php echo $client_view->PhysicalAddress->viewAttributes() ?>><?php echo $client_view->PhysicalAddress->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_TownOrVillage">
				...
				<td data-name="TownOrVillage" <?php echo $client_view->TownOrVillage->cellAttributes() ?>>
					<span id="el_client_TownOrVillage">
						<span<?php echo $client_view->TownOrVillage->viewAttributes() ?>><?php echo $client_view->TownOrVillage->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Mobile">
				...
				<td data-name="Mobile" <?php echo $client_view->Mobile->cellAttributes() ?>>
					<span id="el_client_Mobile">
						<span<?php echo $client_view->Mobile->viewAttributes() ?>><?php echo $client_view->Mobile->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r__Email">
				...
				<td data-name="_Email" <?php echo $client_view->_Email->cellAttributes() ?>>
					<span id="el_client__Email">
						<span<?php echo $client_view->_Email->viewAttributes() ?>><?php echo $client_view->_Email->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NextOfKin">
				...
				<td data-name="NextOfKin" <?php echo $client_view->NextOfKin->cellAttributes() ?>>
					<span id="el_client_NextOfKin">
						<span<?php echo $client_view->NextOfKin->viewAttributes() ?>><?php echo $client_view->NextOfKin->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NextOfKinMobile">
				...
				<td data-name="NextOfKinMobile" <?php echo $client_view->NextOfKinMobile->cellAttributes() ?>>
					<span id="el_client_NextOfKinMobile">
						<span<?php echo $client_view->NextOfKinMobile->viewAttributes() ?>><?php echo $client_view->NextOfKinMobile->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NextOfKinEmail">
				...
				<td data-name="NextOfKinEmail" <?php echo $client_view->NextOfKinEmail->cellAttributes() ?>>
					<span id="el_client_NextOfKinEmail">
						<span<?php echo $client_view->NextOfKinEmail->viewAttributes() ?>><?php echo $client_view->NextOfKinEmail->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_AdditionalInformation">
				...
				<td data-name="AdditionalInformation" <?php echo $client_view->AdditionalInformation->cellAttributes() ?>>
					<span id="el_client_AdditionalInformation">
						<span<?php echo $client_view->AdditionalInformation->viewAttributes() ?>><?php echo $client_view->AdditionalInformation->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
