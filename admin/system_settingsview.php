			...
			<tr id="r_name">
				...
				<td data-name="name" <?php echo $system_settings_view->name->cellAttributes() ?>>
					<span id="el_system_settings_name">
						<span<?php echo $system_settings_view->name->viewAttributes() ?>><?php echo $system_settings_view->name->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r__email">
				...
				<td data-name="_email" <?php echo $system_settings_view->_email->cellAttributes() ?>>
					<span id="el_system_settings__email">
						<span<?php echo $system_settings_view->_email->viewAttributes() ?>><?php echo $system_settings_view->_email->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_contact">
				...
				<td data-name="contact" <?php echo $system_settings_view->contact->cellAttributes() ?>>
					<span id="el_system_settings_contact">
						<span<?php echo $system_settings_view->contact->viewAttributes() ?>><?php echo $system_settings_view->contact->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
