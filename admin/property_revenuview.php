			...
			<tr id="r_id">
				...
				<td data-name="id" <?php echo $property_revenu_view->id->cellAttributes() ?>>
					<span id="el_property_revenu_id">
						<span<?php echo $property_revenu_view->id->viewAttributes() ?>><?php echo $property_revenu_view->id->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientId">
				...
				<td data-name="ClientId" <?php echo $property_revenu_view->ClientId->cellAttributes() ?>>
					<span id="el_property_revenu_ClientId">
						<span<?php echo $property_revenu_view->ClientId->viewAttributes() ?>><?php echo $property_revenu_view->ClientId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientProperty">
				...
				<td data-name="ClientProperty" <?php echo $property_revenu_view->ClientProperty->cellAttributes() ?>>
					<span id="el_property_revenu_ClientProperty">
						<span<?php echo $property_revenu_view->ClientProperty->viewAttributes() ?>><?php echo $property_revenu_view->ClientProperty->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyId">
				...
				<td data-name="PropertyId" <?php echo $property_revenu_view->PropertyId->cellAttributes() ?>>
					<span id="el_property_revenu_PropertyId">
						<span<?php echo $property_revenu_view->PropertyId->viewAttributes() ?>><?php echo $property_revenu_view->PropertyId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyUse">
				...
				<td data-name="PropertyUse" <?php echo $property_revenu_view->PropertyUse->cellAttributes() ?>>
					<span id="el_property_revenu_PropertyUse">
						<span<?php echo $property_revenu_view->PropertyUse->viewAttributes() ?>><?php echo $property_revenu_view->PropertyUse->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_AmountPaid">
				...
				<td data-name="AmountPaid" <?php echo $property_revenu_view->AmountPaid->cellAttributes() ?>>
					<span id="el_property_revenu_AmountPaid">
						<span<?php echo $property_revenu_view->AmountPaid->viewAttributes() ?>><?php echo $property_revenu_view->AmountPaid->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Balance">
				...
				<td data-name="Balance" <?php echo $property_revenu_view->Balance->cellAttributes() ?>>
					<span id="el_property_revenu_Balance">
						<span<?php echo $property_revenu_view->Balance->viewAttributes() ?>><?php echo $property_revenu_view->Balance->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_date">
				...
				<td data-name="date" <?php echo $property_revenu_view->date->cellAttributes() ?>>
					<span id="el_property_revenu_date">
						<span<?php echo $property_revenu_view->date->viewAttributes() ?>><?php echo $property_revenu_view->date->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
