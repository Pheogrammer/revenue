	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_userlevelid" class="form-group row">
				...
				<div class="<?php echo $userlevels_edit->RightColumnClass ?>">
					<div <?php echo $userlevels_edit->userlevelid->cellAttributes() ?>>
						<input type="text" data-table="userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($userlevels_edit->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevels_edit->userlevelid->EditValue ?>" <?php echo $userlevels_edit->userlevelid->editAttributes() ?>>
						...
						<?php echo $userlevels_edit->userlevelid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_userlevelname" class="form-group row">
				...
				<div class="<?php echo $userlevels_edit->RightColumnClass ?>">
					<div <?php echo $userlevels_edit->userlevelname->cellAttributes() ?>>
						<span id="el_userlevels_userlevelname">
							<input type="text" data-table="userlevels" data-field="x_userlevelname" name="x_userlevelname" id="x_userlevelname" size="30" maxlength="80" placeholder="<?php echo HtmlEncode($userlevels_edit->userlevelname->getPlaceHolder()) ?>" value="<?php echo $userlevels_edit->userlevelname->EditValue ?>" <?php echo $userlevels_edit->userlevelname->editAttributes() ?>>
						</span>
						<?php echo $userlevels_edit->userlevelname->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
