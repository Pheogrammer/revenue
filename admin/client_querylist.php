		...
		<form name="fclient_querylist" id="fclient_querylist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_client_query" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($client_query_list->TotalRecords > 0 || $client_query_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" id="myDataTable" id="tbl_client_querylist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($client_query_list->SortUrl($client_query_list->ClientId) == "") { ?>
										<th data-name="ClientId" class="<?php echo $client_query_list->ClientId->headerCellClass() ?>">
											<div id="elh_client_query_ClientId" class="client_query_ClientId">
												<div class="ew-table-header-caption"><?php echo $client_query_list->ClientId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientId" class="<?php echo $client_query_list->ClientId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_query_list->SortUrl($client_query_list->ClientId) ?>', 1);">
												<div id="elh_client_query_ClientId" class="client_query_ClientId">
								...
								?>
									<?php if ($client_query_list->SortUrl($client_query_list->Date) == "") { ?>
										<th data-name="Date" class="<?php echo $client_query_list->Date->headerCellClass() ?>">
											<div id="elh_client_query_Date" class="client_query_Date">
												<div class="ew-table-header-caption"><?php echo $client_query_list->Date->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Date" class="<?php echo $client_query_list->Date->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_query_list->SortUrl($client_query_list->Date) ?>', 1);">
												<div id="elh_client_query_Date" class="client_query_Date">
								...
								?>
									<?php if ($client_query_list->SortUrl($client_query_list->Status) == "") { ?>
										<th data-name="Status" class="<?php echo $client_query_list->Status->headerCellClass() ?>">
											<div id="elh_client_query_Status" class="client_query_Status">
												<div class="ew-table-header-caption"><?php echo $client_query_list->Status->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Status" class="<?php echo $client_query_list->Status->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_query_list->SortUrl($client_query_list->Status) ?>', 1);">
												<div id="elh_client_query_Status" class="client_query_Status">
										...
										?>
											<td data-name="ClientId" <?php echo $client_query_list->ClientId->cellAttributes() ?>>
												<span id="el<?php echo $client_query_list->RowCount ?>_client_query_ClientId">
													<span<?php echo $client_query_list->ClientId->viewAttributes() ?>><?php echo $client_query_list->ClientId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Date" <?php echo $client_query_list->Date->cellAttributes() ?>>
												<span id="el<?php echo $client_query_list->RowCount ?>_client_query_Date">
													<span<?php echo $client_query_list->Date->viewAttributes() ?>><?php echo $client_query_list->Date->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Status" <?php echo $client_query_list->Status->cellAttributes() ?>>
												<span id="el<?php echo $client_query_list->RowCount ?>_client_query_Status">
													<span<?php echo $client_query_list->Status->viewAttributes() ?>><?php echo $client_query_list->Status->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
