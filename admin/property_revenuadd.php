...
<script>
	loadjs.ready("head", function() {
		...
		// Client script
		$("#x_AmountPayable").prop("readonly", "true"), $("#x_PropertyUse").prop("readonly", "true"), $("#x_Balance").prop("readonly", "true"), $("#x_AmountPaid").on("focus input change", function() {
			var e = parseFloat(document.getElementById("x_AmountPayable").value),
				a = parseFloat(document.getElementById("x_AmountPaid").value);
			document.getElementById("x_Balance").value = +e - a
		});
	});
</script>
	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->ClientId->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<?php if ($property_revenu_add->ClientId->getSessionValue() != "") { ?>
								<span id="el_property_revenu_ClientId">
									<span<?php echo $property_revenu_add->ClientId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->ClientId->ViewValue)) ?>">
								</span>
								</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientProperty" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->ClientProperty->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_ClientProperty">
								...
								<script>
									loadjs.ready(["fproperty_revenuadd"], function() {
										fproperty_revenuadd.createAutoSuggest({
											"id": "x_ClientProperty",
											"forceSelect": true
										});
									});
						...
						<?php } else { ?>
							<span id="el_property_revenu_ClientProperty">
								<span<?php echo $property_revenu_add->ClientProperty->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->ClientProperty->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->ClientProperty->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyId" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->PropertyId->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_revenu_PropertyId">
								<span<?php echo $property_revenu_add->PropertyId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->PropertyId->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->PropertyId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->PropertyUse->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_revenu_PropertyUse">
								<span<?php echo $property_revenu_add->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPayable" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->AmountPayable->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_AmountPayable">
								<input type="text" data-table="property_revenu" data-field="x_AmountPayable" name="x_AmountPayable" id="x_AmountPayable" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($property_revenu_add->AmountPayable->getPlaceHolder()) ?>" value="<?php echo $property_revenu_add->AmountPayable->EditValue ?>" <?php echo $property_revenu_add->AmountPayable->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_property_revenu_AmountPayable">
								<span<?php echo $property_revenu_add->AmountPayable->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->AmountPayable->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->AmountPayable->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPaid" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->AmountPaid->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_AmountPaid">
								<input type="text" data-table="property_revenu" data-field="x_AmountPaid" name="x_AmountPaid" id="x_AmountPaid" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($property_revenu_add->AmountPaid->getPlaceHolder()) ?>" value="<?php echo $property_revenu_add->AmountPaid->EditValue ?>" <?php echo $property_revenu_add->AmountPaid->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_property_revenu_AmountPaid">
								<span<?php echo $property_revenu_add->AmountPaid->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->AmountPaid->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->AmountPaid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Balance" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->Balance->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_Balance">
								<input type="text" data-table="property_revenu" data-field="x_Balance" name="x_Balance" id="x_Balance" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($property_revenu_add->Balance->getPlaceHolder()) ?>" value="<?php echo $property_revenu_add->Balance->EditValue ?>" <?php echo $property_revenu_add->Balance->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_property_revenu_Balance">
								<span<?php echo $property_revenu_add->Balance->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->Balance->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->Balance->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_date" class="form-group row">
				...
				<div class="<?php echo $property_revenu_add->RightColumnClass ?>">
					<div <?php echo $property_revenu_add->date->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
								...
								<?php if (!$property_revenu_add->date->ReadOnly && !$property_revenu_add->date->Disabled && !isset($property_revenu_add->date->EditAttrs["readonly"]) && !isset($property_revenu_add->date->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fproperty_revenuadd", "datetimepicker"], function() {
											ew.createDateTimePicker("fproperty_revenuadd", "x_date", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 7
											});
						...
						<?php } else { ?>
							<span id="el_property_revenu_date">
								<span<?php echo $property_revenu_add->date->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_add->date->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_add->date->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
