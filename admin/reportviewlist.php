							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($reportview_list->SortUrl($reportview_list->ChargeGroupName) == "") { ?>
										<th data-name="ChargeGroupName" class="<?php echo $reportview_list->ChargeGroupName->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_reportview_ChargeGroupName" class="reportview_ChargeGroupName">
												<div class="ew-table-header-caption"><?php echo $reportview_list->ChargeGroupName->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGroupName" class="<?php echo $reportview_list->ChargeGroupName->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $reportview_list->SortUrl($reportview_list->ChargeGroupName) ?>', 1);">
												<div id="elh_reportview_ChargeGroupName" class="reportview_ChargeGroupName">
								...
								?>
									<?php if ($reportview_list->SortUrl($reportview_list->AmountPayable) == "") { ?>
										<th data-name="AmountPayable" class="<?php echo $reportview_list->AmountPayable->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_reportview_AmountPayable" class="reportview_AmountPayable">
												<div class="ew-table-header-caption"><?php echo $reportview_list->AmountPayable->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPayable" class="<?php echo $reportview_list->AmountPayable->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $reportview_list->SortUrl($reportview_list->AmountPayable) ?>', 1);">
												<div id="elh_reportview_AmountPayable" class="reportview_AmountPayable">
								...
								?>
									<?php if ($reportview_list->SortUrl($reportview_list->AmountPaid) == "") { ?>
										<th data-name="AmountPaid" class="<?php echo $reportview_list->AmountPaid->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_reportview_AmountPaid" class="reportview_AmountPaid">
												<div class="ew-table-header-caption"><?php echo $reportview_list->AmountPaid->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPaid" class="<?php echo $reportview_list->AmountPaid->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $reportview_list->SortUrl($reportview_list->AmountPaid) ?>', 1);">
												<div id="elh_reportview_AmountPaid" class="reportview_AmountPaid">
								...
								?>
									<?php if ($reportview_list->SortUrl($reportview_list->Balance) == "") { ?>
										<th data-name="Balance" class="<?php echo $reportview_list->Balance->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_reportview_Balance" class="reportview_Balance">
												<div class="ew-table-header-caption"><?php echo $reportview_list->Balance->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Balance" class="<?php echo $reportview_list->Balance->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $reportview_list->SortUrl($reportview_list->Balance) ?>', 1);">
												<div id="elh_reportview_Balance" class="reportview_Balance">
								...
								?>
									<?php if ($reportview_list->SortUrl($reportview_list->date) == "") { ?>
										<th data-name="date" class="<?php echo $reportview_list->date->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_reportview_date" class="reportview_date">
												<div class="ew-table-header-caption"><?php echo $reportview_list->date->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="date" class="<?php echo $reportview_list->date->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $reportview_list->SortUrl($reportview_list->date) ?>', 1);">
												<div id="elh_reportview_date" class="reportview_date">
										...
										?>
											<td data-name="ChargeGroupName" <?php echo $reportview_list->ChargeGroupName->cellAttributes() ?>>
												<span id="el<?php echo $reportview_list->RowCount ?>_reportview_ChargeGroupName">
													<span<?php echo $reportview_list->ChargeGroupName->viewAttributes() ?>><?php echo $reportview_list->ChargeGroupName->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPayable" <?php echo $reportview_list->AmountPayable->cellAttributes() ?>>
												<span id="el<?php echo $reportview_list->RowCount ?>_reportview_AmountPayable">
													<span<?php echo $reportview_list->AmountPayable->viewAttributes() ?>><?php echo $reportview_list->AmountPayable->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPaid" <?php echo $reportview_list->AmountPaid->cellAttributes() ?>>
												<span id="el<?php echo $reportview_list->RowCount ?>_reportview_AmountPaid">
													<span<?php echo $reportview_list->AmountPaid->viewAttributes() ?>><?php echo $reportview_list->AmountPaid->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Balance" <?php echo $reportview_list->Balance->cellAttributes() ?>>
												<span id="el<?php echo $reportview_list->RowCount ?>_reportview_Balance">
													<span<?php echo $reportview_list->Balance->viewAttributes() ?>><?php echo $reportview_list->Balance->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="date" <?php echo $reportview_list->date->cellAttributes() ?>>
												<span id="el<?php echo $reportview_list->RowCount ?>_reportview_date">
													<span<?php echo $reportview_list->date->viewAttributes() ?>><?php echo $reportview_list->date->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
