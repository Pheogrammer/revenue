		...
		<form name="fchargeslist" id="fchargeslist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_charges" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($charges_list->TotalRecords > 0 || $charges_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_chargeslist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->ChargeCode) == "") { ?>
										<th data-name="ChargeCode" class="<?php echo $charges_list->ChargeCode->headerCellClass() ?>">
											<div id="elh_charges_ChargeCode" class="charges_ChargeCode">
												<div class="ew-table-header-caption"><?php echo $charges_list->ChargeCode->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeCode" class="<?php echo $charges_list->ChargeCode->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->ChargeCode) ?>', 1);">
												<div id="elh_charges_ChargeCode" class="charges_ChargeCode">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->ChargeGroup) == "") { ?>
										<th data-name="ChargeGroup" class="<?php echo $charges_list->ChargeGroup->headerCellClass() ?>">
											<div id="elh_charges_ChargeGroup" class="charges_ChargeGroup">
												<div class="ew-table-header-caption"><?php echo $charges_list->ChargeGroup->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGroup" class="<?php echo $charges_list->ChargeGroup->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->ChargeGroup) ?>', 1);">
												<div id="elh_charges_ChargeGroup" class="charges_ChargeGroup">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->ChargeDesc) == "") { ?>
										<th data-name="ChargeDesc" class="<?php echo $charges_list->ChargeDesc->headerCellClass() ?>">
											<div id="elh_charges_ChargeDesc" class="charges_ChargeDesc">
												<div class="ew-table-header-caption"><?php echo $charges_list->ChargeDesc->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeDesc" class="<?php echo $charges_list->ChargeDesc->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->ChargeDesc) ?>', 1);">
												<div id="elh_charges_ChargeDesc" class="charges_ChargeDesc">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $charges_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_charges_PropertyUse" class="charges_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $charges_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $charges_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->PropertyUse) ?>', 1);">
												<div id="elh_charges_PropertyUse" class="charges_PropertyUse">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->Fee) == "") { ?>
										<th data-name="Fee" class="<?php echo $charges_list->Fee->headerCellClass() ?>">
											<div id="elh_charges_Fee" class="charges_Fee">
												<div class="ew-table-header-caption"><?php echo $charges_list->Fee->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Fee" class="<?php echo $charges_list->Fee->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->Fee) ?>', 1);">
												<div id="elh_charges_Fee" class="charges_Fee">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->Factor) == "") { ?>
										<th data-name="Factor" class="<?php echo $charges_list->Factor->headerCellClass() ?>">
											<div id="elh_charges_Factor" class="charges_Factor">
												<div class="ew-table-header-caption"><?php echo $charges_list->Factor->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Factor" class="<?php echo $charges_list->Factor->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->Factor) ?>', 1);">
												<div id="elh_charges_Factor" class="charges_Factor">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->UnitOfMeasure) == "") { ?>
										<th data-name="UnitOfMeasure" class="<?php echo $charges_list->UnitOfMeasure->headerCellClass() ?>">
											<div id="elh_charges_UnitOfMeasure" class="charges_UnitOfMeasure">
												<div class="ew-table-header-caption"><?php echo $charges_list->UnitOfMeasure->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="UnitOfMeasure" class="<?php echo $charges_list->UnitOfMeasure->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->UnitOfMeasure) ?>', 1);">
												<div id="elh_charges_UnitOfMeasure" class="charges_UnitOfMeasure">
								...
								?>
									<?php if ($charges_list->SortUrl($charges_list->PeriodType) == "") { ?>
										<th data-name="PeriodType" class="<?php echo $charges_list->PeriodType->headerCellClass() ?>">
											<div id="elh_charges_PeriodType" class="charges_PeriodType">
												<div class="ew-table-header-caption"><?php echo $charges_list->PeriodType->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PeriodType" class="<?php echo $charges_list->PeriodType->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charges_list->SortUrl($charges_list->PeriodType) ?>', 1);">
												<div id="elh_charges_PeriodType" class="charges_PeriodType">
										...
										?>
											<td data-name="ChargeCode" <?php echo $charges_list->ChargeCode->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_ChargeCode">
													<span<?php echo $charges_list->ChargeCode->viewAttributes() ?>><?php echo $charges_list->ChargeCode->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeGroup" <?php echo $charges_list->ChargeGroup->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_ChargeGroup">
													<span<?php echo $charges_list->ChargeGroup->viewAttributes() ?>><?php echo $charges_list->ChargeGroup->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeDesc" <?php echo $charges_list->ChargeDesc->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_ChargeDesc">
													<span<?php echo $charges_list->ChargeDesc->viewAttributes() ?>><?php echo $charges_list->ChargeDesc->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyUse" <?php echo $charges_list->PropertyUse->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_PropertyUse">
													<span<?php echo $charges_list->PropertyUse->viewAttributes() ?>><?php echo $charges_list->PropertyUse->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Fee" <?php echo $charges_list->Fee->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_Fee">
													<span<?php echo $charges_list->Fee->viewAttributes() ?>><?php echo $charges_list->Fee->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Factor" <?php echo $charges_list->Factor->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_Factor">
													<span<?php echo $charges_list->Factor->viewAttributes() ?>><?php echo $charges_list->Factor->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="UnitOfMeasure" <?php echo $charges_list->UnitOfMeasure->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_UnitOfMeasure">
													<span<?php echo $charges_list->UnitOfMeasure->viewAttributes() ?>><?php echo $charges_list->UnitOfMeasure->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PeriodType" <?php echo $charges_list->PeriodType->cellAttributes() ?>>
												<span id="el<?php echo $charges_list->RowCount ?>_charges_PeriodType">
													<span<?php echo $charges_list->PeriodType->viewAttributes() ?>><?php echo $charges_list->PeriodType->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
