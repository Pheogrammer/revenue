	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_name" class="form-group row">
				...
				<div class="<?php echo $system_settings_edit->RightColumnClass ?>">
					<div <?php echo $system_settings_edit->name->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_system_settings_name">
								<span<?php echo $system_settings_edit->name->viewAttributes() ?>><?php echo $system_settings_edit->name->ViewValue ?>
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $system_settings_edit->name->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__email" class="form-group row">
				...
				<div class="<?php echo $system_settings_edit->RightColumnClass ?>">
					<div <?php echo $system_settings_edit->_email->cellAttributes() ?>>
						<?php if (!$system_settings->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_system_settings__email">
								<span<?php echo $system_settings_edit->_email->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($system_settings_edit->_email->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $system_settings_edit->_email->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_contact" class="form-group row">
				...
				<div class="<?php echo $system_settings_edit->RightColumnClass ?>">
					<div <?php echo $system_settings_edit->contact->cellAttributes() ?>>
						<?php if (!$system_settings->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_system_settings_contact">
								<span<?php echo $system_settings_edit->contact->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($system_settings_edit->contact->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $system_settings_edit->contact->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
