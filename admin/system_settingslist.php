							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($system_settings_list->SortUrl($system_settings_list->name) == "") { ?>
										<th data-name="name" class="<?php echo $system_settings_list->name->headerCellClass() ?>">
											<div id="elh_system_settings_name" class="system_settings_name">
												<div class="ew-table-header-caption"><?php echo $system_settings_list->name->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="name" class="<?php echo $system_settings_list->name->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $system_settings_list->SortUrl($system_settings_list->name) ?>', 1);">
												<div id="elh_system_settings_name" class="system_settings_name">
								...
								?>
									<?php if ($system_settings_list->SortUrl($system_settings_list->_email) == "") { ?>
										<th data-name="_email" class="<?php echo $system_settings_list->_email->headerCellClass() ?>">
											<div id="elh_system_settings__email" class="system_settings__email">
												<div class="ew-table-header-caption"><?php echo $system_settings_list->_email->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="_email" class="<?php echo $system_settings_list->_email->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $system_settings_list->SortUrl($system_settings_list->_email) ?>', 1);">
												<div id="elh_system_settings__email" class="system_settings__email">
								...
								?>
									<?php if ($system_settings_list->SortUrl($system_settings_list->contact) == "") { ?>
										<th data-name="contact" class="<?php echo $system_settings_list->contact->headerCellClass() ?>">
											<div id="elh_system_settings_contact" class="system_settings_contact">
												<div class="ew-table-header-caption"><?php echo $system_settings_list->contact->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="contact" class="<?php echo $system_settings_list->contact->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $system_settings_list->SortUrl($system_settings_list->contact) ?>', 1);">
												<div id="elh_system_settings_contact" class="system_settings_contact">
										...
										?>
											<td data-name="name" <?php echo $system_settings_list->name->cellAttributes() ?>>
												<span id="el<?php echo $system_settings_list->RowCount ?>_system_settings_name">
													<span<?php echo $system_settings_list->name->viewAttributes() ?>><?php echo $system_settings_list->name->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="_email" <?php echo $system_settings_list->_email->cellAttributes() ?>>
												<span id="el<?php echo $system_settings_list->RowCount ?>_system_settings__email">
													<span<?php echo $system_settings_list->_email->viewAttributes() ?>><?php echo $system_settings_list->_email->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="contact" <?php echo $system_settings_list->contact->cellAttributes() ?>>
												<span id="el<?php echo $system_settings_list->RowCount ?>_system_settings_contact">
													<span<?php echo $system_settings_list->contact->viewAttributes() ?>><?php echo $system_settings_list->contact->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
