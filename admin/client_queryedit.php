	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $client_query_edit->RightColumnClass ?>">
					<div <?php echo $client_query_edit->ClientId->cellAttributes() ?>>
						...
						<?php echo $client_query_edit->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Query" class="form-group row">
				...
				<div class="<?php echo $client_query_edit->RightColumnClass ?>">
					<div <?php echo $client_query_edit->Query->cellAttributes() ?>>
						...
						<?php echo $client_query_edit->Query->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Reply" class="form-group row">
				...
				<div class="<?php echo $client_query_edit->RightColumnClass ?>">
					<div <?php echo $client_query_edit->Reply->cellAttributes() ?>>
						...
						<?php echo $client_query_edit->Reply->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Date" class="form-group row">
				...
				<div class="<?php echo $client_query_edit->RightColumnClass ?>">
					<div <?php echo $client_query_edit->Date->cellAttributes() ?>>
							...
							<?php if (!$client_query_edit->Date->ReadOnly && !$client_query_edit->Date->Disabled && !isset($client_query_edit->Date->EditAttrs["readonly"]) && !isset($client_query_edit->Date->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["fclient_queryedit", "datetimepicker"], function() {
										ew.createDateTimePicker("fclient_queryedit", "x_Date", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 0
										});
						...
						<?php echo $client_query_edit->Date->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Status" class="form-group row">
				...
				<div class="<?php echo $client_query_edit->RightColumnClass ?>">
					<div <?php echo $client_query_edit->Status->cellAttributes() ?>>
						...
						<?php echo $client_query_edit->Status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
