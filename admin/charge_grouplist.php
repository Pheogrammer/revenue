		...
		<form name="fcharge_grouplist" id="fcharge_grouplist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_charge_group" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($charge_group_list->TotalRecords > 0 || $charge_group_list->isAdd() || $charge_group_list->isCopy() || $charge_group_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_charge_grouplist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($charge_group_list->SortUrl($charge_group_list->ChargeGroupCode) == "") { ?>
										<th data-name="ChargeGroupCode" class="<?php echo $charge_group_list->ChargeGroupCode->headerCellClass() ?>">
											<div id="elh_charge_group_ChargeGroupCode" class="charge_group_ChargeGroupCode">
												<div class="ew-table-header-caption"><?php echo $charge_group_list->ChargeGroupCode->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGroupCode" class="<?php echo $charge_group_list->ChargeGroupCode->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charge_group_list->SortUrl($charge_group_list->ChargeGroupCode) ?>', 1);">
												<div id="elh_charge_group_ChargeGroupCode" class="charge_group_ChargeGroupCode">
								...
								?>
									<?php if ($charge_group_list->SortUrl($charge_group_list->ChargeGroupName) == "") { ?>
										<th data-name="ChargeGroupName" class="<?php echo $charge_group_list->ChargeGroupName->headerCellClass() ?>">
											<div id="elh_charge_group_ChargeGroupName" class="charge_group_ChargeGroupName">
												<div class="ew-table-header-caption"><?php echo $charge_group_list->ChargeGroupName->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGroupName" class="<?php echo $charge_group_list->ChargeGroupName->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $charge_group_list->SortUrl($charge_group_list->ChargeGroupName) ?>', 1);">
												<div id="elh_charge_group_ChargeGroupName" class="charge_group_ChargeGroupName">
												...
												<td data-name="ChargeGroupCode" <?php echo $charge_group_list->ChargeGroupCode->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $charge_group_list->RowCount ?>_charge_group_ChargeGroupCode" class="form-group">
															<span<?php echo $charge_group_list->ChargeGroupCode->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charge_group_list->ChargeGroupCode->EditValue)) ?>">
														</span>
														</span>
													...
													?>
														<span id="el<?php echo $charge_group_list->RowCount ?>_charge_group_ChargeGroupCode">
															<span<?php echo $charge_group_list->ChargeGroupCode->viewAttributes() ?>><?php echo $charge_group_list->ChargeGroupCode->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
												...
												<td data-name="ChargeGroupName" <?php echo $charge_group_list->ChargeGroupName->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $charge_group_list->RowCount ?>_charge_group_ChargeGroupName">
															<span<?php echo $charge_group_list->ChargeGroupName->viewAttributes() ?>><?php echo $charge_group_list->ChargeGroupName->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
