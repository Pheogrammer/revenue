	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_ChargeCode" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->ChargeCode->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
							<span id="el_charges_ChargeCode">
								<span<?php echo $charges_edit->ChargeCode->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->ChargeCode->EditValue)) ?>">
							</span>
							</span>
						...
						<?php } else { ?>
							<span id="el_charges_ChargeCode">
								<span<?php echo $charges_edit->ChargeCode->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->ChargeCode->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->ChargeCode->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGroup" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->ChargeGroup->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_ChargeGroup">
								<span<?php echo $charges_edit->ChargeGroup->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->ChargeGroup->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->ChargeGroup->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeDesc" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->ChargeDesc->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_ChargeDesc">
								<span<?php echo $charges_edit->ChargeDesc->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->ChargeDesc->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->ChargeDesc->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->PropertyUse->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_PropertyUse">
								<span<?php echo $charges_edit->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Fee" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->Fee->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
							<span id="el_charges_Fee">
								<input type="text" data-table="charges" data-field="x_Fee" name="x_Fee" id="x_Fee" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($charges_edit->Fee->getPlaceHolder()) ?>" value="<?php echo $charges_edit->Fee->EditValue ?>" <?php echo $charges_edit->Fee->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_charges_Fee">
								<span<?php echo $charges_edit->Fee->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->Fee->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->Fee->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Factor" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->Factor->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
							<span id="el_charges_Factor">
								<input type="text" data-table="charges" data-field="x_Factor" name="x_Factor" id="x_Factor" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($charges_edit->Factor->getPlaceHolder()) ?>" value="<?php echo $charges_edit->Factor->EditValue ?>" <?php echo $charges_edit->Factor->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_charges_Factor">
								<span<?php echo $charges_edit->Factor->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->Factor->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->Factor->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_UnitOfMeasure" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->UnitOfMeasure->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_UnitOfMeasure">
								<span<?php echo $charges_edit->UnitOfMeasure->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->UnitOfMeasure->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->UnitOfMeasure->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PeriodType" class="form-group row">
				...
				<div class="<?php echo $charges_edit->RightColumnClass ?>">
					<div <?php echo $charges_edit->PeriodType->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_PeriodType">
								<span<?php echo $charges_edit->PeriodType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_edit->PeriodType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_edit->PeriodType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
