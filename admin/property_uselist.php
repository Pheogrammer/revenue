							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($property_use_list->SortUrl($property_use_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $property_use_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_property_use_PropertyUse" class="property_use_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $property_use_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $property_use_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_use_list->SortUrl($property_use_list->PropertyUse) ?>', 1);">
												<div id="elh_property_use_PropertyUse" class="property_use_PropertyUse">
												...
												<td data-name="PropertyUse" <?php echo $property_use_list->PropertyUse->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $property_use_list->RowCount ?>_property_use_PropertyUse">
															<span<?php echo $property_use_list->PropertyUse->viewAttributes() ?>><?php echo $property_use_list->PropertyUse->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
