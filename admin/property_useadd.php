	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_use_add->RightColumnClass ?>">
					<div <?php echo $property_use_add->PropertyUse->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_property_use_PropertyUse">
								<span<?php echo $property_use_add->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_use_add->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_use_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
