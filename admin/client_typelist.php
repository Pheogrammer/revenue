		...
		<form name="fclient_typelist" id="fclient_typelist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_client_type" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($client_type_list->TotalRecords > 0 || $client_type_list->isAdd() || $client_type_list->isCopy() || $client_type_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_client_typelist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($client_type_list->SortUrl($client_type_list->ClientType) == "") { ?>
										<th data-name="ClientType" class="<?php echo $client_type_list->ClientType->headerCellClass() ?>">
											<div id="elh_client_type_ClientType" class="client_type_ClientType">
												<div class="ew-table-header-caption"><?php echo $client_type_list->ClientType->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientType" class="<?php echo $client_type_list->ClientType->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_type_list->SortUrl($client_type_list->ClientType) ?>', 1);">
												<div id="elh_client_type_ClientType" class="client_type_ClientType">
												...
												<td data-name="ClientType" <?php echo $client_type_list->ClientType->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $client_type_list->RowCount ?>_client_type_ClientType">
															<span<?php echo $client_type_list->ClientType->viewAttributes() ?>><?php echo $client_type_list->ClientType->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
