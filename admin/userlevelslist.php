							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($userlevels_list->SortUrl($userlevels_list->userlevelid) == "") { ?>
										<th data-name="userlevelid" class="<?php echo $userlevels_list->userlevelid->headerCellClass() ?>">
											<div id="elh_userlevels_userlevelid" class="userlevels_userlevelid">
								...
								?>
									<?php if ($userlevels_list->SortUrl($userlevels_list->userlevelname) == "") { ?>
										<th data-name="userlevelname" class="<?php echo $userlevels_list->userlevelname->headerCellClass() ?>">
											<div id="elh_userlevels_userlevelname" class="userlevels_userlevelname">
										...
										?>
											<td data-name="userlevelid" <?php echo $userlevels_list->userlevelid->cellAttributes() ?>>
												<span id="el<?php echo $userlevels_list->RowCount ?>_userlevels_userlevelid">
													<span<?php echo $userlevels_list->userlevelid->viewAttributes() ?>><?php echo $userlevels_list->userlevelid->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="userlevelname" <?php echo $userlevels_list->userlevelname->cellAttributes() ?>>
												<span id="el<?php echo $userlevels_list->RowCount ?>_userlevels_userlevelname">
													<span<?php echo $userlevels_list->userlevelname->viewAttributes() ?>><?php echo $userlevels_list->userlevelname->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
