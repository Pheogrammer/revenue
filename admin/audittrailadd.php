	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_datetime" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->datetime->cellAttributes() ?>>
							...
							<?php if (!$audittrail_add->datetime->ReadOnly && !$audittrail_add->datetime->Disabled && !isset($audittrail_add->datetime->EditAttrs["readonly"]) && !isset($audittrail_add->datetime->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["faudittrailadd", "datetimepicker"], function() {
										ew.createDateTimePicker("faudittrailadd", "x_datetime", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 0
										});
						...
						<?php echo $audittrail_add->datetime->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_script" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->script->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->script->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_user" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->user->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->user->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__action" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->_action->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->_action->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__table" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->_table->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->_table->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_field" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->field->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->field->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_keyvalue" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->keyvalue->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->keyvalue->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_oldvalue" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->oldvalue->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->oldvalue->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_newvalue" class="form-group row">
				...
				<div class="<?php echo $audittrail_add->RightColumnClass ?>">
					<div <?php echo $audittrail_add->newvalue->cellAttributes() ?>>
						...
						<?php echo $audittrail_add->newvalue->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
