						...
						<tr class="ew-table-header">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->id) == "") { ?>
									<th data-name="id" class="<?php echo $property_grid->id->headerCellClass() ?>">
										<div id="elh_property_id" class="property_id">
											<div class="ew-table-header-caption"><?php echo $property_grid->id->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="id" class="<?php echo $property_grid->id->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->ClientId) == "") { ?>
									<th data-name="ClientId" class="<?php echo $property_grid->ClientId->headerCellClass() ?>">
										<div id="elh_property_ClientId" class="property_ClientId">
											<div class="ew-table-header-caption"><?php echo $property_grid->ClientId->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ClientId" class="<?php echo $property_grid->ClientId->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->ChargeGroup) == "") { ?>
									<th data-name="ChargeGroup" class="<?php echo $property_grid->ChargeGroup->headerCellClass() ?>">
										<div id="elh_property_ChargeGroup" class="property_ChargeGroup">
											<div class="ew-table-header-caption"><?php echo $property_grid->ChargeGroup->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ChargeGroup" class="<?php echo $property_grid->ChargeGroup->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->ChargeGropuDes) == "") { ?>
									<th data-name="ChargeGropuDes" class="<?php echo $property_grid->ChargeGropuDes->headerCellClass() ?>">
										<div id="elh_property_ChargeGropuDes" class="property_ChargeGropuDes">
											<div class="ew-table-header-caption"><?php echo $property_grid->ChargeGropuDes->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ChargeGropuDes" class="<?php echo $property_grid->ChargeGropuDes->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->ChargeableFee) == "") { ?>
									<th data-name="ChargeableFee" class="<?php echo $property_grid->ChargeableFee->headerCellClass() ?>">
										<div id="elh_property_ChargeableFee" class="property_ChargeableFee">
											<div class="ew-table-header-caption"><?php echo $property_grid->ChargeableFee->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ChargeableFee" class="<?php echo $property_grid->ChargeableFee->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->BalanceBF) == "") { ?>
									<th data-name="BalanceBF" class="<?php echo $property_grid->BalanceBF->headerCellClass() ?>">
										<div id="elh_property_BalanceBF" class="property_BalanceBF">
											<div class="ew-table-header-caption"><?php echo $property_grid->BalanceBF->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="BalanceBF" class="<?php echo $property_grid->BalanceBF->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->AmountPayable) == "") { ?>
									<th data-name="AmountPayable" class="<?php echo $property_grid->AmountPayable->headerCellClass() ?>">
										<div id="elh_property_AmountPayable" class="property_AmountPayable">
											<div class="ew-table-header-caption"><?php echo $property_grid->AmountPayable->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="AmountPayable" class="<?php echo $property_grid->AmountPayable->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->Property) == "") { ?>
									<th data-name="Property" class="<?php echo $property_grid->Property->headerCellClass() ?>">
										<div id="elh_property_Property" class="property_Property">
											<div class="ew-table-header-caption"><?php echo $property_grid->Property->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Property" class="<?php echo $property_grid->Property->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->PropertyId) == "") { ?>
									<th data-name="PropertyId" class="<?php echo $property_grid->PropertyId->headerCellClass() ?>">
										<div id="elh_property_PropertyId" class="property_PropertyId">
											<div class="ew-table-header-caption"><?php echo $property_grid->PropertyId->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="PropertyId" class="<?php echo $property_grid->PropertyId->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->PropertyUse) == "") { ?>
									<th data-name="PropertyUse" class="<?php echo $property_grid->PropertyUse->headerCellClass() ?>">
										<div id="elh_property_PropertyUse" class="property_PropertyUse">
											<div class="ew-table-header-caption"><?php echo $property_grid->PropertyUse->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="PropertyUse" class="<?php echo $property_grid->PropertyUse->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->Location) == "") { ?>
									<th data-name="Location" class="<?php echo $property_grid->Location->headerCellClass() ?>">
										<div id="elh_property_Location" class="property_Location">
											<div class="ew-table-header-caption"><?php echo $property_grid->Location->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Location" class="<?php echo $property_grid->Location->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->AmountPaid) == "") { ?>
									<th data-name="AmountPaid" class="<?php echo $property_grid->AmountPaid->headerCellClass() ?>">
										<div id="elh_property_AmountPaid" class="property_AmountPaid">
											<div class="ew-table-header-caption"><?php echo $property_grid->AmountPaid->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="AmountPaid" class="<?php echo $property_grid->AmountPaid->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->CurrentBalance) == "") { ?>
									<th data-name="CurrentBalance" class="<?php echo $property_grid->CurrentBalance->headerCellClass() ?>">
										<div id="elh_property_CurrentBalance" class="property_CurrentBalance">
											<div class="ew-table-header-caption"><?php echo $property_grid->CurrentBalance->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="CurrentBalance" class="<?php echo $property_grid->CurrentBalance->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->DataRegistered) == "") { ?>
									<th data-name="DataRegistered" class="<?php echo $property_grid->DataRegistered->headerCellClass() ?>">
										<div id="elh_property_DataRegistered" class="property_DataRegistered">
											<div class="ew-table-header-caption"><?php echo $property_grid->DataRegistered->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="DataRegistered" class="<?php echo $property_grid->DataRegistered->headerCellClass() ?>">
							...
							?>
								<?php if ($property_grid->SortUrl($property_grid->Status) == "") { ?>
									<th data-name="Status" class="<?php echo $property_grid->Status->headerCellClass() ?>">
										<div id="elh_property_Status" class="property_Status">
											<div class="ew-table-header-caption"><?php echo $property_grid->Status->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Status" class="<?php echo $property_grid->Status->headerCellClass() ?>">
											...
											<td data-name="id" <?php echo $property_grid->id->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_id" class="form-group">
														<span<?php echo $property_grid->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->id->EditValue)) ?>">
													</span>
													</span>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_id">
														<span<?php echo $property_grid->id->viewAttributes() ?>><?php echo $property_grid->id->getViewValue() ?>
													</span>
													</span>
											...
											<td data-name="ClientId" <?php echo $property_grid->ClientId->cellAttributes() ?>>
												...
												?>
													<?php if ($property_grid->ClientId->getSessionValue() != "") { ?>
														<span id="el<?php echo $property_grid->RowCount ?>_property_ClientId" class="form-group">
															<span<?php echo $property_grid->ClientId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->ClientId->ViewValue)) ?>">
														</span>
														</span>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_ClientId">
														<span<?php echo $property_grid->ClientId->viewAttributes() ?>><?php echo $property_grid->ClientId->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="ChargeGroup" <?php echo $property_grid->ChargeGroup->cellAttributes() ?>>
													...
													<span id="el<?php echo $property_grid->RowCount ?>_property_ChargeGroup" class="form-group">
														...
														<script>
															loadjs.ready(["fpropertygrid"], function() {
																fpropertygrid.createAutoSuggest({
																	"id": "x<?php echo $property_grid->RowIndex ?>_ChargeGroup",
																	"forceSelect": true
																});
															});
														</script>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_ChargeGroup">
														<span<?php echo $property_grid->ChargeGroup->viewAttributes() ?>><?php echo $property_grid->ChargeGroup->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="ChargeGropuDes" <?php echo $property_grid->ChargeGropuDes->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_ChargeGropuDes">
														<span<?php echo $property_grid->ChargeGropuDes->viewAttributes() ?>><?php echo $property_grid->ChargeGropuDes->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="ChargeableFee" <?php echo $property_grid->ChargeableFee->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_ChargeableFee">
														<span<?php echo $property_grid->ChargeableFee->viewAttributes() ?>><?php echo $property_grid->ChargeableFee->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="BalanceBF" <?php echo $property_grid->BalanceBF->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_BalanceBF">
														<span<?php echo $property_grid->BalanceBF->viewAttributes() ?>><?php echo $property_grid->BalanceBF->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="AmountPayable" <?php echo $property_grid->AmountPayable->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_AmountPayable">
														<span<?php echo $property_grid->AmountPayable->viewAttributes() ?>><?php echo $property_grid->AmountPayable->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="Property" <?php echo $property_grid->Property->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_Property">
														<span<?php echo $property_grid->Property->viewAttributes() ?>><?php echo $property_grid->Property->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="PropertyId" <?php echo $property_grid->PropertyId->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_PropertyId">
														<span<?php echo $property_grid->PropertyId->viewAttributes() ?>><?php echo $property_grid->PropertyId->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="PropertyUse" <?php echo $property_grid->PropertyUse->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_PropertyUse">
														<span<?php echo $property_grid->PropertyUse->viewAttributes() ?>><?php echo $property_grid->PropertyUse->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="Location" <?php echo $property_grid->Location->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_Location">
														<span<?php echo $property_grid->Location->viewAttributes() ?>><?php echo $property_grid->Location->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="AmountPaid" <?php echo $property_grid->AmountPaid->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_AmountPaid">
														<span<?php echo $property_grid->AmountPaid->viewAttributes() ?>><?php echo $property_grid->AmountPaid->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="CurrentBalance" <?php echo $property_grid->CurrentBalance->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_CurrentBalance">
														<span<?php echo $property_grid->CurrentBalance->viewAttributes() ?>><?php echo $property_grid->CurrentBalance->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="DataRegistered" <?php echo $property_grid->DataRegistered->cellAttributes() ?>>
														...
														<?php if (!$property_grid->DataRegistered->ReadOnly && !$property_grid->DataRegistered->Disabled && !isset($property_grid->DataRegistered->EditAttrs["readonly"]) && !isset($property_grid->DataRegistered->EditAttrs["disabled"])) { ?>
															<script>
																loadjs.ready(["fpropertygrid", "datetimepicker"], function() {
																	ew.createDateTimePicker("fpropertygrid", "x<?php echo $property_grid->RowIndex ?>_DataRegistered", {
																		"ignoreReadonly": true,
																		"useCurrent": false,
																		"format": 0
																	});
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_DataRegistered">
														<span<?php echo $property_grid->DataRegistered->viewAttributes() ?>><?php echo $property_grid->DataRegistered->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
											...
											<td data-name="Status" <?php echo $property_grid->Status->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_Status" class="form-group">
														...
														<div id="dsl_x<?php echo $property_grid->RowIndex ?>_Status" data-repeatcolumn="5" class="ew-item-list d-none">
															<div>
												...
												?>
													<span id="el<?php echo $property_grid->RowCount ?>_property_Status">
														<span<?php echo $property_grid->Status->viewAttributes() ?>><?php echo $property_grid->Status->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property->isConfirm()) { ?>
							...
							<tr <?php echo $property->rowAttributes() ?>>
									...
									<td data-name="id">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_id" class="form-group property_id">
												<span<?php echo $property_grid->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->id->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_id" name="x<?php echo $property_grid->RowIndex ?>_id" id="x<?php echo $property_grid->RowIndex ?>_id" value="<?php echo HtmlEncode($property_grid->id->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="ChargeGroup">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_ChargeGroup" class="form-group property_ChargeGroup">
												<span<?php echo $property_grid->ChargeGroup->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->ChargeGroup->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_ChargeGroup" name="x<?php echo $property_grid->RowIndex ?>_ChargeGroup" id="x<?php echo $property_grid->RowIndex ?>_ChargeGroup" value="<?php echo HtmlEncode($property_grid->ChargeGroup->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="ChargeGropuDes">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_ChargeGropuDes" class="form-group property_ChargeGropuDes">
												<span<?php echo $property_grid->ChargeGropuDes->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->ChargeGropuDes->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_ChargeGropuDes" name="x<?php echo $property_grid->RowIndex ?>_ChargeGropuDes" id="x<?php echo $property_grid->RowIndex ?>_ChargeGropuDes" value="<?php echo HtmlEncode($property_grid->ChargeGropuDes->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="ChargeableFee">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_ChargeableFee" class="form-group property_ChargeableFee">
												<span<?php echo $property_grid->ChargeableFee->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->ChargeableFee->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_ChargeableFee" name="x<?php echo $property_grid->RowIndex ?>_ChargeableFee" id="x<?php echo $property_grid->RowIndex ?>_ChargeableFee" value="<?php echo HtmlEncode($property_grid->ChargeableFee->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="BalanceBF">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_BalanceBF" class="form-group property_BalanceBF">
												<span<?php echo $property_grid->BalanceBF->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->BalanceBF->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_BalanceBF" name="x<?php echo $property_grid->RowIndex ?>_BalanceBF" id="x<?php echo $property_grid->RowIndex ?>_BalanceBF" value="<?php echo HtmlEncode($property_grid->BalanceBF->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="AmountPayable">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_AmountPayable" class="form-group property_AmountPayable">
												<span<?php echo $property_grid->AmountPayable->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->AmountPayable->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_AmountPayable" name="x<?php echo $property_grid->RowIndex ?>_AmountPayable" id="x<?php echo $property_grid->RowIndex ?>_AmountPayable" value="<?php echo HtmlEncode($property_grid->AmountPayable->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="Property">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_Property" class="form-group property_Property">
												<span<?php echo $property_grid->Property->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->Property->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_Property" name="x<?php echo $property_grid->RowIndex ?>_Property" id="x<?php echo $property_grid->RowIndex ?>_Property" value="<?php echo HtmlEncode($property_grid->Property->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="PropertyId">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_PropertyId" class="form-group property_PropertyId">
												<span<?php echo $property_grid->PropertyId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->PropertyId->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_PropertyId" name="x<?php echo $property_grid->RowIndex ?>_PropertyId" id="x<?php echo $property_grid->RowIndex ?>_PropertyId" value="<?php echo HtmlEncode($property_grid->PropertyId->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="PropertyUse">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_PropertyUse" class="form-group property_PropertyUse">
												<span<?php echo $property_grid->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->PropertyUse->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_PropertyUse" name="x<?php echo $property_grid->RowIndex ?>_PropertyUse" id="x<?php echo $property_grid->RowIndex ?>_PropertyUse" value="<?php echo HtmlEncode($property_grid->PropertyUse->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="Location">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_Location" class="form-group property_Location">
												<span<?php echo $property_grid->Location->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->Location->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_Location" name="x<?php echo $property_grid->RowIndex ?>_Location" id="x<?php echo $property_grid->RowIndex ?>_Location" value="<?php echo HtmlEncode($property_grid->Location->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="AmountPaid">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_AmountPaid" class="form-group property_AmountPaid">
												<span<?php echo $property_grid->AmountPaid->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->AmountPaid->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_AmountPaid" name="x<?php echo $property_grid->RowIndex ?>_AmountPaid" id="x<?php echo $property_grid->RowIndex ?>_AmountPaid" value="<?php echo HtmlEncode($property_grid->AmountPaid->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="CurrentBalance">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_CurrentBalance" class="form-group property_CurrentBalance">
												<span<?php echo $property_grid->CurrentBalance->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->CurrentBalance->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_CurrentBalance" name="x<?php echo $property_grid->RowIndex ?>_CurrentBalance" id="x<?php echo $property_grid->RowIndex ?>_CurrentBalance" value="<?php echo HtmlEncode($property_grid->CurrentBalance->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="DataRegistered">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_DataRegistered" class="form-group property_DataRegistered">
												<span<?php echo $property_grid->DataRegistered->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->DataRegistered->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_DataRegistered" name="x<?php echo $property_grid->RowIndex ?>_DataRegistered" id="x<?php echo $property_grid->RowIndex ?>_DataRegistered" value="<?php echo HtmlEncode($property_grid->DataRegistered->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="Status">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_Status" class="form-group property_Status">
												<span<?php echo $property_grid->Status->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_grid->Status->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property" data-field="x_Status" name="x<?php echo $property_grid->RowIndex ?>_Status" id="x<?php echo $property_grid->RowIndex ?>_Status" value="<?php echo HtmlEncode($property_grid->Status->FormValue) ?>">
										<?php } ?>
