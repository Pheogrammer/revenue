	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_userlevelid" class="form-group row">
				...
				<div class="<?php echo $userlevels_add->RightColumnClass ?>">
					<div <?php echo $userlevels_add->userlevelid->cellAttributes() ?>>
						...
						<?php echo $userlevels_add->userlevelid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_userlevelname" class="form-group row">
				...
				<div class="<?php echo $userlevels_add->RightColumnClass ?>">
					<div <?php echo $userlevels_add->userlevelname->cellAttributes() ?>>
						...
						<?php echo $userlevels_add->userlevelname->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
