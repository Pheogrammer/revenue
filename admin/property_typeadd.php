	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_PropertyType" class="form-group row">
				...
				<div class="<?php echo $property_type_add->RightColumnClass ?>">
					<div <?php echo $property_type_add->PropertyType->cellAttributes() ?>>
						...
						<?php echo $property_type_add->PropertyType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_type_add->RightColumnClass ?>">
					<div <?php echo $property_type_add->PropertyUse->cellAttributes() ?>>
						...
						<?php echo $property_type_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
