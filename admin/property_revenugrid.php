						...
						<tr class="ew-table-header">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->id) == "") { ?>
									<th data-name="id" class="<?php echo $property_revenu_grid->id->headerCellClass() ?>">
										<div id="elh_property_revenu_id" class="property_revenu_id">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->id->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="id" class="<?php echo $property_revenu_grid->id->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->ClientId) == "") { ?>
									<th data-name="ClientId" class="<?php echo $property_revenu_grid->ClientId->headerCellClass() ?>">
										<div id="elh_property_revenu_ClientId" class="property_revenu_ClientId">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->ClientId->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ClientId" class="<?php echo $property_revenu_grid->ClientId->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->ClientProperty) == "") { ?>
									<th data-name="ClientProperty" class="<?php echo $property_revenu_grid->ClientProperty->headerCellClass() ?>">
										<div id="elh_property_revenu_ClientProperty" class="property_revenu_ClientProperty">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->ClientProperty->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="ClientProperty" class="<?php echo $property_revenu_grid->ClientProperty->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->PropertyId) == "") { ?>
									<th data-name="PropertyId" class="<?php echo $property_revenu_grid->PropertyId->headerCellClass() ?>">
										<div id="elh_property_revenu_PropertyId" class="property_revenu_PropertyId">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->PropertyId->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="PropertyId" class="<?php echo $property_revenu_grid->PropertyId->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->PropertyUse) == "") { ?>
									<th data-name="PropertyUse" class="<?php echo $property_revenu_grid->PropertyUse->headerCellClass() ?>">
										<div id="elh_property_revenu_PropertyUse" class="property_revenu_PropertyUse">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->PropertyUse->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="PropertyUse" class="<?php echo $property_revenu_grid->PropertyUse->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->AmountPaid) == "") { ?>
									<th data-name="AmountPaid" class="<?php echo $property_revenu_grid->AmountPaid->headerCellClass() ?>">
										<div id="elh_property_revenu_AmountPaid" class="property_revenu_AmountPaid">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->AmountPaid->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="AmountPaid" class="<?php echo $property_revenu_grid->AmountPaid->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->Balance) == "") { ?>
									<th data-name="Balance" class="<?php echo $property_revenu_grid->Balance->headerCellClass() ?>">
										<div id="elh_property_revenu_Balance" class="property_revenu_Balance">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->Balance->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="Balance" class="<?php echo $property_revenu_grid->Balance->headerCellClass() ?>">
							...
							?>
								<?php if ($property_revenu_grid->SortUrl($property_revenu_grid->date) == "") { ?>
									<th data-name="date" class="<?php echo $property_revenu_grid->date->headerCellClass() ?>">
										<div id="elh_property_revenu_date" class="property_revenu_date">
											<div class="ew-table-header-caption"><?php echo $property_revenu_grid->date->caption() ?></div>
										</div>
									</th>
								<?php } else { ?>
									<th data-name="date" class="<?php echo $property_revenu_grid->date->headerCellClass() ?>">
											...
											<td data-name="id" <?php echo $property_revenu_grid->id->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_id" class="form-group">
														<span<?php echo $property_revenu_grid->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->id->EditValue)) ?>">
													</span>
													</span>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_id">
														<span<?php echo $property_revenu_grid->id->viewAttributes() ?>><?php echo $property_revenu_grid->id->getViewValue() ?>
													</span>
													</span>
											...
											<td data-name="ClientId" <?php echo $property_revenu_grid->ClientId->cellAttributes() ?>>
												...
												?>
													<?php if ($property_revenu_grid->ClientId->getSessionValue() != "") { ?>
														<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_ClientId" class="form-group">
															<span<?php echo $property_revenu_grid->ClientId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->ClientId->ViewValue)) ?>">
														</span>
														</span>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_ClientId">
														<span<?php echo $property_revenu_grid->ClientId->viewAttributes() ?>><?php echo $property_revenu_grid->ClientId->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
											...
											<td data-name="ClientProperty" <?php echo $property_revenu_grid->ClientProperty->cellAttributes() ?>>
													...
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_ClientProperty" class="form-group">
														...
														<script>
															loadjs.ready(["fproperty_revenugrid"], function() {
																fproperty_revenugrid.createAutoSuggest({
																	"id": "x<?php echo $property_revenu_grid->RowIndex ?>_ClientProperty",
																	"forceSelect": true
																});
															});
														</script>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_ClientProperty">
														<span<?php echo $property_revenu_grid->ClientProperty->viewAttributes() ?>><?php echo $property_revenu_grid->ClientProperty->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
											...
											<td data-name="PropertyId" <?php echo $property_revenu_grid->PropertyId->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_PropertyId">
														<span<?php echo $property_revenu_grid->PropertyId->viewAttributes() ?>><?php echo $property_revenu_grid->PropertyId->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
											...
											<td data-name="PropertyUse" <?php echo $property_revenu_grid->PropertyUse->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_PropertyUse">
														<span<?php echo $property_revenu_grid->PropertyUse->viewAttributes() ?>><?php echo $property_revenu_grid->PropertyUse->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
											...
											<td data-name="AmountPaid" <?php echo $property_revenu_grid->AmountPaid->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_AmountPaid">
														<span<?php echo $property_revenu_grid->AmountPaid->viewAttributes() ?>><?php echo $property_revenu_grid->AmountPaid->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
											...
											<td data-name="Balance" <?php echo $property_revenu_grid->Balance->cellAttributes() ?>>
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_Balance">
														<span<?php echo $property_revenu_grid->Balance->viewAttributes() ?>><?php echo $property_revenu_grid->Balance->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
											...
											<td data-name="date" <?php echo $property_revenu_grid->date->cellAttributes() ?>>
														...
														<?php if (!$property_revenu_grid->date->ReadOnly && !$property_revenu_grid->date->Disabled && !isset($property_revenu_grid->date->EditAttrs["readonly"]) && !isset($property_revenu_grid->date->EditAttrs["disabled"])) { ?>
															<script>
																loadjs.ready(["fproperty_revenugrid", "datetimepicker"], function() {
																	ew.createDateTimePicker("fproperty_revenugrid", "x<?php echo $property_revenu_grid->RowIndex ?>_date", {
																		"ignoreReadonly": true,
																		"useCurrent": false,
																		"format": 7
																	});
												...
												?>
													<span id="el<?php echo $property_revenu_grid->RowCount ?>_property_revenu_date">
														<span<?php echo $property_revenu_grid->date->viewAttributes() ?>><?php echo $property_revenu_grid->date->getViewValue() ?>
													</span>
													</span>
													<?php if (!$property_revenu->isConfirm()) { ?>
							...
							<tr <?php echo $property_revenu->rowAttributes() ?>>
									...
									<td data-name="id">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_id" class="form-group property_revenu_id">
												<span<?php echo $property_revenu_grid->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->id->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_id" name="x<?php echo $property_revenu_grid->RowIndex ?>_id" id="x<?php echo $property_revenu_grid->RowIndex ?>_id" value="<?php echo HtmlEncode($property_revenu_grid->id->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="ClientProperty">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_ClientProperty" class="form-group property_revenu_ClientProperty">
												<span<?php echo $property_revenu_grid->ClientProperty->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->ClientProperty->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_ClientProperty" name="x<?php echo $property_revenu_grid->RowIndex ?>_ClientProperty" id="x<?php echo $property_revenu_grid->RowIndex ?>_ClientProperty" value="<?php echo HtmlEncode($property_revenu_grid->ClientProperty->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="PropertyId">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_PropertyId" class="form-group property_revenu_PropertyId">
												<span<?php echo $property_revenu_grid->PropertyId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->PropertyId->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_PropertyId" name="x<?php echo $property_revenu_grid->RowIndex ?>_PropertyId" id="x<?php echo $property_revenu_grid->RowIndex ?>_PropertyId" value="<?php echo HtmlEncode($property_revenu_grid->PropertyId->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="PropertyUse">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_PropertyUse" class="form-group property_revenu_PropertyUse">
												<span<?php echo $property_revenu_grid->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->PropertyUse->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_PropertyUse" name="x<?php echo $property_revenu_grid->RowIndex ?>_PropertyUse" id="x<?php echo $property_revenu_grid->RowIndex ?>_PropertyUse" value="<?php echo HtmlEncode($property_revenu_grid->PropertyUse->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="AmountPaid">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_AmountPaid" class="form-group property_revenu_AmountPaid">
												<span<?php echo $property_revenu_grid->AmountPaid->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->AmountPaid->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_AmountPaid" name="x<?php echo $property_revenu_grid->RowIndex ?>_AmountPaid" id="x<?php echo $property_revenu_grid->RowIndex ?>_AmountPaid" value="<?php echo HtmlEncode($property_revenu_grid->AmountPaid->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="Balance">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_Balance" class="form-group property_revenu_Balance">
												<span<?php echo $property_revenu_grid->Balance->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->Balance->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_Balance" name="x<?php echo $property_revenu_grid->RowIndex ?>_Balance" id="x<?php echo $property_revenu_grid->RowIndex ?>_Balance" value="<?php echo HtmlEncode($property_revenu_grid->Balance->FormValue) ?>">
										<?php } ?>
								...
								?>
									<td data-name="date">
										...
										<?php } else { ?>
											<span id="el$rowindex$_property_revenu_date" class="form-group property_revenu_date">
												<span<?php echo $property_revenu_grid->date->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_grid->date->ViewValue)) ?>">
											</span>
											</span>
											<input type="hidden" data-table="property_revenu" data-field="x_date" name="x<?php echo $property_revenu_grid->RowIndex ?>_date" id="x<?php echo $property_revenu_grid->RowIndex ?>_date" value="<?php echo HtmlEncode($property_revenu_grid->date->FormValue) ?>">
										<?php } ?>
