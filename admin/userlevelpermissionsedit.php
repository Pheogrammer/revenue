	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_userlevelid" class="form-group row">
				...
				<div class="<?php echo $userlevelpermissions_edit->RightColumnClass ?>">
					<div <?php echo $userlevelpermissions_edit->userlevelid->cellAttributes() ?>>
						<input type="text" data-table="userlevelpermissions" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($userlevelpermissions_edit->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevelpermissions_edit->userlevelid->EditValue ?>" <?php echo $userlevelpermissions_edit->userlevelid->editAttributes() ?>>
						...
						<?php echo $userlevelpermissions_edit->userlevelid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__tablename" class="form-group row">
				...
				<div class="<?php echo $userlevelpermissions_edit->RightColumnClass ?>">
					<div <?php echo $userlevelpermissions_edit->_tablename->cellAttributes() ?>>
						...
						<?php echo $userlevelpermissions_edit->_tablename->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_permission" class="form-group row">
				...
				<div class="<?php echo $userlevelpermissions_edit->RightColumnClass ?>">
					<div <?php echo $userlevelpermissions_edit->permission->cellAttributes() ?>>
						<span id="el_userlevelpermissions_permission">
							<input type="text" data-table="userlevelpermissions" data-field="x_permission" name="x_permission" id="x_permission" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($userlevelpermissions_edit->permission->getPlaceHolder()) ?>" value="<?php echo $userlevelpermissions_edit->permission->EditValue ?>" <?php echo $userlevelpermissions_edit->permission->editAttributes() ?>>
						</span>
						<?php echo $userlevelpermissions_edit->permission->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
