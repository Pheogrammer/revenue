				...
				<thead><!-- Table header -->
					<tr class="ew-table-header">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->id->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->id->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->id->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->ClientId->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->ClientId->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->ClientId->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->ClientProperty->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->ClientProperty->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->ClientProperty->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->PropertyId->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->PropertyId->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->PropertyId->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->PropertyUse->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->PropertyUse->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->PropertyUse->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->AmountPaid->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->AmountPaid->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->AmountPaid->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->Balance->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->Balance->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->Balance->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_revenu_preview->date->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_revenu_preview->date->Name) ?>" data-sort-order="<?php echo $property_revenu_preview->SortField == $property_revenu_preview->date->Name && $property_revenu_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
