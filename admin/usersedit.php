	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_id" class="form-group row">
				...
				<div class="<?php echo $users_edit->RightColumnClass ?>">
					<div <?php echo $users_edit->id->cellAttributes() ?>>
						<span id="el_users_id">
							<span<?php echo $users_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($users_edit->id->EditValue)) ?>">
						</span>
						</span>
						...
						<?php echo $users_edit->id->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Fullname" class="form-group row">
				...
				<div class="<?php echo $users_edit->RightColumnClass ?>">
					<div <?php echo $users_edit->Fullname->cellAttributes() ?>>
						...
						<?php echo $users_edit->Fullname->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Username" class="form-group row">
				...
				<div class="<?php echo $users_edit->RightColumnClass ?>">
					<div <?php echo $users_edit->Username->cellAttributes() ?>>
						...
						<?php echo $users_edit->Username->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__Email" class="form-group row">
				...
				<div class="<?php echo $users_edit->RightColumnClass ?>">
					<div <?php echo $users_edit->_Email->cellAttributes() ?>>
						...
						<?php echo $users_edit->_Email->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Passsword" class="form-group row">
				...
				<div class="<?php echo $users_edit->RightColumnClass ?>">
					<div <?php echo $users_edit->Passsword->cellAttributes() ?>>
						...
						<?php echo $users_edit->Passsword->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_userLevelId" class="form-group row">
				...
				<div class="<?php echo $users_edit->RightColumnClass ?>">
					<div <?php echo $users_edit->userLevelId->cellAttributes() ?>>
						...
						<?php } ?>
						<?php echo $users_edit->userLevelId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
