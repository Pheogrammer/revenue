	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->ClientId->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
							<?php if ($property_add->ClientId->getSessionValue() != "") { ?>
								<span id="el_property_ClientId">
									<span<?php echo $property_add->ClientId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->ClientId->ViewValue)) ?>">
								</span>
								</span>
						...
						<?php } ?>
						<?php echo $property_add->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGroup" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->ChargeGroup->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
							<span id="el_property_ChargeGroup">
								...
								<script>
									loadjs.ready(["fpropertyadd"], function() {
										fpropertyadd.createAutoSuggest({
											"id": "x_ChargeGroup",
											"forceSelect": true
										});
									});
						...
						<?php } else { ?>
							<span id="el_property_ChargeGroup">
								<span<?php echo $property_add->ChargeGroup->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->ChargeGroup->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->ChargeGroup->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGropuDes" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->ChargeGropuDes->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_ChargeGropuDes">
								<span<?php echo $property_add->ChargeGropuDes->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->ChargeGropuDes->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->ChargeGropuDes->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeableFee" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->ChargeableFee->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_ChargeableFee">
								<span<?php echo $property_add->ChargeableFee->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->ChargeableFee->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->ChargeableFee->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_BalanceBF" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->BalanceBF->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_BalanceBF">
								<span<?php echo $property_add->BalanceBF->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->BalanceBF->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->BalanceBF->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPayable" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->AmountPayable->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_AmountPayable">
								<span<?php echo $property_add->AmountPayable->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->AmountPayable->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->AmountPayable->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Property" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->Property->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Property">
								<span<?php echo $property_add->Property->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->Property->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->Property->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyId" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->PropertyId->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_PropertyId">
								<span<?php echo $property_add->PropertyId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->PropertyId->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->PropertyId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->PropertyUse->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_PropertyUse">
								<span<?php echo $property_add->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Location" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->Location->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Location">
								<span<?php echo $property_add->Location->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->Location->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->Location->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPaid" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->AmountPaid->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_AmountPaid">
								<span<?php echo $property_add->AmountPaid->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->AmountPaid->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->AmountPaid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_CurrentBalance" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->CurrentBalance->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_CurrentBalance">
								<span<?php echo $property_add->CurrentBalance->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->CurrentBalance->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->CurrentBalance->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Description" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->Description->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Description">
								<span<?php echo $property_add->Description->viewAttributes() ?>><?php echo $property_add->Description->ViewValue ?>
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->Description->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_DataRegistered" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->DataRegistered->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
								...
								<?php if (!$property_add->DataRegistered->ReadOnly && !$property_add->DataRegistered->Disabled && !isset($property_add->DataRegistered->EditAttrs["readonly"]) && !isset($property_add->DataRegistered->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fpropertyadd", "datetimepicker"], function() {
											ew.createDateTimePicker("fpropertyadd", "x_DataRegistered", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_property_DataRegistered">
								<span<?php echo $property_add->DataRegistered->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->DataRegistered->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->DataRegistered->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PhysicalAddress" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->PhysicalAddress->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_PhysicalAddress">
								<span<?php echo $property_add->PhysicalAddress->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->PhysicalAddress->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->PhysicalAddress->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Status" class="form-group row">
				...
				<div class="<?php echo $property_add->RightColumnClass ?>">
					<div <?php echo $property_add->Status->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Status">
								<span<?php echo $property_add->Status->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_add->Status->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_add->Status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
