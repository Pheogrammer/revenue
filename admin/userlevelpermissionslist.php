							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($userlevelpermissions_list->SortUrl($userlevelpermissions_list->userlevelid) == "") { ?>
										<th data-name="userlevelid" class="<?php echo $userlevelpermissions_list->userlevelid->headerCellClass() ?>">
											<div id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid">
								...
								?>
									<?php if ($userlevelpermissions_list->SortUrl($userlevelpermissions_list->_tablename) == "") { ?>
										<th data-name="_tablename" class="<?php echo $userlevelpermissions_list->_tablename->headerCellClass() ?>">
											<div id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename">
								...
								?>
									<?php if ($userlevelpermissions_list->SortUrl($userlevelpermissions_list->permission) == "") { ?>
										<th data-name="permission" class="<?php echo $userlevelpermissions_list->permission->headerCellClass() ?>">
											<div id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission">
										...
										?>
											<td data-name="userlevelid" <?php echo $userlevelpermissions_list->userlevelid->cellAttributes() ?>>
												<span id="el<?php echo $userlevelpermissions_list->RowCount ?>_userlevelpermissions_userlevelid">
													<span<?php echo $userlevelpermissions_list->userlevelid->viewAttributes() ?>><?php echo $userlevelpermissions_list->userlevelid->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="_tablename" <?php echo $userlevelpermissions_list->_tablename->cellAttributes() ?>>
												<span id="el<?php echo $userlevelpermissions_list->RowCount ?>_userlevelpermissions__tablename">
													<span<?php echo $userlevelpermissions_list->_tablename->viewAttributes() ?>><?php echo $userlevelpermissions_list->_tablename->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="permission" <?php echo $userlevelpermissions_list->permission->cellAttributes() ?>>
												<span id="el<?php echo $userlevelpermissions_list->RowCount ?>_userlevelpermissions_permission">
													<span<?php echo $userlevelpermissions_list->permission->viewAttributes() ?>><?php echo $userlevelpermissions_list->permission->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
