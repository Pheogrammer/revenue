...
<form action="" method="POST">
	...
	<a href=""><input type="submit" name="backup" value="Start Database Backup" class="btn btn-primary" /></a>
</form>
...
if (isset($_POST['backup'])) {
	...
	define("DB_USER", 'root');
	define("DB_PASSWORD", '');
	define("DB_NAME", 'revenue');
	define("DB_HOST", 'localhost');
	define("BACKUP_DIR", 'DBbackup'); // Comment this line to use same script's directory ('.')
