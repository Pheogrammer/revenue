			...
			<tr id="r_ClientId">
				...
				<td data-name="ClientId" <?php echo $update_requests_view->ClientId->cellAttributes() ?>>
					<span id="el_update_requests_ClientId">
						<span<?php echo $update_requests_view->ClientId->viewAttributes() ?>><?php echo $update_requests_view->ClientId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NewClientIdentity">
				...
				<td data-name="NewClientIdentity" <?php echo $update_requests_view->NewClientIdentity->cellAttributes() ?>>
					<span id="el_update_requests_NewClientIdentity">
						<span<?php echo $update_requests_view->NewClientIdentity->viewAttributes() ?>><?php echo $update_requests_view->NewClientIdentity->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NewClientName">
				...
				<td data-name="NewClientName" <?php echo $update_requests_view->NewClientName->cellAttributes() ?>>
					<span id="el_update_requests_NewClientName">
						<span<?php echo $update_requests_view->NewClientName->viewAttributes() ?>><?php echo $update_requests_view->NewClientName->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NewAccountType">
				...
				<td data-name="NewAccountType" <?php echo $update_requests_view->NewAccountType->cellAttributes() ?>>
					<span id="el_update_requests_NewAccountType">
						<span<?php echo $update_requests_view->NewAccountType->viewAttributes() ?>><?php echo $update_requests_view->NewAccountType->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NewMobileNumber">
				...
				<td data-name="NewMobileNumber" <?php echo $update_requests_view->NewMobileNumber->cellAttributes() ?>>
					<span id="el_update_requests_NewMobileNumber">
						<span<?php echo $update_requests_view->NewMobileNumber->viewAttributes() ?>><?php echo $update_requests_view->NewMobileNumber->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NewEmail">
				...
				<td data-name="NewEmail" <?php echo $update_requests_view->NewEmail->cellAttributes() ?>>
					<span id="el_update_requests_NewEmail">
						<span<?php echo $update_requests_view->NewEmail->viewAttributes() ?>><?php echo $update_requests_view->NewEmail->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_NewAdditionalInformation">
				...
				<td data-name="NewAdditionalInformation" <?php echo $update_requests_view->NewAdditionalInformation->cellAttributes() ?>>
					<span id="el_update_requests_NewAdditionalInformation">
						<span<?php echo $update_requests_view->NewAdditionalInformation->viewAttributes() ?>><?php echo $update_requests_view->NewAdditionalInformation->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_date">
				...
				<td data-name="date" <?php echo $update_requests_view->date->cellAttributes() ?>>
					<span id="el_update_requests_date">
						<span<?php echo $update_requests_view->date->viewAttributes() ?>><?php echo $update_requests_view->date->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_status">
				...
				<td data-name="status" <?php echo $update_requests_view->status->cellAttributes() ?>>
					<span id="el_update_requests_status">
						<span<?php echo $update_requests_view->status->viewAttributes() ?>><?php echo $update_requests_view->status->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Property">
				...
				<td data-name="Property" <?php echo $update_requests_view->Property->cellAttributes() ?>>
					<span id="el_update_requests_Property">
						<span<?php echo $update_requests_view->Property->viewAttributes() ?>><?php echo $update_requests_view->Property->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyId">
				...
				<td data-name="PropertyId" <?php echo $update_requests_view->PropertyId->cellAttributes() ?>>
					<span id="el_update_requests_PropertyId">
						<span<?php echo $update_requests_view->PropertyId->viewAttributes() ?>><?php echo $update_requests_view->PropertyId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyUse">
				...
				<td data-name="PropertyUse" <?php echo $update_requests_view->PropertyUse->cellAttributes() ?>>
					<span id="el_update_requests_PropertyUse">
						<span<?php echo $update_requests_view->PropertyUse->viewAttributes() ?>><?php echo $update_requests_view->PropertyUse->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Comment">
				...
				<td data-name="Comment" <?php echo $update_requests_view->Comment->cellAttributes() ?>>
					<span id="el_update_requests_Comment">
						<span<?php echo $update_requests_view->Comment->viewAttributes() ?>><?php echo $update_requests_view->Comment->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
