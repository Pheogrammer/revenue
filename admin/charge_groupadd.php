	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ChargeGroupName" class="form-group row">
				...
				<div class="<?php echo $charge_group_add->RightColumnClass ?>">
					<div <?php echo $charge_group_add->ChargeGroupName->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_charge_group_ChargeGroupName">
								<span<?php echo $charge_group_add->ChargeGroupName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charge_group_add->ChargeGroupName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charge_group_add->ChargeGroupName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
