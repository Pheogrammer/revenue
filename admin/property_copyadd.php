...
<script>
	loadjs.ready("head", function() {
		...
		// Client script
		$("#x_BalanceBF").attr("disabled", "disabled"), $("#x_ChargeableFee").attr("disabled", "disabled"), $("#x_AmountPayable").attr("disabled", "disabled"), $("#x_CurrentBalance").attr("disabled", "disabled"), $("#x_AmountPaid").attr("disabled", "disabled"), $("#x_ChargeableFee").on("focus input change", function() {
			var e = parseFloat(document.getElementById("x_ChargeableFee").value),
				a = parseFloat(document.getElementById("x_BalanceBF").value),
				t = document.getElementById("x_AmountPayable"),
				d = document.getElementById("x_CurrentBalance");
			t.value = +e + a, d.value = +e + a
		});
	});
</script>
	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->ClientId->cellAttributes() ?>>
						<span id="el_property_copy_ClientId">
							...
							<script>
								loadjs.ready(["fproperty_copyadd"], function() {
									fproperty_copyadd.createAutoSuggest({
										"id": "x_ClientId",
										"forceSelect": true
									});
								});
						...
						<?php echo $property_copy_add->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGroup" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->ChargeGroup->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->ChargeGroup->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGropuDes" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->ChargeGropuDes->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->ChargeGropuDes->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Property" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->Property->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->Property->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->PropertyUse->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeableFee" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->ChargeableFee->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->ChargeableFee->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_BalanceBF" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->BalanceBF->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->BalanceBF->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPayable" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->AmountPayable->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->AmountPayable->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPaid" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->AmountPaid->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->AmountPaid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_CurrentBalance" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->CurrentBalance->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->CurrentBalance->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_DataRegistered" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->DataRegistered->cellAttributes() ?>>
							...
							<?php if (!$property_copy_add->DataRegistered->ReadOnly && !$property_copy_add->DataRegistered->Disabled && !isset($property_copy_add->DataRegistered->EditAttrs["readonly"]) && !isset($property_copy_add->DataRegistered->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["fproperty_copyadd", "datetimepicker"], function() {
										ew.createDateTimePicker("fproperty_copyadd", "x_DataRegistered", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 0
										});
						...
						<?php echo $property_copy_add->DataRegistered->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Description" class="form-group row">
				...
				<div class="<?php echo $property_copy_add->RightColumnClass ?>">
					<div <?php echo $property_copy_add->Description->cellAttributes() ?>>
						...
						<?php echo $property_copy_add->Description->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
