	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ChargeGroup" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->ChargeGroup->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_charges_ChargeGroup">
								<span<?php echo $charges_add->ChargeGroup->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->ChargeGroup->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->ChargeGroup->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeDesc" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->ChargeDesc->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_ChargeDesc">
								<span<?php echo $charges_add->ChargeDesc->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->ChargeDesc->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->ChargeDesc->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->PropertyUse->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_PropertyUse">
								<span<?php echo $charges_add->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Fee" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->Fee->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
							<span id="el_charges_Fee">
								<input type="text" data-table="charges" data-field="x_Fee" name="x_Fee" id="x_Fee" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($charges_add->Fee->getPlaceHolder()) ?>" value="<?php echo $charges_add->Fee->EditValue ?>" <?php echo $charges_add->Fee->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_charges_Fee">
								<span<?php echo $charges_add->Fee->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->Fee->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->Fee->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Factor" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->Factor->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
							<span id="el_charges_Factor">
								<input type="text" data-table="charges" data-field="x_Factor" name="x_Factor" id="x_Factor" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($charges_add->Factor->getPlaceHolder()) ?>" value="<?php echo $charges_add->Factor->EditValue ?>" <?php echo $charges_add->Factor->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_charges_Factor">
								<span<?php echo $charges_add->Factor->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->Factor->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->Factor->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_UnitOfMeasure" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->UnitOfMeasure->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_UnitOfMeasure">
								<span<?php echo $charges_add->UnitOfMeasure->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->UnitOfMeasure->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->UnitOfMeasure->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PeriodType" class="form-group row">
				...
				<div class="<?php echo $charges_add->RightColumnClass ?>">
					<div <?php echo $charges_add->PeriodType->cellAttributes() ?>>
						<?php if (!$charges->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charges_PeriodType">
								<span<?php echo $charges_add->PeriodType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charges_add->PeriodType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charges_add->PeriodType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
