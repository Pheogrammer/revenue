			...
			<tr id="r_ChargeCode">
				...
				<td data-name="ChargeCode" <?php echo $charges_view->ChargeCode->cellAttributes() ?>>
					<span id="el_charges_ChargeCode">
						<span<?php echo $charges_view->ChargeCode->viewAttributes() ?>><?php echo $charges_view->ChargeCode->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeGroup">
				...
				<td data-name="ChargeGroup" <?php echo $charges_view->ChargeGroup->cellAttributes() ?>>
					<span id="el_charges_ChargeGroup">
						<span<?php echo $charges_view->ChargeGroup->viewAttributes() ?>><?php echo $charges_view->ChargeGroup->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeDesc">
				...
				<td data-name="ChargeDesc" <?php echo $charges_view->ChargeDesc->cellAttributes() ?>>
					<span id="el_charges_ChargeDesc">
						<span<?php echo $charges_view->ChargeDesc->viewAttributes() ?>><?php echo $charges_view->ChargeDesc->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyUse">
				...
				<td data-name="PropertyUse" <?php echo $charges_view->PropertyUse->cellAttributes() ?>>
					<span id="el_charges_PropertyUse">
						<span<?php echo $charges_view->PropertyUse->viewAttributes() ?>><?php echo $charges_view->PropertyUse->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Fee">
				...
				<td data-name="Fee" <?php echo $charges_view->Fee->cellAttributes() ?>>
					<span id="el_charges_Fee">
						<span<?php echo $charges_view->Fee->viewAttributes() ?>><?php echo $charges_view->Fee->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Factor">
				...
				<td data-name="Factor" <?php echo $charges_view->Factor->cellAttributes() ?>>
					<span id="el_charges_Factor">
						<span<?php echo $charges_view->Factor->viewAttributes() ?>><?php echo $charges_view->Factor->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_UnitOfMeasure">
				...
				<td data-name="UnitOfMeasure" <?php echo $charges_view->UnitOfMeasure->cellAttributes() ?>>
					<span id="el_charges_UnitOfMeasure">
						<span<?php echo $charges_view->UnitOfMeasure->viewAttributes() ?>><?php echo $charges_view->UnitOfMeasure->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PeriodType">
				...
				<td data-name="PeriodType" <?php echo $charges_view->PeriodType->cellAttributes() ?>>
					<span id="el_charges_PeriodType">
						<span<?php echo $charges_view->PeriodType->viewAttributes() ?>><?php echo $charges_view->PeriodType->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
