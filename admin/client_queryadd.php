	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $client_query_add->RightColumnClass ?>">
					<div <?php echo $client_query_add->ClientId->cellAttributes() ?>>
						...
						<?php echo $client_query_add->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Query" class="form-group row">
				...
				<div class="<?php echo $client_query_add->RightColumnClass ?>">
					<div <?php echo $client_query_add->Query->cellAttributes() ?>>
						...
						<?php echo $client_query_add->Query->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Reply" class="form-group row">
				...
				<div class="<?php echo $client_query_add->RightColumnClass ?>">
					<div <?php echo $client_query_add->Reply->cellAttributes() ?>>
						...
						<?php echo $client_query_add->Reply->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Date" class="form-group row">
				...
				<div class="<?php echo $client_query_add->RightColumnClass ?>">
					<div <?php echo $client_query_add->Date->cellAttributes() ?>>
							...
							<?php if (!$client_query_add->Date->ReadOnly && !$client_query_add->Date->Disabled && !isset($client_query_add->Date->EditAttrs["readonly"]) && !isset($client_query_add->Date->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["fclient_queryadd", "datetimepicker"], function() {
										ew.createDateTimePicker("fclient_queryadd", "x_Date", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 0
										});
						...
						<?php echo $client_query_add->Date->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Status" class="form-group row">
				...
				<div class="<?php echo $client_query_add->RightColumnClass ?>">
					<div <?php echo $client_query_add->Status->cellAttributes() ?>>
						...
						<?php echo $client_query_add->Status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
