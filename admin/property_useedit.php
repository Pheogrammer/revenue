	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_use_edit->RightColumnClass ?>">
					<div <?php echo $property_use_edit->PropertyUse->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_property_use_PropertyUse">
								<span<?php echo $property_use_edit->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_use_edit->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_use_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
