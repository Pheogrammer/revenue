			...
			<tr id="r_userlevelid">
				...
				<td data-name="userlevelid" <?php echo $userlevelpermissions_view->userlevelid->cellAttributes() ?>>
					<span id="el_userlevelpermissions_userlevelid">
						<span<?php echo $userlevelpermissions_view->userlevelid->viewAttributes() ?>><?php echo $userlevelpermissions_view->userlevelid->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r__tablename">
				...
				<td data-name="_tablename" <?php echo $userlevelpermissions_view->_tablename->cellAttributes() ?>>
					<span id="el_userlevelpermissions__tablename">
						<span<?php echo $userlevelpermissions_view->_tablename->viewAttributes() ?>><?php echo $userlevelpermissions_view->_tablename->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_permission">
				...
				<td data-name="permission" <?php echo $userlevelpermissions_view->permission->cellAttributes() ?>>
					<span id="el_userlevelpermissions_permission">
						<span<?php echo $userlevelpermissions_view->permission->viewAttributes() ?>><?php echo $userlevelpermissions_view->permission->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
