	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->ClientId->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewClientIdentity" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->NewClientIdentity->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->NewClientIdentity->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewClientName" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->NewClientName->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->NewClientName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewAccountType" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->NewAccountType->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->NewAccountType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewMobileNumber" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->NewMobileNumber->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->NewMobileNumber->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewEmail" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->NewEmail->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->NewEmail->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NewAdditionalInformation" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->NewAdditionalInformation->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->NewAdditionalInformation->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_date" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->date->cellAttributes() ?>>
							...
							<?php if (!$update_requests_add->date->ReadOnly && !$update_requests_add->date->Disabled && !isset($update_requests_add->date->EditAttrs["readonly"]) && !isset($update_requests_add->date->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["fupdate_requestsadd", "datetimepicker"], function() {
										ew.createDateTimePicker("fupdate_requestsadd", "x_date", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 7
										});
						...
						<?php echo $update_requests_add->date->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_status" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->status->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Property" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->Property->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->Property->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyId" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->PropertyId->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->PropertyId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->PropertyUse->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Comment" class="form-group row">
				...
				<div class="<?php echo $update_requests_add->RightColumnClass ?>">
					<div <?php echo $update_requests_add->Comment->cellAttributes() ?>>
						...
						<?php echo $update_requests_add->Comment->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
