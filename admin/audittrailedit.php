...
<?php if (!$audittrail_edit->IsModal) { ?>
	<form name="ew-pager-form" class="form-inline ew-form ew-pager-form" action="<?php echo CurrentPageName() ?>">
		<?php echo $audittrail_edit->Pager->render() ?>
	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_id" class="form-group row">
				<label id="elh_audittrail_id" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail_edit->id->caption() ?><?php echo $audittrail_edit->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->id->cellAttributes() ?>>
						<span id="el_audittrail_id">
							<span<?php echo $audittrail_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($audittrail_edit->id->EditValue)) ?>">
						</span>
						</span>
						<input type="hidden" data-table="audittrail" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($audittrail_edit->id->CurrentValue) ?>">
						<?php echo $audittrail_edit->id->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_datetime" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->datetime->cellAttributes() ?>>
						<span id="el_audittrail_datetime">
							<input type="text" data-table="audittrail" data-field="x_datetime" name="x_datetime" id="x_datetime" maxlength="19" placeholder="<?php echo HtmlEncode($audittrail_edit->datetime->getPlaceHolder()) ?>" value="<?php echo $audittrail_edit->datetime->EditValue ?>" <?php echo $audittrail_edit->datetime->editAttributes() ?>>
							<?php if (!$audittrail_edit->datetime->ReadOnly && !$audittrail_edit->datetime->Disabled && !isset($audittrail_edit->datetime->EditAttrs["readonly"]) && !isset($audittrail_edit->datetime->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["faudittrailedit", "datetimepicker"], function() {
										ew.createDateTimePicker("faudittrailedit", "x_datetime", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 0
										});
						...
						<?php echo $audittrail_edit->datetime->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_script" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->script->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->script->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_user" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->user->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->user->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__action" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->_action->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->_action->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__table" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->_table->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->_table->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_field" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->field->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->field->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_keyvalue" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->keyvalue->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->keyvalue->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_oldvalue" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->oldvalue->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->oldvalue->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_newvalue" class="form-group row">
				...
				<div class="<?php echo $audittrail_edit->RightColumnClass ?>">
					<div <?php echo $audittrail_edit->newvalue->cellAttributes() ?>>
						...
						<?php echo $audittrail_edit->newvalue->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
