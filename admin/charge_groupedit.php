	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_ChargeGroupCode" class="form-group row">
				...
				<div class="<?php echo $charge_group_edit->RightColumnClass ?>">
					<div <?php echo $charge_group_edit->ChargeGroupCode->cellAttributes() ?>>
						<?php if (!$charge_group->isConfirm()) { ?>
							<span id="el_charge_group_ChargeGroupCode">
								<span<?php echo $charge_group_edit->ChargeGroupCode->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charge_group_edit->ChargeGroupCode->EditValue)) ?>">
							</span>
							</span>
						...
						<?php } else { ?>
							<span id="el_charge_group_ChargeGroupCode">
								<span<?php echo $charge_group_edit->ChargeGroupCode->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charge_group_edit->ChargeGroupCode->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charge_group_edit->ChargeGroupCode->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGroupName" class="form-group row">
				...
				<div class="<?php echo $charge_group_edit->RightColumnClass ?>">
					<div <?php echo $charge_group_edit->ChargeGroupName->cellAttributes() ?>>
						<?php if (!$charge_group->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_charge_group_ChargeGroupName">
								<span<?php echo $charge_group_edit->ChargeGroupName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($charge_group_edit->ChargeGroupName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $charge_group_edit->ChargeGroupName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
