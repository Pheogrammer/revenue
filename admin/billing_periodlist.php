		...
		<form name="fbilling_periodlist" id="fbilling_periodlist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_billing_period" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($billing_period_list->TotalRecords > 0 || $billing_period_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_billing_periodlist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($billing_period_list->SortUrl($billing_period_list->BillingYear) == "") { ?>
										<th data-name="BillingYear" class="<?php echo $billing_period_list->BillingYear->headerCellClass() ?>">
											<div id="elh_billing_period_BillingYear" class="billing_period_BillingYear">
												<div class="ew-table-header-caption"><?php echo $billing_period_list->BillingYear->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="BillingYear" class="<?php echo $billing_period_list->BillingYear->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $billing_period_list->SortUrl($billing_period_list->BillingYear) ?>', 1);">
												<div id="elh_billing_period_BillingYear" class="billing_period_BillingYear">
								...
								?>
									<?php if ($billing_period_list->SortUrl($billing_period_list->BillingCycle) == "") { ?>
										<th data-name="BillingCycle" class="<?php echo $billing_period_list->BillingCycle->headerCellClass() ?>">
											<div id="elh_billing_period_BillingCycle" class="billing_period_BillingCycle">
												<div class="ew-table-header-caption"><?php echo $billing_period_list->BillingCycle->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="BillingCycle" class="<?php echo $billing_period_list->BillingCycle->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $billing_period_list->SortUrl($billing_period_list->BillingCycle) ?>', 1);">
												<div id="elh_billing_period_BillingCycle" class="billing_period_BillingCycle">
								...
								?>
									<?php if ($billing_period_list->SortUrl($billing_period_list->From) == "") { ?>
										<th data-name="From" class="<?php echo $billing_period_list->From->headerCellClass() ?>">
											<div id="elh_billing_period_From" class="billing_period_From">
												<div class="ew-table-header-caption"><?php echo $billing_period_list->From->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="From" class="<?php echo $billing_period_list->From->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $billing_period_list->SortUrl($billing_period_list->From) ?>', 1);">
												<div id="elh_billing_period_From" class="billing_period_From">
								...
								?>
									<?php if ($billing_period_list->SortUrl($billing_period_list->To) == "") { ?>
										<th data-name="To" class="<?php echo $billing_period_list->To->headerCellClass() ?>">
											<div id="elh_billing_period_To" class="billing_period_To">
												<div class="ew-table-header-caption"><?php echo $billing_period_list->To->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="To" class="<?php echo $billing_period_list->To->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $billing_period_list->SortUrl($billing_period_list->To) ?>', 1);">
												<div id="elh_billing_period_To" class="billing_period_To">
								...
								?>
									<?php if ($billing_period_list->SortUrl($billing_period_list->Status) == "") { ?>
										<th data-name="Status" class="<?php echo $billing_period_list->Status->headerCellClass() ?>">
											<div id="elh_billing_period_Status" class="billing_period_Status">
												<div class="ew-table-header-caption"><?php echo $billing_period_list->Status->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Status" class="<?php echo $billing_period_list->Status->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $billing_period_list->SortUrl($billing_period_list->Status) ?>', 1);">
												<div id="elh_billing_period_Status" class="billing_period_Status">
										...
										?>
											<td data-name="BillingYear" <?php echo $billing_period_list->BillingYear->cellAttributes() ?>>
												<span id="el<?php echo $billing_period_list->RowCount ?>_billing_period_BillingYear">
													<span<?php echo $billing_period_list->BillingYear->viewAttributes() ?>><?php echo $billing_period_list->BillingYear->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="BillingCycle" <?php echo $billing_period_list->BillingCycle->cellAttributes() ?>>
												<span id="el<?php echo $billing_period_list->RowCount ?>_billing_period_BillingCycle">
													<span<?php echo $billing_period_list->BillingCycle->viewAttributes() ?>><?php echo $billing_period_list->BillingCycle->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="From" <?php echo $billing_period_list->From->cellAttributes() ?>>
												<span id="el<?php echo $billing_period_list->RowCount ?>_billing_period_From">
													<span<?php echo $billing_period_list->From->viewAttributes() ?>><?php echo $billing_period_list->From->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="To" <?php echo $billing_period_list->To->cellAttributes() ?>>
												<span id="el<?php echo $billing_period_list->RowCount ?>_billing_period_To">
													<span<?php echo $billing_period_list->To->viewAttributes() ?>><?php echo $billing_period_list->To->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Status" <?php echo $billing_period_list->Status->cellAttributes() ?>>
												<span id="el<?php echo $billing_period_list->RowCount ?>_billing_period_Status">
													<span<?php echo $billing_period_list->Status->viewAttributes() ?>><?php echo $billing_period_list->Status->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
