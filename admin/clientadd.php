	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_ClientName" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->ClientName->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_client_ClientName">
								<span<?php echo $client_add->ClientName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->ClientName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->ClientName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientType" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->ClientType->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_ClientType">
								<span<?php echo $client_add->ClientType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->ClientType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->ClientType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_IdentityType" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->IdentityType->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_IdentityType">
								<span<?php echo $client_add->IdentityType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->IdentityType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->IdentityType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientID" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->ClientID->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_ClientID">
								<span<?php echo $client_add->ClientID->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->ClientID->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->ClientID->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Surname" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->Surname->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_Surname">
								<span<?php echo $client_add->Surname->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->Surname->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->Surname->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_FirstName" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->FirstName->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_FirstName">
								<span<?php echo $client_add->FirstName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->FirstName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->FirstName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_MiddleName" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->MiddleName->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_MiddleName">
								<span<?php echo $client_add->MiddleName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->MiddleName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->MiddleName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Gender" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->Gender->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_Gender">
								<span<?php echo $client_add->Gender->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->Gender->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->Gender->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_MaritalStatus" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->MaritalStatus->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_MaritalStatus">
								<span<?php echo $client_add->MaritalStatus->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->MaritalStatus->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->MaritalStatus->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_DateOfBirth" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->DateOfBirth->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
								...
								<?php if (!$client_add->DateOfBirth->ReadOnly && !$client_add->DateOfBirth->Disabled && !isset($client_add->DateOfBirth->EditAttrs["readonly"]) && !isset($client_add->DateOfBirth->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fclientadd", "datetimepicker"], function() {
											ew.createDateTimePicker("fclientadd", "x_DateOfBirth", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_client_DateOfBirth">
								<span<?php echo $client_add->DateOfBirth->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->DateOfBirth->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->DateOfBirth->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PostalAddress" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->PostalAddress->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_PostalAddress">
								<span<?php echo $client_add->PostalAddress->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->PostalAddress->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->PostalAddress->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PhysicalAddress" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->PhysicalAddress->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_PhysicalAddress">
								<span<?php echo $client_add->PhysicalAddress->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->PhysicalAddress->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->PhysicalAddress->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_TownOrVillage" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->TownOrVillage->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_TownOrVillage">
								<span<?php echo $client_add->TownOrVillage->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->TownOrVillage->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->TownOrVillage->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Mobile" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->Mobile->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_Mobile">
								<span<?php echo $client_add->Mobile->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->Mobile->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->Mobile->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__Email" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->_Email->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client__Email">
								<span<?php echo $client_add->_Email->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->_Email->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->_Email->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NextOfKin" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->NextOfKin->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_NextOfKin">
								<span<?php echo $client_add->NextOfKin->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->NextOfKin->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->NextOfKin->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NextOfKinMobile" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->NextOfKinMobile->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_NextOfKinMobile">
								<span<?php echo $client_add->NextOfKinMobile->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->NextOfKinMobile->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->NextOfKinMobile->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NextOfKinEmail" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->NextOfKinEmail->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_NextOfKinEmail">
								<span<?php echo $client_add->NextOfKinEmail->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_add->NextOfKinEmail->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->NextOfKinEmail->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AdditionalInformation" class="form-group row">
				...
				<div class="<?php echo $client_add->RightColumnClass ?>">
					<div <?php echo $client_add->AdditionalInformation->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_AdditionalInformation">
								<span<?php echo $client_add->AdditionalInformation->viewAttributes() ?>><?php echo $client_add->AdditionalInformation->ViewValue ?>
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_add->AdditionalInformation->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
