		...
		<form name="fclientlist" id="fclientlist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_client" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($client_list->TotalRecords > 0 || $client_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_clientlist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->id) == "") { ?>
										<th data-name="id" class="<?php echo $client_list->id->headerCellClass() ?>">
											<div id="elh_client_id" class="client_id">
												<div class="ew-table-header-caption"><?php echo $client_list->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $client_list->id->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->id) ?>', 1);">
												<div id="elh_client_id" class="client_id">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->ClientName) == "") { ?>
										<th data-name="ClientName" class="<?php echo $client_list->ClientName->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_client_ClientName" class="client_ClientName">
												<div class="ew-table-header-caption"><?php echo $client_list->ClientName->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientName" class="<?php echo $client_list->ClientName->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->ClientName) ?>', 1);">
												<div id="elh_client_ClientName" class="client_ClientName">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->ClientType) == "") { ?>
										<th data-name="ClientType" class="<?php echo $client_list->ClientType->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_client_ClientType" class="client_ClientType">
												<div class="ew-table-header-caption"><?php echo $client_list->ClientType->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientType" class="<?php echo $client_list->ClientType->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->ClientType) ?>', 1);">
												<div id="elh_client_ClientType" class="client_ClientType">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->IdentityType) == "") { ?>
										<th data-name="IdentityType" class="<?php echo $client_list->IdentityType->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_client_IdentityType" class="client_IdentityType">
												<div class="ew-table-header-caption"><?php echo $client_list->IdentityType->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="IdentityType" class="<?php echo $client_list->IdentityType->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->IdentityType) ?>', 1);">
												<div id="elh_client_IdentityType" class="client_IdentityType">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->ClientID) == "") { ?>
										<th data-name="ClientID" class="<?php echo $client_list->ClientID->headerCellClass() ?>">
											<div id="elh_client_ClientID" class="client_ClientID">
												<div class="ew-table-header-caption"><?php echo $client_list->ClientID->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientID" class="<?php echo $client_list->ClientID->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->ClientID) ?>', 1);">
												<div id="elh_client_ClientID" class="client_ClientID">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->Surname) == "") { ?>
										<th data-name="Surname" class="<?php echo $client_list->Surname->headerCellClass() ?>">
											<div id="elh_client_Surname" class="client_Surname">
												<div class="ew-table-header-caption"><?php echo $client_list->Surname->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Surname" class="<?php echo $client_list->Surname->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Surname) ?>', 1);">
												<div id="elh_client_Surname" class="client_Surname">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->FirstName) == "") { ?>
										<th data-name="FirstName" class="<?php echo $client_list->FirstName->headerCellClass() ?>">
											<div id="elh_client_FirstName" class="client_FirstName">
												<div class="ew-table-header-caption"><?php echo $client_list->FirstName->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="FirstName" class="<?php echo $client_list->FirstName->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->FirstName) ?>', 1);">
												<div id="elh_client_FirstName" class="client_FirstName">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->MiddleName) == "") { ?>
										<th data-name="MiddleName" class="<?php echo $client_list->MiddleName->headerCellClass() ?>">
											<div id="elh_client_MiddleName" class="client_MiddleName">
												<div class="ew-table-header-caption"><?php echo $client_list->MiddleName->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="MiddleName" class="<?php echo $client_list->MiddleName->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->MiddleName) ?>', 1);">
												<div id="elh_client_MiddleName" class="client_MiddleName">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->Gender) == "") { ?>
										<th data-name="Gender" class="<?php echo $client_list->Gender->headerCellClass() ?>">
											<div id="elh_client_Gender" class="client_Gender">
												<div class="ew-table-header-caption"><?php echo $client_list->Gender->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Gender" class="<?php echo $client_list->Gender->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Gender) ?>', 1);">
												<div id="elh_client_Gender" class="client_Gender">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->MaritalStatus) == "") { ?>
										<th data-name="MaritalStatus" class="<?php echo $client_list->MaritalStatus->headerCellClass() ?>">
											<div id="elh_client_MaritalStatus" class="client_MaritalStatus">
												<div class="ew-table-header-caption"><?php echo $client_list->MaritalStatus->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="MaritalStatus" class="<?php echo $client_list->MaritalStatus->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->MaritalStatus) ?>', 1);">
												<div id="elh_client_MaritalStatus" class="client_MaritalStatus">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->DateOfBirth) == "") { ?>
										<th data-name="DateOfBirth" class="<?php echo $client_list->DateOfBirth->headerCellClass() ?>">
											<div id="elh_client_DateOfBirth" class="client_DateOfBirth">
												<div class="ew-table-header-caption"><?php echo $client_list->DateOfBirth->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="DateOfBirth" class="<?php echo $client_list->DateOfBirth->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->DateOfBirth) ?>', 1);">
												<div id="elh_client_DateOfBirth" class="client_DateOfBirth">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->TownOrVillage) == "") { ?>
										<th data-name="TownOrVillage" class="<?php echo $client_list->TownOrVillage->headerCellClass() ?>">
											<div id="elh_client_TownOrVillage" class="client_TownOrVillage">
												<div class="ew-table-header-caption"><?php echo $client_list->TownOrVillage->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="TownOrVillage" class="<?php echo $client_list->TownOrVillage->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->TownOrVillage) ?>', 1);">
												<div id="elh_client_TownOrVillage" class="client_TownOrVillage">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->Mobile) == "") { ?>
										<th data-name="Mobile" class="<?php echo $client_list->Mobile->headerCellClass() ?>">
											<div id="elh_client_Mobile" class="client_Mobile">
												<div class="ew-table-header-caption"><?php echo $client_list->Mobile->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Mobile" class="<?php echo $client_list->Mobile->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->Mobile) ?>', 1);">
												<div id="elh_client_Mobile" class="client_Mobile">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->_Email) == "") { ?>
										<th data-name="_Email" class="<?php echo $client_list->_Email->headerCellClass() ?>">
											<div id="elh_client__Email" class="client__Email">
												<div class="ew-table-header-caption"><?php echo $client_list->_Email->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="_Email" class="<?php echo $client_list->_Email->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->_Email) ?>', 1);">
												<div id="elh_client__Email" class="client__Email">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->NextOfKin) == "") { ?>
										<th data-name="NextOfKin" class="<?php echo $client_list->NextOfKin->headerCellClass() ?>">
											<div id="elh_client_NextOfKin" class="client_NextOfKin">
												<div class="ew-table-header-caption"><?php echo $client_list->NextOfKin->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NextOfKin" class="<?php echo $client_list->NextOfKin->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->NextOfKin) ?>', 1);">
												<div id="elh_client_NextOfKin" class="client_NextOfKin">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->NextOfKinMobile) == "") { ?>
										<th data-name="NextOfKinMobile" class="<?php echo $client_list->NextOfKinMobile->headerCellClass() ?>">
											<div id="elh_client_NextOfKinMobile" class="client_NextOfKinMobile">
												<div class="ew-table-header-caption"><?php echo $client_list->NextOfKinMobile->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NextOfKinMobile" class="<?php echo $client_list->NextOfKinMobile->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->NextOfKinMobile) ?>', 1);">
												<div id="elh_client_NextOfKinMobile" class="client_NextOfKinMobile">
								...
								?>
									<?php if ($client_list->SortUrl($client_list->NextOfKinEmail) == "") { ?>
										<th data-name="NextOfKinEmail" class="<?php echo $client_list->NextOfKinEmail->headerCellClass() ?>">
											<div id="elh_client_NextOfKinEmail" class="client_NextOfKinEmail">
												<div class="ew-table-header-caption"><?php echo $client_list->NextOfKinEmail->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NextOfKinEmail" class="<?php echo $client_list->NextOfKinEmail->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $client_list->SortUrl($client_list->NextOfKinEmail) ?>', 1);">
												<div id="elh_client_NextOfKinEmail" class="client_NextOfKinEmail">
										...
										?>
											<td data-name="id" <?php echo $client_list->id->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_id">
													<span<?php echo $client_list->id->viewAttributes() ?>><?php echo $client_list->id->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientName" <?php echo $client_list->ClientName->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_ClientName">
													<span<?php echo $client_list->ClientName->viewAttributes() ?>><?php echo $client_list->ClientName->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientType" <?php echo $client_list->ClientType->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_ClientType">
													<span<?php echo $client_list->ClientType->viewAttributes() ?>><?php echo $client_list->ClientType->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="IdentityType" <?php echo $client_list->IdentityType->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_IdentityType">
													<span<?php echo $client_list->IdentityType->viewAttributes() ?>><?php echo $client_list->IdentityType->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientID" <?php echo $client_list->ClientID->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_ClientID">
													<span<?php echo $client_list->ClientID->viewAttributes() ?>><?php echo $client_list->ClientID->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Surname" <?php echo $client_list->Surname->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_Surname">
													<span<?php echo $client_list->Surname->viewAttributes() ?>><?php echo $client_list->Surname->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="FirstName" <?php echo $client_list->FirstName->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_FirstName">
													<span<?php echo $client_list->FirstName->viewAttributes() ?>><?php echo $client_list->FirstName->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="MiddleName" <?php echo $client_list->MiddleName->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_MiddleName">
													<span<?php echo $client_list->MiddleName->viewAttributes() ?>><?php echo $client_list->MiddleName->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Gender" <?php echo $client_list->Gender->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_Gender">
													<span<?php echo $client_list->Gender->viewAttributes() ?>><?php echo $client_list->Gender->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="MaritalStatus" <?php echo $client_list->MaritalStatus->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_MaritalStatus">
													<span<?php echo $client_list->MaritalStatus->viewAttributes() ?>><?php echo $client_list->MaritalStatus->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="DateOfBirth" <?php echo $client_list->DateOfBirth->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_DateOfBirth">
													<span<?php echo $client_list->DateOfBirth->viewAttributes() ?>><?php echo $client_list->DateOfBirth->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="TownOrVillage" <?php echo $client_list->TownOrVillage->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_TownOrVillage">
													<span<?php echo $client_list->TownOrVillage->viewAttributes() ?>><?php echo $client_list->TownOrVillage->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Mobile" <?php echo $client_list->Mobile->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_Mobile">
													<span<?php echo $client_list->Mobile->viewAttributes() ?>><?php echo $client_list->Mobile->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="_Email" <?php echo $client_list->_Email->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client__Email">
													<span<?php echo $client_list->_Email->viewAttributes() ?>><?php echo $client_list->_Email->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NextOfKin" <?php echo $client_list->NextOfKin->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_NextOfKin">
													<span<?php echo $client_list->NextOfKin->viewAttributes() ?>><?php echo $client_list->NextOfKin->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NextOfKinMobile" <?php echo $client_list->NextOfKinMobile->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_NextOfKinMobile">
													<span<?php echo $client_list->NextOfKinMobile->viewAttributes() ?>><?php echo $client_list->NextOfKinMobile->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NextOfKinEmail" <?php echo $client_list->NextOfKinEmail->cellAttributes() ?>>
												<span id="el<?php echo $client_list->RowCount ?>_client_NextOfKinEmail">
													<span<?php echo $client_list->NextOfKinEmail->viewAttributes() ?>><?php echo $client_list->NextOfKinEmail->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
