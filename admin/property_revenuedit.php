	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_id" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->id->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_id">
								<span<?php echo $property_revenu_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->id->EditValue)) ?>">
							</span>
							</span>
						...
						<?php } else { ?>
							<span id="el_property_revenu_id">
								<span<?php echo $property_revenu_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->id->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->id->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->ClientId->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<?php if ($property_revenu_edit->ClientId->getSessionValue() != "") { ?>
								<span id="el_property_revenu_ClientId">
									<span<?php echo $property_revenu_edit->ClientId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->ClientId->ViewValue)) ?>">
								</span>
								</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientProperty" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->ClientProperty->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_ClientProperty">
								...
								<script>
									loadjs.ready(["fproperty_revenuedit"], function() {
										fproperty_revenuedit.createAutoSuggest({
											"id": "x_ClientProperty",
											"forceSelect": true
										});
									});
						...
						<?php } else { ?>
							<span id="el_property_revenu_ClientProperty">
								<span<?php echo $property_revenu_edit->ClientProperty->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->ClientProperty->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->ClientProperty->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyId" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->PropertyId->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_revenu_PropertyId">
								<span<?php echo $property_revenu_edit->PropertyId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->PropertyId->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->PropertyId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->PropertyUse->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_revenu_PropertyUse">
								<span<?php echo $property_revenu_edit->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPayable" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->AmountPayable->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_AmountPayable">
								<input type="text" data-table="property_revenu" data-field="x_AmountPayable" name="x_AmountPayable" id="x_AmountPayable" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($property_revenu_edit->AmountPayable->getPlaceHolder()) ?>" value="<?php echo $property_revenu_edit->AmountPayable->EditValue ?>" <?php echo $property_revenu_edit->AmountPayable->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_property_revenu_AmountPayable">
								<span<?php echo $property_revenu_edit->AmountPayable->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->AmountPayable->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->AmountPayable->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPaid" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->AmountPaid->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_AmountPaid">
								<input type="text" data-table="property_revenu" data-field="x_AmountPaid" name="x_AmountPaid" id="x_AmountPaid" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($property_revenu_edit->AmountPaid->getPlaceHolder()) ?>" value="<?php echo $property_revenu_edit->AmountPaid->EditValue ?>" <?php echo $property_revenu_edit->AmountPaid->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_property_revenu_AmountPaid">
								<span<?php echo $property_revenu_edit->AmountPaid->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->AmountPaid->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->AmountPaid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Balance" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->Balance->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
							<span id="el_property_revenu_Balance">
								<input type="text" data-table="property_revenu" data-field="x_Balance" name="x_Balance" id="x_Balance" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($property_revenu_edit->Balance->getPlaceHolder()) ?>" value="<?php echo $property_revenu_edit->Balance->EditValue ?>" <?php echo $property_revenu_edit->Balance->editAttributes() ?>>
							</span>
						<?php } else { ?>
							<span id="el_property_revenu_Balance">
								<span<?php echo $property_revenu_edit->Balance->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->Balance->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->Balance->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_date" class="form-group row">
				...
				<div class="<?php echo $property_revenu_edit->RightColumnClass ?>">
					<div <?php echo $property_revenu_edit->date->cellAttributes() ?>>
						<?php if (!$property_revenu->isConfirm()) { ?>
								...
								<?php if (!$property_revenu_edit->date->ReadOnly && !$property_revenu_edit->date->Disabled && !isset($property_revenu_edit->date->EditAttrs["readonly"]) && !isset($property_revenu_edit->date->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fproperty_revenuedit", "datetimepicker"], function() {
											ew.createDateTimePicker("fproperty_revenuedit", "x_date", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 7
											});
						...
						<?php } else { ?>
							<span id="el_property_revenu_date">
								<span<?php echo $property_revenu_edit->date->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_revenu_edit->date->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_revenu_edit->date->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
