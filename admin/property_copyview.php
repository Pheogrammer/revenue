			...
			<tr id="r_id">
				...
				<td data-name="id" <?php echo $property_copy_view->id->cellAttributes() ?>>
					<span id="el_property_copy_id">
						<span<?php echo $property_copy_view->id->viewAttributes() ?>><?php echo $property_copy_view->id->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ClientId">
				...
				<td data-name="ClientId" <?php echo $property_copy_view->ClientId->cellAttributes() ?>>
					<span id="el_property_copy_ClientId">
						<span<?php echo $property_copy_view->ClientId->viewAttributes() ?>><?php echo $property_copy_view->ClientId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeGroup">
				...
				<td data-name="ChargeGroup" <?php echo $property_copy_view->ChargeGroup->cellAttributes() ?>>
					<span id="el_property_copy_ChargeGroup">
						<span<?php echo $property_copy_view->ChargeGroup->viewAttributes() ?>><?php echo $property_copy_view->ChargeGroup->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeGropuDes">
				...
				<td data-name="ChargeGropuDes" <?php echo $property_copy_view->ChargeGropuDes->cellAttributes() ?>>
					<span id="el_property_copy_ChargeGropuDes">
						<span<?php echo $property_copy_view->ChargeGropuDes->viewAttributes() ?>><?php echo $property_copy_view->ChargeGropuDes->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Property">
				...
				<td data-name="Property" <?php echo $property_copy_view->Property->cellAttributes() ?>>
					<span id="el_property_copy_Property">
						<span<?php echo $property_copy_view->Property->viewAttributes() ?>><?php echo $property_copy_view->Property->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_PropertyUse">
				...
				<td data-name="PropertyUse" <?php echo $property_copy_view->PropertyUse->cellAttributes() ?>>
					<span id="el_property_copy_PropertyUse">
						<span<?php echo $property_copy_view->PropertyUse->viewAttributes() ?>><?php echo $property_copy_view->PropertyUse->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_ChargeableFee">
				...
				<td data-name="ChargeableFee" <?php echo $property_copy_view->ChargeableFee->cellAttributes() ?>>
					<span id="el_property_copy_ChargeableFee">
						<span<?php echo $property_copy_view->ChargeableFee->viewAttributes() ?>><?php echo $property_copy_view->ChargeableFee->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_BalanceBF">
				...
				<td data-name="BalanceBF" <?php echo $property_copy_view->BalanceBF->cellAttributes() ?>>
					<span id="el_property_copy_BalanceBF">
						<span<?php echo $property_copy_view->BalanceBF->viewAttributes() ?>><?php echo $property_copy_view->BalanceBF->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_AmountPayable">
				...
				<td data-name="AmountPayable" <?php echo $property_copy_view->AmountPayable->cellAttributes() ?>>
					<span id="el_property_copy_AmountPayable">
						<span<?php echo $property_copy_view->AmountPayable->viewAttributes() ?>><?php echo $property_copy_view->AmountPayable->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_AmountPaid">
				...
				<td data-name="AmountPaid" <?php echo $property_copy_view->AmountPaid->cellAttributes() ?>>
					<span id="el_property_copy_AmountPaid">
						<span<?php echo $property_copy_view->AmountPaid->viewAttributes() ?>><?php echo $property_copy_view->AmountPaid->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_CurrentBalance">
				...
				<td data-name="CurrentBalance" <?php echo $property_copy_view->CurrentBalance->cellAttributes() ?>>
					<span id="el_property_copy_CurrentBalance">
						<span<?php echo $property_copy_view->CurrentBalance->viewAttributes() ?>><?php echo $property_copy_view->CurrentBalance->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_DataRegistered">
				...
				<td data-name="DataRegistered" <?php echo $property_copy_view->DataRegistered->cellAttributes() ?>>
					<span id="el_property_copy_DataRegistered">
						<span<?php echo $property_copy_view->DataRegistered->viewAttributes() ?>><?php echo $property_copy_view->DataRegistered->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Description">
				...
				<td data-name="Description" <?php echo $property_copy_view->Description->cellAttributes() ?>>
					<span id="el_property_copy_Description">
						<span<?php echo $property_copy_view->Description->viewAttributes() ?>><?php echo $property_copy_view->Description->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
