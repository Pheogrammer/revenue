			...
			<tr id="r_BillingYear">
				...
				<td data-name="BillingYear" <?php echo $billing_period_view->BillingYear->cellAttributes() ?>>
					<span id="el_billing_period_BillingYear">
						<span<?php echo $billing_period_view->BillingYear->viewAttributes() ?>><?php echo $billing_period_view->BillingYear->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_BillingCycle">
				...
				<td data-name="BillingCycle" <?php echo $billing_period_view->BillingCycle->cellAttributes() ?>>
					<span id="el_billing_period_BillingCycle">
						<span<?php echo $billing_period_view->BillingCycle->viewAttributes() ?>><?php echo $billing_period_view->BillingCycle->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_From">
				...
				<td data-name="From" <?php echo $billing_period_view->From->cellAttributes() ?>>
					<span id="el_billing_period_From">
						<span<?php echo $billing_period_view->From->viewAttributes() ?>><?php echo $billing_period_view->From->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_To">
				...
				<td data-name="To" <?php echo $billing_period_view->To->cellAttributes() ?>>
					<span id="el_billing_period_To">
						<span<?php echo $billing_period_view->To->viewAttributes() ?>><?php echo $billing_period_view->To->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Status">
				...
				<td data-name="Status" <?php echo $billing_period_view->Status->cellAttributes() ?>>
					<span id="el_billing_period_Status">
						<span<?php echo $billing_period_view->Status->viewAttributes() ?>><?php echo $billing_period_view->Status->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
