		...
		?>
			<tr id="r_id">
				...
				<td data-name="id" <?php echo $users_view->id->cellAttributes() ?>>
					<span id="el_users_id">
						<span<?php echo $users_view->id->viewAttributes() ?>><?php echo $users_view->id->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Fullname">
				...
				<td data-name="Fullname" <?php echo $users_view->Fullname->cellAttributes() ?>>
					<span id="el_users_Fullname">
						<span<?php echo $users_view->Fullname->viewAttributes() ?>><?php echo $users_view->Fullname->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Username">
				...
				<td data-name="Username" <?php echo $users_view->Username->cellAttributes() ?>>
					<span id="el_users_Username">
						<span<?php echo $users_view->Username->viewAttributes() ?>><?php echo $users_view->Username->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r__Email">
				...
				<td data-name="_Email" <?php echo $users_view->_Email->cellAttributes() ?>>
					<span id="el_users__Email">
						<span<?php echo $users_view->_Email->viewAttributes() ?>><?php echo $users_view->_Email->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_Passsword">
				...
				<td data-name="Passsword" <?php echo $users_view->Passsword->cellAttributes() ?>>
					<span id="el_users_Passsword">
						<span<?php echo $users_view->Passsword->viewAttributes() ?>><?php echo $users_view->Passsword->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_userLevelId">
				...
				<td data-name="userLevelId" <?php echo $users_view->userLevelId->cellAttributes() ?>>
					<span id="el_users_userLevelId">
						<span<?php echo $users_view->userLevelId->viewAttributes() ?>><?php echo $users_view->userLevelId->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
