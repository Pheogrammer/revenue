							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->ClientId) == "") { ?>
										<th data-name="ClientId" class="<?php echo $update_requests_list->ClientId->headerCellClass() ?>" style="white-space: nowrap;">
											<div id="elh_update_requests_ClientId" class="update_requests_ClientId">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->ClientId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientId" class="<?php echo $update_requests_list->ClientId->headerCellClass() ?>" style="white-space: nowrap;">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->ClientId) ?>', 1);">
												<div id="elh_update_requests_ClientId" class="update_requests_ClientId">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->NewClientIdentity) == "") { ?>
										<th data-name="NewClientIdentity" class="<?php echo $update_requests_list->NewClientIdentity->headerCellClass() ?>">
											<div id="elh_update_requests_NewClientIdentity" class="update_requests_NewClientIdentity">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->NewClientIdentity->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NewClientIdentity" class="<?php echo $update_requests_list->NewClientIdentity->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->NewClientIdentity) ?>', 1);">
												<div id="elh_update_requests_NewClientIdentity" class="update_requests_NewClientIdentity">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->NewClientName) == "") { ?>
										<th data-name="NewClientName" class="<?php echo $update_requests_list->NewClientName->headerCellClass() ?>">
											<div id="elh_update_requests_NewClientName" class="update_requests_NewClientName">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->NewClientName->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NewClientName" class="<?php echo $update_requests_list->NewClientName->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->NewClientName) ?>', 1);">
												<div id="elh_update_requests_NewClientName" class="update_requests_NewClientName">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->NewAccountType) == "") { ?>
										<th data-name="NewAccountType" class="<?php echo $update_requests_list->NewAccountType->headerCellClass() ?>">
											<div id="elh_update_requests_NewAccountType" class="update_requests_NewAccountType">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->NewAccountType->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NewAccountType" class="<?php echo $update_requests_list->NewAccountType->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->NewAccountType) ?>', 1);">
												<div id="elh_update_requests_NewAccountType" class="update_requests_NewAccountType">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->NewMobileNumber) == "") { ?>
										<th data-name="NewMobileNumber" class="<?php echo $update_requests_list->NewMobileNumber->headerCellClass() ?>">
											<div id="elh_update_requests_NewMobileNumber" class="update_requests_NewMobileNumber">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->NewMobileNumber->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NewMobileNumber" class="<?php echo $update_requests_list->NewMobileNumber->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->NewMobileNumber) ?>', 1);">
												<div id="elh_update_requests_NewMobileNumber" class="update_requests_NewMobileNumber">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->NewEmail) == "") { ?>
										<th data-name="NewEmail" class="<?php echo $update_requests_list->NewEmail->headerCellClass() ?>">
											<div id="elh_update_requests_NewEmail" class="update_requests_NewEmail">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->NewEmail->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="NewEmail" class="<?php echo $update_requests_list->NewEmail->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->NewEmail) ?>', 1);">
												<div id="elh_update_requests_NewEmail" class="update_requests_NewEmail">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->date) == "") { ?>
										<th data-name="date" class="<?php echo $update_requests_list->date->headerCellClass() ?>">
											<div id="elh_update_requests_date" class="update_requests_date">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->date->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="date" class="<?php echo $update_requests_list->date->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->date) ?>', 1);">
												<div id="elh_update_requests_date" class="update_requests_date">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->status) == "") { ?>
										<th data-name="status" class="<?php echo $update_requests_list->status->headerCellClass() ?>">
											<div id="elh_update_requests_status" class="update_requests_status">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->status->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="status" class="<?php echo $update_requests_list->status->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->status) ?>', 1);">
												<div id="elh_update_requests_status" class="update_requests_status">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->Property) == "") { ?>
										<th data-name="Property" class="<?php echo $update_requests_list->Property->headerCellClass() ?>">
											<div id="elh_update_requests_Property" class="update_requests_Property">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->Property->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Property" class="<?php echo $update_requests_list->Property->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->Property) ?>', 1);">
												<div id="elh_update_requests_Property" class="update_requests_Property">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->PropertyId) == "") { ?>
										<th data-name="PropertyId" class="<?php echo $update_requests_list->PropertyId->headerCellClass() ?>">
											<div id="elh_update_requests_PropertyId" class="update_requests_PropertyId">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->PropertyId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyId" class="<?php echo $update_requests_list->PropertyId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->PropertyId) ?>', 1);">
												<div id="elh_update_requests_PropertyId" class="update_requests_PropertyId">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $update_requests_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_update_requests_PropertyUse" class="update_requests_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $update_requests_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->PropertyUse) ?>', 1);">
												<div id="elh_update_requests_PropertyUse" class="update_requests_PropertyUse">
								...
								?>
									<?php if ($update_requests_list->SortUrl($update_requests_list->Comment) == "") { ?>
										<th data-name="Comment" class="<?php echo $update_requests_list->Comment->headerCellClass() ?>">
											<div id="elh_update_requests_Comment" class="update_requests_Comment">
												<div class="ew-table-header-caption"><?php echo $update_requests_list->Comment->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Comment" class="<?php echo $update_requests_list->Comment->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $update_requests_list->SortUrl($update_requests_list->Comment) ?>', 1);">
												<div id="elh_update_requests_Comment" class="update_requests_Comment">
										...
										?>
											<td data-name="ClientId" <?php echo $update_requests_list->ClientId->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_ClientId">
													<span<?php echo $update_requests_list->ClientId->viewAttributes() ?>><?php echo $update_requests_list->ClientId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NewClientIdentity" <?php echo $update_requests_list->NewClientIdentity->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_NewClientIdentity">
													<span<?php echo $update_requests_list->NewClientIdentity->viewAttributes() ?>><?php echo $update_requests_list->NewClientIdentity->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NewClientName" <?php echo $update_requests_list->NewClientName->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_NewClientName">
													<span<?php echo $update_requests_list->NewClientName->viewAttributes() ?>><?php echo $update_requests_list->NewClientName->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NewAccountType" <?php echo $update_requests_list->NewAccountType->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_NewAccountType">
													<span<?php echo $update_requests_list->NewAccountType->viewAttributes() ?>><?php echo $update_requests_list->NewAccountType->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NewMobileNumber" <?php echo $update_requests_list->NewMobileNumber->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_NewMobileNumber">
													<span<?php echo $update_requests_list->NewMobileNumber->viewAttributes() ?>><?php echo $update_requests_list->NewMobileNumber->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="NewEmail" <?php echo $update_requests_list->NewEmail->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_NewEmail">
													<span<?php echo $update_requests_list->NewEmail->viewAttributes() ?>><?php echo $update_requests_list->NewEmail->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="date" <?php echo $update_requests_list->date->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_date">
													<span<?php echo $update_requests_list->date->viewAttributes() ?>><?php echo $update_requests_list->date->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="status" <?php echo $update_requests_list->status->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_status">
													<span<?php echo $update_requests_list->status->viewAttributes() ?>><?php echo $update_requests_list->status->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Property" <?php echo $update_requests_list->Property->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_Property">
													<span<?php echo $update_requests_list->Property->viewAttributes() ?>><?php echo $update_requests_list->Property->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyId" <?php echo $update_requests_list->PropertyId->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_PropertyId">
													<span<?php echo $update_requests_list->PropertyId->viewAttributes() ?>><?php echo $update_requests_list->PropertyId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyUse" <?php echo $update_requests_list->PropertyUse->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_PropertyUse">
													<span<?php echo $update_requests_list->PropertyUse->viewAttributes() ?>><?php echo $update_requests_list->PropertyUse->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Comment" <?php echo $update_requests_list->Comment->cellAttributes() ?>>
												<span id="el<?php echo $update_requests_list->RowCount ?>_update_requests_Comment">
													<span<?php echo $update_requests_list->Comment->viewAttributes() ?>><?php echo $update_requests_list->Comment->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
