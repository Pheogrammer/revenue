	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_BillingYear" class="form-group row">
				...
				<div class="<?php echo $billing_period_add->RightColumnClass ?>">
					<div <?php echo $billing_period_add->BillingYear->cellAttributes() ?>>
						...
						<?php } else { ?>
							<span id="el_billing_period_BillingYear">
								<span<?php echo $billing_period_add->BillingYear->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_add->BillingYear->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_add->BillingYear->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_BillingCycle" class="form-group row">
				...
				<div class="<?php echo $billing_period_add->RightColumnClass ?>">
					<div <?php echo $billing_period_add->BillingCycle->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_billing_period_BillingCycle">
								<span<?php echo $billing_period_add->BillingCycle->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_add->BillingCycle->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_add->BillingCycle->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_From" class="form-group row">
				...
				<div class="<?php echo $billing_period_add->RightColumnClass ?>">
					<div <?php echo $billing_period_add->From->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
								...
								<?php if (!$billing_period_add->From->ReadOnly && !$billing_period_add->From->Disabled && !isset($billing_period_add->From->EditAttrs["readonly"]) && !isset($billing_period_add->From->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fbilling_periodadd", "datetimepicker"], function() {
											ew.createDateTimePicker("fbilling_periodadd", "x_From", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_billing_period_From">
								<span<?php echo $billing_period_add->From->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_add->From->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_add->From->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_To" class="form-group row">
				...
				<div class="<?php echo $billing_period_add->RightColumnClass ?>">
					<div <?php echo $billing_period_add->To->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
							<span id="el_billing_period_To">
								...
								<?php if (!$billing_period_add->To->ReadOnly && !$billing_period_add->To->Disabled && !isset($billing_period_add->To->EditAttrs["readonly"]) && !isset($billing_period_add->To->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fbilling_periodadd", "datetimepicker"], function() {
											ew.createDateTimePicker("fbilling_periodadd", "x_To", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_billing_period_To">
								<span<?php echo $billing_period_add->To->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_add->To->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_add->To->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Status" class="form-group row">
				...
				<div class="<?php echo $billing_period_add->RightColumnClass ?>">
					<div <?php echo $billing_period_add->Status->cellAttributes() ?>>
						<?php if (!$billing_period->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_billing_period_Status">
								<span<?php echo $billing_period_add->Status->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($billing_period_add->Status->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $billing_period_add->Status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
