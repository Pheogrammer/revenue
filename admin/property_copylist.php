							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->id) == "") { ?>
										<th data-name="id" class="<?php echo $property_copy_list->id->headerCellClass() ?>">
											<div id="elh_property_copy_id" class="property_copy_id">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $property_copy_list->id->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->id) ?>', 1);">
												<div id="elh_property_copy_id" class="property_copy_id">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->ClientId) == "") { ?>
										<th data-name="ClientId" class="<?php echo $property_copy_list->ClientId->headerCellClass() ?>">
											<div id="elh_property_copy_ClientId" class="property_copy_ClientId">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->ClientId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ClientId" class="<?php echo $property_copy_list->ClientId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->ClientId) ?>', 1);">
												<div id="elh_property_copy_ClientId" class="property_copy_ClientId">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->ChargeGroup) == "") { ?>
										<th data-name="ChargeGroup" class="<?php echo $property_copy_list->ChargeGroup->headerCellClass() ?>">
											<div id="elh_property_copy_ChargeGroup" class="property_copy_ChargeGroup">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->ChargeGroup->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGroup" class="<?php echo $property_copy_list->ChargeGroup->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->ChargeGroup) ?>', 1);">
												<div id="elh_property_copy_ChargeGroup" class="property_copy_ChargeGroup">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->ChargeGropuDes) == "") { ?>
										<th data-name="ChargeGropuDes" class="<?php echo $property_copy_list->ChargeGropuDes->headerCellClass() ?>">
											<div id="elh_property_copy_ChargeGropuDes" class="property_copy_ChargeGropuDes">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->ChargeGropuDes->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeGropuDes" class="<?php echo $property_copy_list->ChargeGropuDes->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->ChargeGropuDes) ?>', 1);">
												<div id="elh_property_copy_ChargeGropuDes" class="property_copy_ChargeGropuDes">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->Property) == "") { ?>
										<th data-name="Property" class="<?php echo $property_copy_list->Property->headerCellClass() ?>">
											<div id="elh_property_copy_Property" class="property_copy_Property">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->Property->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Property" class="<?php echo $property_copy_list->Property->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->Property) ?>', 1);">
												<div id="elh_property_copy_Property" class="property_copy_Property">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $property_copy_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_property_copy_PropertyUse" class="property_copy_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $property_copy_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->PropertyUse) ?>', 1);">
												<div id="elh_property_copy_PropertyUse" class="property_copy_PropertyUse">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->ChargeableFee) == "") { ?>
										<th data-name="ChargeableFee" class="<?php echo $property_copy_list->ChargeableFee->headerCellClass() ?>">
											<div id="elh_property_copy_ChargeableFee" class="property_copy_ChargeableFee">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->ChargeableFee->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="ChargeableFee" class="<?php echo $property_copy_list->ChargeableFee->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->ChargeableFee) ?>', 1);">
												<div id="elh_property_copy_ChargeableFee" class="property_copy_ChargeableFee">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->BalanceBF) == "") { ?>
										<th data-name="BalanceBF" class="<?php echo $property_copy_list->BalanceBF->headerCellClass() ?>">
											<div id="elh_property_copy_BalanceBF" class="property_copy_BalanceBF">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->BalanceBF->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="BalanceBF" class="<?php echo $property_copy_list->BalanceBF->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->BalanceBF) ?>', 1);">
												<div id="elh_property_copy_BalanceBF" class="property_copy_BalanceBF">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->AmountPayable) == "") { ?>
										<th data-name="AmountPayable" class="<?php echo $property_copy_list->AmountPayable->headerCellClass() ?>">
											<div id="elh_property_copy_AmountPayable" class="property_copy_AmountPayable">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->AmountPayable->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPayable" class="<?php echo $property_copy_list->AmountPayable->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->AmountPayable) ?>', 1);">
												<div id="elh_property_copy_AmountPayable" class="property_copy_AmountPayable">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->AmountPaid) == "") { ?>
										<th data-name="AmountPaid" class="<?php echo $property_copy_list->AmountPaid->headerCellClass() ?>">
											<div id="elh_property_copy_AmountPaid" class="property_copy_AmountPaid">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->AmountPaid->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="AmountPaid" class="<?php echo $property_copy_list->AmountPaid->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->AmountPaid) ?>', 1);">
												<div id="elh_property_copy_AmountPaid" class="property_copy_AmountPaid">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->CurrentBalance) == "") { ?>
										<th data-name="CurrentBalance" class="<?php echo $property_copy_list->CurrentBalance->headerCellClass() ?>">
											<div id="elh_property_copy_CurrentBalance" class="property_copy_CurrentBalance">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->CurrentBalance->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="CurrentBalance" class="<?php echo $property_copy_list->CurrentBalance->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->CurrentBalance) ?>', 1);">
												<div id="elh_property_copy_CurrentBalance" class="property_copy_CurrentBalance">
								...
								?>
									<?php if ($property_copy_list->SortUrl($property_copy_list->DataRegistered) == "") { ?>
										<th data-name="DataRegistered" class="<?php echo $property_copy_list->DataRegistered->headerCellClass() ?>">
											<div id="elh_property_copy_DataRegistered" class="property_copy_DataRegistered">
												<div class="ew-table-header-caption"><?php echo $property_copy_list->DataRegistered->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="DataRegistered" class="<?php echo $property_copy_list->DataRegistered->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_copy_list->SortUrl($property_copy_list->DataRegistered) ?>', 1);">
												<div id="elh_property_copy_DataRegistered" class="property_copy_DataRegistered">
										...
										?>
											<td data-name="id" <?php echo $property_copy_list->id->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_id">
													<span<?php echo $property_copy_list->id->viewAttributes() ?>><?php echo $property_copy_list->id->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ClientId" <?php echo $property_copy_list->ClientId->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_ClientId">
													<span<?php echo $property_copy_list->ClientId->viewAttributes() ?>><?php echo $property_copy_list->ClientId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeGroup" <?php echo $property_copy_list->ChargeGroup->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_ChargeGroup">
													<span<?php echo $property_copy_list->ChargeGroup->viewAttributes() ?>><?php echo $property_copy_list->ChargeGroup->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeGropuDes" <?php echo $property_copy_list->ChargeGropuDes->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_ChargeGropuDes">
													<span<?php echo $property_copy_list->ChargeGropuDes->viewAttributes() ?>><?php echo $property_copy_list->ChargeGropuDes->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Property" <?php echo $property_copy_list->Property->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_Property">
													<span<?php echo $property_copy_list->Property->viewAttributes() ?>><?php echo $property_copy_list->Property->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="PropertyUse" <?php echo $property_copy_list->PropertyUse->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_PropertyUse">
													<span<?php echo $property_copy_list->PropertyUse->viewAttributes() ?>><?php echo $property_copy_list->PropertyUse->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="ChargeableFee" <?php echo $property_copy_list->ChargeableFee->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_ChargeableFee">
													<span<?php echo $property_copy_list->ChargeableFee->viewAttributes() ?>><?php echo $property_copy_list->ChargeableFee->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="BalanceBF" <?php echo $property_copy_list->BalanceBF->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_BalanceBF">
													<span<?php echo $property_copy_list->BalanceBF->viewAttributes() ?>><?php echo $property_copy_list->BalanceBF->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPayable" <?php echo $property_copy_list->AmountPayable->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_AmountPayable">
													<span<?php echo $property_copy_list->AmountPayable->viewAttributes() ?>><?php echo $property_copy_list->AmountPayable->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="AmountPaid" <?php echo $property_copy_list->AmountPaid->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_AmountPaid">
													<span<?php echo $property_copy_list->AmountPaid->viewAttributes() ?>><?php echo $property_copy_list->AmountPaid->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="CurrentBalance" <?php echo $property_copy_list->CurrentBalance->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_CurrentBalance">
													<span<?php echo $property_copy_list->CurrentBalance->viewAttributes() ?>><?php echo $property_copy_list->CurrentBalance->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="DataRegistered" <?php echo $property_copy_list->DataRegistered->cellAttributes() ?>>
												<span id="el<?php echo $property_copy_list->RowCount ?>_property_copy_DataRegistered">
													<span<?php echo $property_copy_list->DataRegistered->viewAttributes() ?>><?php echo $property_copy_list->DataRegistered->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
