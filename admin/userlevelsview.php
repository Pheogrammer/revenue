			...
			<tr id="r_userlevelid">
				...
				<td data-name="userlevelid" <?php echo $userlevels_view->userlevelid->cellAttributes() ?>>
					<span id="el_userlevels_userlevelid">
						<span<?php echo $userlevels_view->userlevelid->viewAttributes() ?>><?php echo $userlevels_view->userlevelid->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_userlevelname">
				...
				<td data-name="userlevelname" <?php echo $userlevels_view->userlevelname->cellAttributes() ?>>
					<span id="el_userlevels_userlevelname">
						<span<?php echo $userlevels_view->userlevelname->viewAttributes() ?>><?php echo $userlevels_view->userlevelname->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
