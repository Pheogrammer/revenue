...
<?php if (!$audittrail_view->IsModal) { ?>
	<?php if (!$audittrail_view->isExport()) { ?>
		<form name="ew-pager-form" class="form-inline ew-form ew-pager-form" action="<?php echo CurrentPageName() ?>">
			<?php echo $audittrail_view->Pager->render() ?>
			<div class="clearfix"></div>
		</form>
	<?php } ?>
<?php } ?>
			...
			<tr id="r_id">
				...
				<td data-name="id" <?php echo $audittrail_view->id->cellAttributes() ?>>
					<span id="el_audittrail_id">
						<span<?php echo $audittrail_view->id->viewAttributes() ?>><?php echo $audittrail_view->id->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_datetime">
				...
				<td data-name="datetime" <?php echo $audittrail_view->datetime->cellAttributes() ?>>
					<span id="el_audittrail_datetime">
						<span<?php echo $audittrail_view->datetime->viewAttributes() ?>><?php echo $audittrail_view->datetime->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_script">
				...
				<td data-name="script" <?php echo $audittrail_view->script->cellAttributes() ?>>
					<span id="el_audittrail_script">
						<span<?php echo $audittrail_view->script->viewAttributes() ?>><?php echo $audittrail_view->script->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_user">
				...
				<td data-name="user" <?php echo $audittrail_view->user->cellAttributes() ?>>
					<span id="el_audittrail_user">
						<span<?php echo $audittrail_view->user->viewAttributes() ?>><?php echo $audittrail_view->user->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r__action">
				...
				<td data-name="_action" <?php echo $audittrail_view->_action->cellAttributes() ?>>
					<span id="el_audittrail__action">
						<span<?php echo $audittrail_view->_action->viewAttributes() ?>><?php echo $audittrail_view->_action->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r__table">
				...
				<td data-name="_table" <?php echo $audittrail_view->_table->cellAttributes() ?>>
					<span id="el_audittrail__table">
						<span<?php echo $audittrail_view->_table->viewAttributes() ?>><?php echo $audittrail_view->_table->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_field">
				...
				<td data-name="field" <?php echo $audittrail_view->field->cellAttributes() ?>>
					<span id="el_audittrail_field">
						<span<?php echo $audittrail_view->field->viewAttributes() ?>><?php echo $audittrail_view->field->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_keyvalue">
				...
				<td data-name="keyvalue" <?php echo $audittrail_view->keyvalue->cellAttributes() ?>>
					<span id="el_audittrail_keyvalue">
						<span<?php echo $audittrail_view->keyvalue->viewAttributes() ?>><?php echo $audittrail_view->keyvalue->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_oldvalue">
				...
				<td data-name="oldvalue" <?php echo $audittrail_view->oldvalue->cellAttributes() ?>>
					<span id="el_audittrail_oldvalue">
						<span<?php echo $audittrail_view->oldvalue->viewAttributes() ?>><?php echo $audittrail_view->oldvalue->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
			...
			<tr id="r_newvalue">
				...
				<td data-name="newvalue" <?php echo $audittrail_view->newvalue->cellAttributes() ?>>
					<span id="el_audittrail_newvalue">
						<span<?php echo $audittrail_view->newvalue->viewAttributes() ?>><?php echo $audittrail_view->newvalue->getViewValue() ?>
					</span>
					</span>
				</td>
			</tr>
