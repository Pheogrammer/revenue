	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_id" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->id->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
							<span id="el_client_id">
								<span<?php echo $client_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->id->EditValue)) ?>">
							</span>
							</span>
						...
						<?php } else { ?>
							<span id="el_client_id">
								<span<?php echo $client_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->id->ViewValue)) ?>">
							</span>
							</span>
							<input type="hidden" data-table="client" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($client_edit->id->FormValue) ?>">
						<?php } ?>
						<?php echo $client_edit->id->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientName" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->ClientName->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_ClientName">
								<span<?php echo $client_edit->ClientName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->ClientName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->ClientName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientType" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->ClientType->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_ClientType">
								<span<?php echo $client_edit->ClientType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->ClientType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->ClientType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_IdentityType" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->IdentityType->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_IdentityType">
								<span<?php echo $client_edit->IdentityType->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->IdentityType->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->IdentityType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientID" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->ClientID->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_ClientID">
								<span<?php echo $client_edit->ClientID->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->ClientID->ViewValue)) ?>">
							</span>
							</span>
							...
							<input type="hidden" data-table="client" data-field="x_ClientID" name="o_ClientID" id="o_ClientID" value="<?php echo HtmlEncode($client_edit->ClientID->OldValue != null ? $client_edit->ClientID->OldValue : $client_edit->ClientID->CurrentValue) ?>">
						<?php } ?>
						<?php echo $client_edit->ClientID->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Surname" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->Surname->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_Surname">
								<span<?php echo $client_edit->Surname->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->Surname->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->Surname->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_FirstName" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->FirstName->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_FirstName">
								<span<?php echo $client_edit->FirstName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->FirstName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->FirstName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_MiddleName" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->MiddleName->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_MiddleName">
								<span<?php echo $client_edit->MiddleName->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->MiddleName->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->MiddleName->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Gender" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->Gender->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_Gender">
								<span<?php echo $client_edit->Gender->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->Gender->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->Gender->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_MaritalStatus" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->MaritalStatus->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_MaritalStatus">
								<span<?php echo $client_edit->MaritalStatus->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->MaritalStatus->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->MaritalStatus->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_DateOfBirth" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->DateOfBirth->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
								...
								<?php if (!$client_edit->DateOfBirth->ReadOnly && !$client_edit->DateOfBirth->Disabled && !isset($client_edit->DateOfBirth->EditAttrs["readonly"]) && !isset($client_edit->DateOfBirth->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fclientedit", "datetimepicker"], function() {
											ew.createDateTimePicker("fclientedit", "x_DateOfBirth", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_client_DateOfBirth">
								<span<?php echo $client_edit->DateOfBirth->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->DateOfBirth->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->DateOfBirth->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PostalAddress" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->PostalAddress->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_PostalAddress">
								<span<?php echo $client_edit->PostalAddress->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->PostalAddress->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->PostalAddress->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PhysicalAddress" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->PhysicalAddress->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_PhysicalAddress">
								<span<?php echo $client_edit->PhysicalAddress->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->PhysicalAddress->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->PhysicalAddress->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_TownOrVillage" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->TownOrVillage->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_TownOrVillage">
								<span<?php echo $client_edit->TownOrVillage->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->TownOrVillage->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->TownOrVillage->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Mobile" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->Mobile->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_Mobile">
								<span<?php echo $client_edit->Mobile->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->Mobile->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->Mobile->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__Email" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->_Email->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client__Email">
								<span<?php echo $client_edit->_Email->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->_Email->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->_Email->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NextOfKin" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->NextOfKin->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_NextOfKin">
								<span<?php echo $client_edit->NextOfKin->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->NextOfKin->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->NextOfKin->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NextOfKinMobile" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->NextOfKinMobile->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_NextOfKinMobile">
								<span<?php echo $client_edit->NextOfKinMobile->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->NextOfKinMobile->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->NextOfKinMobile->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_NextOfKinEmail" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->NextOfKinEmail->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_NextOfKinEmail">
								<span<?php echo $client_edit->NextOfKinEmail->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($client_edit->NextOfKinEmail->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->NextOfKinEmail->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AdditionalInformation" class="form-group row">
				...
				<div class="<?php echo $client_edit->RightColumnClass ?>">
					<div <?php echo $client_edit->AdditionalInformation->cellAttributes() ?>>
						<?php if (!$client->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_client_AdditionalInformation">
								<span<?php echo $client_edit->AdditionalInformation->viewAttributes() ?>><?php echo $client_edit->AdditionalInformation->ViewValue ?>
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $client_edit->AdditionalInformation->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
