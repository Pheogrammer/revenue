	...
	<div class="ew-add-div"><!-- page* -->
		...
		?>
			<div id="r_Fullname" class="form-group row">
				...
				<div class="<?php echo $users_add->RightColumnClass ?>">
					<div <?php echo $users_add->Fullname->cellAttributes() ?>>
						...
						<?php echo $users_add->Fullname->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Username" class="form-group row">
				...
				<div class="<?php echo $users_add->RightColumnClass ?>">
					<div <?php echo $users_add->Username->cellAttributes() ?>>
						...
						<?php echo $users_add->Username->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r__Email" class="form-group row">
				...
				<div class="<?php echo $users_add->RightColumnClass ?>">
					<div <?php echo $users_add->_Email->cellAttributes() ?>>
						...
						<?php echo $users_add->_Email->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Passsword" class="form-group row">
				...
				<div class="<?php echo $users_add->RightColumnClass ?>">
					<div <?php echo $users_add->Passsword->cellAttributes() ?>>
						...
						<?php echo $users_add->Passsword->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_userLevelId" class="form-group row">
				...
				<div class="<?php echo $users_add->RightColumnClass ?>">
					<div <?php echo $users_add->userLevelId->cellAttributes() ?>>
						...
						<?php } ?>
						<?php echo $users_add->userLevelId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
