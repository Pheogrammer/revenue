...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "revenue"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'uBUqerufjbjUF9kR', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/revenue.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{F82056AB-CEC6-48BF-AA9B-76524AD406BC}", // Project ID (GUID)
	...
	"NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-success navbar-dark",
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "pass" => "", "db" => "revenue"]
	],
	...
	"LOGIN_PASSWORD_FIELD_NAME" => "Passsword",
	"USER_ID_FIELD_NAME" => "id",
	"PARENT_USER_ID_FIELD_NAME" => "",
	"USER_LEVEL_FIELD_NAME" => "userLevelId",
	...
	"USER_PROFILE_PASSWORD_EXPIRE" => 30,
