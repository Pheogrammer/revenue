				...
				<thead><!-- Table header -->
					<tr class="ew-table-header">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->id->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->id->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->id->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->ClientId->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->ClientId->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->ClientId->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->ChargeGroup->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->ChargeGroup->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->ChargeGroup->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->ChargeGropuDes->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->ChargeGropuDes->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->ChargeGropuDes->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->ChargeableFee->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->ChargeableFee->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->ChargeableFee->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->BalanceBF->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->BalanceBF->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->BalanceBF->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->AmountPayable->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->AmountPayable->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->AmountPayable->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->Property->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->Property->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->Property->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->PropertyId->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->PropertyId->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->PropertyId->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->PropertyUse->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->PropertyUse->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->PropertyUse->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->Location->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->Location->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->Location->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->AmountPaid->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->AmountPaid->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->AmountPaid->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->CurrentBalance->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->CurrentBalance->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->CurrentBalance->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->DataRegistered->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->DataRegistered->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->DataRegistered->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
						...
						?>
							...
							<?php } else { ?>
								<th class="<?php echo $property_preview->Status->headerCellClass() ?>">
									<div class="ew-pointer" data-sort="<?php echo HtmlEncode($property_preview->Status->Name) ?>" data-sort-order="<?php echo $property_preview->SortField == $property_preview->Status->Name && $property_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
