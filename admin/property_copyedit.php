	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_id" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->id->cellAttributes() ?>>
						<span id="el_property_copy_id">
							<span<?php echo $property_copy_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_copy_edit->id->EditValue)) ?>">
						</span>
						</span>
						...
						<?php echo $property_copy_edit->id->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->ClientId->cellAttributes() ?>>
						<span id="el_property_copy_ClientId">
							...
							<script>
								loadjs.ready(["fproperty_copyedit"], function() {
									fproperty_copyedit.createAutoSuggest({
										"id": "x_ClientId",
										"forceSelect": true
									});
								});
						...
						<?php echo $property_copy_edit->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGroup" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->ChargeGroup->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->ChargeGroup->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGropuDes" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->ChargeGropuDes->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->ChargeGropuDes->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Property" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->Property->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->Property->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->PropertyUse->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeableFee" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->ChargeableFee->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->ChargeableFee->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_BalanceBF" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->BalanceBF->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->BalanceBF->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPayable" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->AmountPayable->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->AmountPayable->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPaid" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->AmountPaid->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->AmountPaid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_CurrentBalance" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->CurrentBalance->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->CurrentBalance->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_DataRegistered" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->DataRegistered->cellAttributes() ?>>
							...
							<?php if (!$property_copy_edit->DataRegistered->ReadOnly && !$property_copy_edit->DataRegistered->Disabled && !isset($property_copy_edit->DataRegistered->EditAttrs["readonly"]) && !isset($property_copy_edit->DataRegistered->EditAttrs["disabled"])) { ?>
								<script>
									loadjs.ready(["fproperty_copyedit", "datetimepicker"], function() {
										ew.createDateTimePicker("fproperty_copyedit", "x_DataRegistered", {
											"ignoreReadonly": true,
											"useCurrent": false,
											"format": 0
										});
						...
						<?php echo $property_copy_edit->DataRegistered->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Description" class="form-group row">
				...
				<div class="<?php echo $property_copy_edit->RightColumnClass ?>">
					<div <?php echo $property_copy_edit->Description->cellAttributes() ?>>
						...
						<?php echo $property_copy_edit->Description->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
