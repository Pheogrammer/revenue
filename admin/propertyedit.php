...
<script>
	loadjs.ready("head", function() {
		...
		// Client script
		$("#x_BalanceBF").prop("readonly", "true"), $("#x_ChargeableFee").prop("readonly", "true"), $("#x_AmountPayable").prop("readonly", "true"), $("#x_CurrentBalance").prop("readonly", "true"), $("#x_AmountPaid").prop("readonly", "true"), $("#x_ChargeableFee").on("focus input change", function() {
			var e = parseFloat(document.getElementById("x_ChargeableFee").value),
				a = parseFloat(document.getElementById("x_BalanceBF").value),
				n = document.getElementById("x_AmountPayable"),
				t = document.getElementById("x_CurrentBalance");
			n.value = +e + a, t.value = +e + a
		});
	});
</script>
	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_id" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->id->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
							<span id="el_property_id">
								<span<?php echo $property_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->id->EditValue)) ?>">
							</span>
							</span>
						...
						<?php } else { ?>
							<span id="el_property_id">
								<span<?php echo $property_edit->id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->id->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->id->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ClientId" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->ClientId->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
							<?php if ($property_edit->ClientId->getSessionValue() != "") { ?>
								<span id="el_property_ClientId">
									<span<?php echo $property_edit->ClientId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->ClientId->ViewValue)) ?>">
								</span>
								</span>
						...
						<?php } ?>
						<?php echo $property_edit->ClientId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGroup" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->ChargeGroup->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
							<span id="el_property_ChargeGroup">
								...
								<script>
									loadjs.ready(["fpropertyedit"], function() {
										fpropertyedit.createAutoSuggest({
											"id": "x_ChargeGroup",
											"forceSelect": true
										});
									});
						...
						<?php } else { ?>
							<span id="el_property_ChargeGroup">
								<span<?php echo $property_edit->ChargeGroup->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->ChargeGroup->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->ChargeGroup->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeGropuDes" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->ChargeGropuDes->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_ChargeGropuDes">
								<span<?php echo $property_edit->ChargeGropuDes->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->ChargeGropuDes->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->ChargeGropuDes->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_ChargeableFee" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->ChargeableFee->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_ChargeableFee">
								<span<?php echo $property_edit->ChargeableFee->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->ChargeableFee->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->ChargeableFee->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_BalanceBF" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->BalanceBF->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_BalanceBF">
								<span<?php echo $property_edit->BalanceBF->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->BalanceBF->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->BalanceBF->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPayable" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->AmountPayable->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_AmountPayable">
								<span<?php echo $property_edit->AmountPayable->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->AmountPayable->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->AmountPayable->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Property" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->Property->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Property">
								<span<?php echo $property_edit->Property->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->Property->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->Property->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyId" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->PropertyId->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_PropertyId">
								<span<?php echo $property_edit->PropertyId->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->PropertyId->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->PropertyId->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->PropertyUse->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_PropertyUse">
								<span<?php echo $property_edit->PropertyUse->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->PropertyUse->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Location" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->Location->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Location">
								<span<?php echo $property_edit->Location->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->Location->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->Location->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_AmountPaid" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->AmountPaid->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_AmountPaid">
								<span<?php echo $property_edit->AmountPaid->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->AmountPaid->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->AmountPaid->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_CurrentBalance" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->CurrentBalance->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_CurrentBalance">
								<span<?php echo $property_edit->CurrentBalance->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->CurrentBalance->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->CurrentBalance->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Description" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->Description->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_Description">
								<span<?php echo $property_edit->Description->viewAttributes() ?>><?php echo $property_edit->Description->ViewValue ?>
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->Description->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_DataRegistered" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->DataRegistered->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
								...
								<?php if (!$property_edit->DataRegistered->ReadOnly && !$property_edit->DataRegistered->Disabled && !isset($property_edit->DataRegistered->EditAttrs["readonly"]) && !isset($property_edit->DataRegistered->EditAttrs["disabled"])) { ?>
									<script>
										loadjs.ready(["fpropertyedit", "datetimepicker"], function() {
											ew.createDateTimePicker("fpropertyedit", "x_DataRegistered", {
												"ignoreReadonly": true,
												"useCurrent": false,
												"format": 0
											});
						...
						<?php } else { ?>
							<span id="el_property_DataRegistered">
								<span<?php echo $property_edit->DataRegistered->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->DataRegistered->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->DataRegistered->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PhysicalAddress" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->PhysicalAddress->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
						...
						<?php } else { ?>
							<span id="el_property_PhysicalAddress">
								<span<?php echo $property_edit->PhysicalAddress->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->PhysicalAddress->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->PhysicalAddress->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_Status" class="form-group row">
				...
				<div class="<?php echo $property_edit->RightColumnClass ?>">
					<div <?php echo $property_edit->Status->cellAttributes() ?>>
						<?php if (!$property->isConfirm()) { ?>
							<span id="el_property_Status">
								...
								<div id="dsl_x_Status" data-repeatcolumn="5" class="ew-item-list d-none">
									<div>
						...
						<?php } else { ?>
							<span id="el_property_Status">
								<span<?php echo $property_edit->Status->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($property_edit->Status->ViewValue)) ?>">
							</span>
							</span>
						...
						<?php } ?>
						<?php echo $property_edit->Status->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
