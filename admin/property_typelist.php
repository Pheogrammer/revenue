							...
							<tr class="ew-table-header">
								...
								?>
									<?php if ($property_type_list->SortUrl($property_type_list->PropertyTypeCode) == "") { ?>
										<th data-name="PropertyTypeCode" class="<?php echo $property_type_list->PropertyTypeCode->headerCellClass() ?>">
											<div id="elh_property_type_PropertyTypeCode" class="property_type_PropertyTypeCode">
												<div class="ew-table-header-caption"><?php echo $property_type_list->PropertyTypeCode->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyTypeCode" class="<?php echo $property_type_list->PropertyTypeCode->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_type_list->SortUrl($property_type_list->PropertyTypeCode) ?>', 1);">
												<div id="elh_property_type_PropertyTypeCode" class="property_type_PropertyTypeCode">
								...
								?>
									<?php if ($property_type_list->SortUrl($property_type_list->PropertyType) == "") { ?>
										<th data-name="PropertyType" class="<?php echo $property_type_list->PropertyType->headerCellClass() ?>">
											<div id="elh_property_type_PropertyType" class="property_type_PropertyType">
												<div class="ew-table-header-caption"><?php echo $property_type_list->PropertyType->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyType" class="<?php echo $property_type_list->PropertyType->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_type_list->SortUrl($property_type_list->PropertyType) ?>', 1);">
												<div id="elh_property_type_PropertyType" class="property_type_PropertyType">
								...
								?>
									<?php if ($property_type_list->SortUrl($property_type_list->PropertyUse) == "") { ?>
										<th data-name="PropertyUse" class="<?php echo $property_type_list->PropertyUse->headerCellClass() ?>">
											<div id="elh_property_type_PropertyUse" class="property_type_PropertyUse">
												<div class="ew-table-header-caption"><?php echo $property_type_list->PropertyUse->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="PropertyUse" class="<?php echo $property_type_list->PropertyUse->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $property_type_list->SortUrl($property_type_list->PropertyUse) ?>', 1);">
												<div id="elh_property_type_PropertyUse" class="property_type_PropertyUse">
												...
												<td data-name="PropertyTypeCode" <?php echo $property_type_list->PropertyTypeCode->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $property_type_list->RowCount ?>_property_type_PropertyTypeCode">
															<span<?php echo $property_type_list->PropertyTypeCode->viewAttributes() ?>><?php echo $property_type_list->PropertyTypeCode->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
												...
												<td data-name="PropertyType" <?php echo $property_type_list->PropertyType->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $property_type_list->RowCount ?>_property_type_PropertyType">
															<span<?php echo $property_type_list->PropertyType->viewAttributes() ?>><?php echo $property_type_list->PropertyType->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
												...
												<td data-name="PropertyUse" <?php echo $property_type_list->PropertyUse->cellAttributes() ?>>
													...
													?>
														<span id="el<?php echo $property_type_list->RowCount ?>_property_type_PropertyUse">
															<span<?php echo $property_type_list->PropertyUse->viewAttributes() ?>><?php echo $property_type_list->PropertyUse->getViewValue() ?>
														</span>
														</span>
													<?php } ?>
												</td>
