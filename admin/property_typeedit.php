	...
	<div class="ew-edit-div"><!-- page* -->
		...
		?>
			<div id="r_PropertyType" class="form-group row">
				...
				<div class="<?php echo $property_type_edit->RightColumnClass ?>">
					<div <?php echo $property_type_edit->PropertyType->cellAttributes() ?>>
						...
						<?php echo $property_type_edit->PropertyType->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
		...
		?>
			<div id="r_PropertyUse" class="form-group row">
				...
				<div class="<?php echo $property_type_edit->RightColumnClass ?>">
					<div <?php echo $property_type_edit->PropertyUse->cellAttributes() ?>>
						...
						<?php echo $property_type_edit->PropertyUse->CustomMsg ?>
					</div>
				</div>
			</div>
		<?php } ?>
