		...
		<form name="fuserslist" id="fuserslist" class="form-inline ew-form ew-list-form" action="<?php echo CurrentPageName() ?>" method="post">
			...
			<div id="gmp_users" class="<?php echo ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
				<?php if ($users_list->TotalRecords > 0 || $users_list->isGridEdit()) { ?>
					<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="myDataTable" id="tbl_userslist" class="table ew-table"><!-- .ew-table -->
						<thead>
							<tr class="ew-table-header">
								...
								?>
									<?php if ($users_list->SortUrl($users_list->id) == "") { ?>
										<th data-name="id" class="<?php echo $users_list->id->headerCellClass() ?>">
											<div id="elh_users_id" class="users_id">
												<div class="ew-table-header-caption"><?php echo $users_list->id->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="id" class="<?php echo $users_list->id->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $users_list->SortUrl($users_list->id) ?>', 1);">
												<div id="elh_users_id" class="users_id">
								...
								?>
									<?php if ($users_list->SortUrl($users_list->Fullname) == "") { ?>
										<th data-name="Fullname" class="<?php echo $users_list->Fullname->headerCellClass() ?>">
											<div id="elh_users_Fullname" class="users_Fullname">
												<div class="ew-table-header-caption"><?php echo $users_list->Fullname->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Fullname" class="<?php echo $users_list->Fullname->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $users_list->SortUrl($users_list->Fullname) ?>', 1);">
												<div id="elh_users_Fullname" class="users_Fullname">
								...
								?>
									<?php if ($users_list->SortUrl($users_list->Username) == "") { ?>
										<th data-name="Username" class="<?php echo $users_list->Username->headerCellClass() ?>">
											<div id="elh_users_Username" class="users_Username">
												<div class="ew-table-header-caption"><?php echo $users_list->Username->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Username" class="<?php echo $users_list->Username->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $users_list->SortUrl($users_list->Username) ?>', 1);">
												<div id="elh_users_Username" class="users_Username">
								...
								?>
									<?php if ($users_list->SortUrl($users_list->_Email) == "") { ?>
										<th data-name="_Email" class="<?php echo $users_list->_Email->headerCellClass() ?>">
											<div id="elh_users__Email" class="users__Email">
												<div class="ew-table-header-caption"><?php echo $users_list->_Email->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="_Email" class="<?php echo $users_list->_Email->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $users_list->SortUrl($users_list->_Email) ?>', 1);">
												<div id="elh_users__Email" class="users__Email">
								...
								?>
									<?php if ($users_list->SortUrl($users_list->Passsword) == "") { ?>
										<th data-name="Passsword" class="<?php echo $users_list->Passsword->headerCellClass() ?>">
											<div id="elh_users_Passsword" class="users_Passsword">
												<div class="ew-table-header-caption"><?php echo $users_list->Passsword->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="Passsword" class="<?php echo $users_list->Passsword->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $users_list->SortUrl($users_list->Passsword) ?>', 1);">
												<div id="elh_users_Passsword" class="users_Passsword">
								...
								?>
									<?php if ($users_list->SortUrl($users_list->userLevelId) == "") { ?>
										<th data-name="userLevelId" class="<?php echo $users_list->userLevelId->headerCellClass() ?>">
											<div id="elh_users_userLevelId" class="users_userLevelId">
												<div class="ew-table-header-caption"><?php echo $users_list->userLevelId->caption() ?></div>
											</div>
										</th>
									<?php } else { ?>
										<th data-name="userLevelId" class="<?php echo $users_list->userLevelId->headerCellClass() ?>">
											<div class="ew-pointer" onclick="ew.sort(event, '<?php echo $users_list->SortUrl($users_list->userLevelId) ?>', 1);">
												<div id="elh_users_userLevelId" class="users_userLevelId">
										...
										?>
											<td data-name="id" <?php echo $users_list->id->cellAttributes() ?>>
												<span id="el<?php echo $users_list->RowCount ?>_users_id">
													<span<?php echo $users_list->id->viewAttributes() ?>><?php echo $users_list->id->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Fullname" <?php echo $users_list->Fullname->cellAttributes() ?>>
												<span id="el<?php echo $users_list->RowCount ?>_users_Fullname">
													<span<?php echo $users_list->Fullname->viewAttributes() ?>><?php echo $users_list->Fullname->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Username" <?php echo $users_list->Username->cellAttributes() ?>>
												<span id="el<?php echo $users_list->RowCount ?>_users_Username">
													<span<?php echo $users_list->Username->viewAttributes() ?>><?php echo $users_list->Username->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="_Email" <?php echo $users_list->_Email->cellAttributes() ?>>
												<span id="el<?php echo $users_list->RowCount ?>_users__Email">
													<span<?php echo $users_list->_Email->viewAttributes() ?>><?php echo $users_list->_Email->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="Passsword" <?php echo $users_list->Passsword->cellAttributes() ?>>
												<span id="el<?php echo $users_list->RowCount ?>_users_Passsword">
													<span<?php echo $users_list->Passsword->viewAttributes() ?>><?php echo $users_list->Passsword->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
										...
										?>
											<td data-name="userLevelId" <?php echo $users_list->userLevelId->cellAttributes() ?>>
												<span id="el<?php echo $users_list->RowCount ?>_users_userLevelId">
													<span<?php echo $users_list->userLevelId->viewAttributes() ?>><?php echo $users_list->userLevelId->getViewValue() ?>
												</span>
												</span>
											</td>
										<?php } ?>
