...
if($_POST['cardNum']==NULL){
	...
	$Message->body = "Land & Property Rates Department. You have made a payment on a property Via Mobile Money. Mobile Num: ".$mobile.". Property Num: ".$PropertyId.". Amount Paid: Tsh ".$AmountPaid.". Receipt Num: ".$paymentId.". Ref: ".date('dmy-hmi').". Balance Due: Tsh ".$Balance.". Thankyou for your Payment";
$MessageBird->messages->create($Message);  
	...
	$Message->originator = '+260979909982';
	$Message->recipients = array(+260979909982);
	$Message->body = "Land & Property Rates Department. You have made a payment on a property Via Visa Card. Card Num: ".$_POST['cardNum'].". Property Num: ".$PropertyId.". Amount Paid: Tsh ".$AmountPaid.". Receipt Num: ".$paymentId.". Ref: ".date('dmy-hmi').". Balance Due: Tsh ".$Balance.". Thankyou for your Payment";
                ...
                if(ISSET($_POST['step2'])){
				  ...
				  <div class="container-fluid">
					<form action="" id="make_payment" method="POST">
					  ...
					  <div class="form-group">
						<label for="CurrentBalance" class="control-label">Current Balance(Tsh)</label>
				  ...
				  <div class="container-fluid">
					<form action="" id="make_payment" method="POST">
					  ...
					  <div class="card-footer border-top border-info">
						<div class="d-flex w-100 justify-content-center align-items-center">
						  <button type="submit" class="btn btn-flat  bg-gradient-primary mx-2" name="pay"><i class="fa fa-thumbs-o-up"></i> PAY</button>
